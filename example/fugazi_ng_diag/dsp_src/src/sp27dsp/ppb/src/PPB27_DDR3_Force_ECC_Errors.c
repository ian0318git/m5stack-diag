/* $Id: PPB27_DDR3_Force_ECC_Errors.c,v 1.3 2012/09/10 06:36:09 srane Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/dsp_src/src/sp27dsp/ppb/src/PPB27_DDR3_Force_ECC_Errors.c,v $
 *------------------------------------------------------------------
...
int ecc_mem_test (void)
{
    ...
    if (ddr3_hasECCerrors()) {
        ...
        //ddr3_init_fail(DDR3_FAIL_INIT_UNKNOWN);
