/* $Id: TDM_self_loopback.c,v 1.1 2012/04/18 09:44:02 srane Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/dsp_src/src/sp27dsp/ppb/src/TDM_self_loopback.c,v $
 *------------------------------------------------------------------
 * TDM_self_loopback.c
 *
 * Mar 2012, Smita Rane
...
/* enabling TDM interrupt */
	...
	for(i=0; i<MAX_NUM_PORT; i++)
	{
		...
		{
				sp_TdmSWTU2Dconfig(TDM(i), AUTOLOAD_ON, SIGCON_LCOL2_LROW_INTC, (BUFFERING_OPTION+1)*NUMBER_OF_SAMPLE_BUFFER);
