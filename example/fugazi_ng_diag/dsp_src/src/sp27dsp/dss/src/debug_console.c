/* $Id: debug_console.c,v 1.2 2012/05/10 22:45:14 srane Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/dsp_src/src/sp27dsp/dss/src/debug_console.c,v $
 *------------------------------------------------------------------
 * debug_console.c 
 *      Graffham : DSS console routines
 *
 * Mar 2012,  Smita Rane
 *
