/* $Id: diag_main.c,v 1.3 2012/12/24 00:07:08 srane Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/dsp_src/src/sp27dsp/dss/src/diag_main.c,v $
 *------------------------------------------------------------------
 * diag_main.c
 *      Graffham - DSP DSS Core diagnostics main entry
 *
 * Mar 2012, Smita Rane
 *
