; $Id: sc3_rt_startup_asm.asm,v 1.1 2012/04/18 18:08:36 srane Exp $
; $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/dsp_src/src/sp27dsp/dss/src/sc3_rt_startup_asm.asm,v $
;------------------------------------------------------------------
;
