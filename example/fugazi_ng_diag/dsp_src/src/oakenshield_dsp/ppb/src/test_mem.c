/* $Id: test_mem.c,v 1.2 2017/07/28 07:58:51 harrchan Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/dsp_src/src/oakenshield_dsp/ppb/src/test_mem.c,v $
 *------------------------------------------------------------------
 * test_mem.c
 *      Oakenshield project: test LSI SP2704 DSP DDR3 SDRAM 
 *
 * Mar 2012, Smita Rane
 *
