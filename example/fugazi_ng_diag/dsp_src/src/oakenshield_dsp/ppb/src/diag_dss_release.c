/* $Id: diag_dss_release.c,v 1.2 2017/07/28 07:58:51 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/dsp_src/src/oakenshield_dsp/ppb/src/diag_dss_release.c,v $
 *------------------------------------------------------------------
 * diag_dss_release.c
 *      Oakenshield ARM - DSS related functions 
 *
 * Mar 2012, Smita Rane
 *
