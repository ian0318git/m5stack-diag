/* $Id: diag_ppb_utils.c,v 1.2 2017/07/28 07:58:51 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/dsp_src/src/oakenshield_dsp/ppb/src/diag_ppb_utils.c,v $
 *------------------------------------------------------------------
 * diag_ppb_utils.c
 *     Utilities 
 *
...
HISTORY:
	none
*******************************************************************************/ 
void StarProPPB_UTILS_memset8(uint8_t *p_mem, uint8_t pattern, uint32_t n)
{
	while (n--) {
		*p_mem++ = pattern;
	}
...
HISTORY:
	none
*******************************************************************************/ 
void StarProPPB_UTILS_memset32(uint32_t *p_mem, uint32_t pattern, uint32_t n)
{
	uint32_t	size;
...
HISTORY:
	none
*******************************************************************************/
void StarProPPB_UTILS_memcpy8 (uint8_t *pdest, const uint8_t *psrc, uint32_t size)
{
	while (size--) {
		*pdest++ = *psrc++; 
	}
...
HISTORY:
	none
*******************************************************************************/
uint32_t StarProPPB_UTILS_csum_partial(uint32_t sum32, const uint8_t *p_data, uint32_t size)
{
...
HISTORY:
	none
*******************************************************************************/
uint16_t StarProPPB_UTILS_csum16_fold(uint32_t sum32)
{
...
HISTORY:
	none
*******************************************************************************/
uint16_t StarProPPB_UTILS_csum16(uint32_t sum32, const uint16_t *p_data, uint32_t size)
{
...
HISTORY:
	none
*******************************************************************************/ 
uint32_t StarProPPB_UTILS_csum32(uint32_t *p_mem, uint32_t n)
{
