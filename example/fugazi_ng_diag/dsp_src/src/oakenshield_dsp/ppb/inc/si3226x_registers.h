/* $Id: si3226x_registers.h,v 1.2 2017/07/28 07:58:38 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/dsp_src/src/oakenshield_dsp/ppb/inc/si3226x_registers.h,v $
 *------------------------------------------------------------------
 * si3226x_registers.h
 *
...
#define RAM_ADDR_READY_TO_ACCESS        0


typedef struct host_if_info_ {
    int  which_port;
    uint which_reg;
    int  data;
    int  data_lw;
