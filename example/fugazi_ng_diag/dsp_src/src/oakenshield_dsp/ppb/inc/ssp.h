/* $Id: ssp.h,v 1.2 2017/07/28 07:58:39 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/dsp_src/src/oakenshield_dsp/ppb/inc/ssp.h,v $
 *------------------------------------------------------------------
 * ssp.h
 *      SSP Port defines
 *
...
/* FPGA instruction set */
#define LSI_SP27XX_FPGAREAD             0x03        /* Read Register            */
#define LSI_SP27XX_FPGAWRIT             0x02        /* Write Register           */
...
extern int spi_read_fpga(uint16_t, int , uint8_t *, int );
extern int spi_write_fpga(uint16_t , int , uint8_t *, int );
...
Revision 1.3.84.1  2016/12/14 05:03:50  olin2
Initial commit code for Oakenshield
