/* $Id: env.c,v 1.3 2021/04/15 00:52:35 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/dsp_src/src/oakenshield_dsp/image/env.c,v $
 *------------------------------------------------------------------
 * env.c
...
uint32_t env_sync (int refresh_addr) {
    ...
    *tp++ = '\0';
    ...
    /* fix compiler issue, size not use */ 
    size += 1;
#ifdef ARM    
...
Revision 1.1.86.1  2016/12/14 04:49:36  olin2
Initial commit code for Oakenshield
