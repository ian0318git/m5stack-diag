/* $Id: diag_emmc_util.h,v 1.3 2021/06/17 02:18:53 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/phoenix/diag_emmc_util.h,v $
 *------------------------------------------------------------------
 *
...
#define EMMC_WESTERN_MANFID_STR     "45"
...
/* eMMC info structure */
typedef struct phoenix_emmc_info {
    char manf_name[32];
    char prod_name[32];
} emmc_info_t;
