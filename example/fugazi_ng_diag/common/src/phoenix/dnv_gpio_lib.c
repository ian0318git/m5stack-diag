/* $Id: dnv_gpio_lib.c,v 1.2 2021/04/15 00:52:26 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/phoenix/dnv_gpio_lib.c,v $
 *------------------------------------------------------------------
 * 
 * dnv_gpio_lib.c
 *
...
int dnv_set_pcie_1f_1 (void)
{
    ...
    offset = CONFIG_PHOENIX_PCIE_ADDR + tmp_bus_dev_fun;
