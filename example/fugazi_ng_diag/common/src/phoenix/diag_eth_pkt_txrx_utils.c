/* $Id: diag_eth_pkt_txrx_utils.c,v 1.2 2021/04/15 00:52:24 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/phoenix/diag_eth_pkt_txrx_utils.c,v $
 *------------------------------------------------------------------
