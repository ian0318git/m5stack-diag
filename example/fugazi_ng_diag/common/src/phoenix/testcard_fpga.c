/* $Id: testcard_fpga.c,v 1.2 2021/04/15 00:52:27 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/phoenix/testcard_fpga.c,v $
 *------------------------------------------------------------------
...
int tc_sync_sig_test (void)
{
    int        ret_val = PASSED;
    uint16_t   tc_fpga_rev = 0;
    uint32_t sync_trig_stat_mask = 0, sync_stat_mask = 0;
    uint32_t   sync_reg_off = 0; 
