/* $Id: platform_pwr_seq.h,v 1.2 2021/04/15 00:52:27 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/phoenix/platform_pwr_seq.h,v $
 *------------------------------------------------------------------
...
/* For Phoenix PWR LED */
#define PWR_SEQ_PWR_LED_REG PWR_SEQ_SCR0
#define PWR_SEQ_PWR_LED_GREEN 0x5555
#define PWR_SEQ_PWR_LED_AMBER 0xAAAA
#define PWR_SEQ_PWR_LED_OFF 0xCCCC


/* Functions prototype */
extern int init_pwr_seq(int err_log);
extern void build_pwr_seq_tst_menu(int);
