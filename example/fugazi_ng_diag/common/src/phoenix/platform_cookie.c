/* $Id: platform_cookie.c,v 1.2 2021/04/15 00:52:27 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/phoenix/platform_cookie.c,v $
 *------------------------------------------------------------------
 *
...
static uchar default_mb_cookie[COOKIE_SIZE_512] = {
    ...
    0x11, 0x1B, 0x41, 0x01, 0x00, 0xE2, 0x46, 0x00,
    0x4A, 0x01, 0xE6, 0x06, 0x01, 0x42, 0x30, 0x31,
    0xC0, 0x46, 0x00, 0x4A, 0x01, 0xE6, 0x50, 0x01,
    0x88, 0x00, 0x00, 0x00, 0x00, 0x02, 0x01, 0xCB,
    0x8C, 0x56, 0x47, 0x34, 0x32, 0x30, 0x2D, 0x31,
    0x34, 0x34, 0x46, 0x58, 0x53, 0x89, 0x56, 0x30,
    0x30, 0x20, 0xC6, 0x8A, 0x54, 0x42, 0x44, 0x54,
    0x42, 0x44, 0x54, 0x42, 0x44, 0x54, 0x09, 0xD0,
    0xC2, 0x8B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0xC3, 0x06, 0x00,
...
static uchar default_eeprom_content[PHOENIX_INIT_EEPROM_SIZE] = {
    /* 0x00 */
    ...
    0x72, 0x3A, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00,
    /* 0x40 */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x43, 0x4C, 0x45, 0x49, 0x20, 0x43, 0x6F, 
    /* 0x50 */
    0x64, 0x65, 0x3A, 0x20, 0x00, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    /* 0x60 */
    0x00, 0x00, 0x00, 0x00, 0x50, 0x72, 0x6F, 0x63, 
    0x65, 0x73, 0x73, 0x6f, 0x72, 0x20, 0x54, 0x79, 
    /* 0x70 */
    0x70, 0x65, 0x3a, 0x20, 0x30, 0x78, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x4d, 0x41, 0x43, 0x20, 
    /* 0x80 */
    0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x20, 
    0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x20, 0x73, 0x69, 
    /* 0x90 */
    0x7a, 0x65, 0x3a, 0x20, 0x30, 0x78, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x4d, 0x61, 0x6e, 0x75, 
    /* 0xA0 */
    0x66, 0x61, 0x63, 0x74, 0x75, 0x72, 0x69, 0x6e, 
    0x67, 0x20, 0x54, 0x65, 0x73, 0x74, 0x20, 0x44, 
    /* 0xB0 */
    0x61, 0x74, 0x61, 0x3a, 0x20, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    /* 0xC0 */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x50, 0x43, 
    /* 0xD0 */
    0x42, 0x20, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 
    0x20, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x3a, 
    /* 0xE0 */
    0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x43, 0x68, 
    /* 0xF0 */
    0x61, 0x73, 0x73, 0x69, 0x73, 0x20, 0x4d, 0x41, 
    0x43, 0x20, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 
    /* 0x100 */
    0x73, 0x3a, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    /* 0x110 */
    0x00, 0x00, 0x00, 0x56, 0x49, 0x44, 0x3a, 0x20, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x4e, 0x61, 0x6d, 
    /* 0x120 */
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    /* 0x140 */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x44, 0x45, 0x53, 
    0x52, 0x3a, 0x20, 0x45, 0x6e, 0x74, 0x65, 0x72, 
    /* 0x150 */
    0x70, 0x72, 0x69, 0x73, 0x65, 0x20, 0x4e, 0x65, 
    0x74, 0x77, 0x6f, 0x72, 0x6b, 0x20, 0x43, 0x6f, 
    /* 0x160 */
    0x6d, 0x70, 0x75, 0x74, 0x65, 0x20, 0x53, 0x79, 
    0x73, 0x74, 0x65, 0x6d, 0x00, 0x00, 0x00, 0x00, 
};
                        ...
                        uchar * contents, int cookie_size)
{
    ...
    printf("%s: Phoenix currently skip SKU ID check.\n", __func__);
    sku_id_val = 0xFF;

    switch (board_type) {
        case MOTHER_BOARD:
            printf("\nLoading default cookie format for Phoenix Motherboard.\n");
            switch (sku_id_val) {
                case 0xFF:
...
int init_eeprom_default (void)
{
     ...
     * load default value.
     *     phoenix-diag# eeprog -qxf /dev/i2c-0 0x54 -16 -t 10 -r 0x0:0x30
    ...
    if ((r_buf[9] == HEX_VAL_OF_F_CHAR) && (r_buf[10] == HEX_VAL_OF_F_CHAR)
        ...
        /* Init the DMI EEPROM */
        fwrite(default_eeprom_content, sizeof(char), PHOENIX_EEPROM_INIT_SIZE, fp);
        fclose(fp);
...
int sync_cookie_content_into_eeprom (void)
{
    ...
    fwrite(default_eeprom_content, sizeof(char), PHOENIX_INIT_EEPROM_SIZE, fp);
    fclose(fp);
    system(INIT_EEPROM);
    /* Wait for write cycle time (option -t) */
    usleep(WAIT_EEPROG);
...
int alter_mb_cookie(void)
{
    ...
    if (hw_brd_rev <= BRD_REV_P2) {
        act2_chip = getdec_answer("\n(0-Discrete-ACT2, 1-Aikido-ACT2-Mailbox, "
                                  "2-Aikido-ACT2-I2C):", 1, 0, 2);
    } else {
        act2_chip = getdec_answer("\n(1-Aikido-ACT2-Mailbox, "
                                  "2-Aikido-ACT2-I2C):", 1, 1, 2);
    }
...
int smartchip (int submenu_flag)
{
    ...
    switch (choice[0]) {
        ...
        case 'n':
            ...
            slot = getdec_answer("Enter NIM slot number", 1, FIRST_SLOT,
                    max_slot);
                                    ...
                                    uchar slot, uchar *cookie_p)
{
    ...
    *i2c_err = '\0'; 
    ...
    case MOTHER_BOARD: /* I2C interface */
        ...
        con_p->dev_if_p->parm1 = (uint8_t)IOFPGA_I2C; 
        if (is_tam_aikido_on()) {
            con_p->dev_if_p->parm2 = (uint8_t)MB_I2C_ADDR_AIKIDO;
        } else {
                     ...
                     uint16_t * id, char *err)
{
    ...
    /*
     * Phoenix SM_MODULE is DSP virtual SM
     */
    g_cookie_type = type;
    if (type == SM_MODULE) {
        /* Check Virtual SM slot present pin */
        ngio = (struct ngio_intf_t *)slot_get_ngiosm(slot);
        if (!ngiosm_present(ngio)) {
            printf("\nNo Virtual SM %d present.\n", con->slot);
            return (FAILED);
        }
        *id = PHOENIX_VIRTUAL_SM;
...
ushort get_mb_id(void)
{
    ...
    if (is_tam_aikido_on()) {
        con->dev_if_p->parm2 = (uint8_t)MB_I2C_ADDR_AIKIDO;
    } else {
