/* $Id: diag_fpga_upgrade.c,v 1.2 2021/04/15 00:52:26 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/phoenix/diag_fpga_upgrade.c,v $
 *------------------------------------------------------------------
 * diag_fpga_upgrade.c - 
 * 
 *
...
{ 
    ...
    fpga_header.flags[0] = update_flag | ALWAYS_UPGRADE_A0;
...
int program_image_update_type (int dummy)
{
    ...
    update_flag = getdec_answer("\nSet Update flag to upgrade image header:"
                                "\n0: Always"
                                "\n1: if newer"
                                "\n2: if different"
                                "\nEnter (0 ~ 2): ", 0, 0, 2);
