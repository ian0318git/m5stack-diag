/* $Id: diag_usb_test.c,v 1.2 2021/04/15 00:52:26 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/phoenix/diag_usb_test.c,v $
 *------------------------------------------------------------------
 *
...
int phoenix_usb_slot_tests(int);
...
static submenu_xtable_t usbtest_menu_table[] = {   
    ...
    (type_t(*)())0, 0, (PFT) 0, 0},
/* Mark since Phoenix does not support
...
int usb_tests (int usb_test_speed)
{
    ...
    rc = phoenix_usb_slot_tests(usb_idx);
    if (rc == PASSED) {
...
/*******************************************************************************
 *
 * Function   :    phoenix_usb_slot_tests
 ...
 *******************************************************************************
 */
int phoenix_usb_slot_tests (int usb_idx)
{
