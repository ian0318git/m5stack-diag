/* $Id: i2c_api.c,v 1.2 2021/04/15 00:52:26 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/phoenix/i2c_api.c,v $
 *------------------------------------------------------------------
 * Filename: i2c_api.c
 *
...
/* DDR4 SPD */
static n2g_i2c_dev_t n2g_i2c0_ddr_spd = { CPU_I2C0, MB_I2C_ADDR_SPD, 1, 1, 0 };
