/* $Id: diag_emmc_util.c,v 1.3 2021/06/17 02:18:53 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/phoenix/diag_emmc_util.c,v $
 *------------------------------------------------------------------
 *
...
static int get_emmc_cid_info (emmc_info_t *emmc_info)
{
    ...
    } else if (strstr(buf, EMMC_WESTERN_MANFID_STR) != NULL) {
