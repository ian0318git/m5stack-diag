/* $Id: diag_cpld_lib.c,v 1.2 2021/04/15 00:52:23 achiu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/phoenix/diag_cpld_lib.c,v $
 *------------------------------------------------------------------
 *
...
int open_cpld (void)
{
    ...
    if (phoenix_open_module(&fd_cpld, PHOENIX_CPLD_KLM)==PASSED) {
        /* The CPLD address for PHOENIX, Because there is TPM on it */
