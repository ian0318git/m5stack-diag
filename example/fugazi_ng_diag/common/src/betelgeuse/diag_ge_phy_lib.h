/* $Id: diag_ge_phy_lib.h,v 1.3 2019/06/24 07:21:37 wilbhuan Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/betelgeuse/diag_ge_phy_lib.h,v $
 *------------------------------------------------------------------
 * 
 * diag_ge_phy_lib.h
 *
...
extern int diag_ge_phy_config_gephy_fiber(void);
...
#define PLAT_GE0_ETHNUM        ETH0
#define PLAT_GE1_ETHNUM        ETH2
