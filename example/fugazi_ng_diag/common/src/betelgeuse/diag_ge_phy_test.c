/* $Id: diag_ge_phy_test.c,v 1.2 2019/01/10 06:36:22 wilbhuan Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/betelgeuse/diag_ge_phy_test.c,v $
 *------------------------------------------------------------------
 * 
 * diag_ge_phy_test.c
 *
...
static submenu_xtable_t gephy0_util_items[] = {
    {"GE PHY register read",        (type_t(*)())diag_util_ge_rd_reg,
     PLAT_GE0_ETHNUM,                0, (type_t(*)())0, 0, (type_t(*)())0, 0},
    ...
    {"CPU register Write",          (type_t(*)())diag_cpu_reg_wr_util, 0, 0,
     (type_t(*)())0, 0, (type_t(*)())0, 0},
    {"Send packet to GE PHY 0",     (type_t(*)())diag_util_ge_send_packet_util, PLAT_GE0_ETHNUM, 0,
     (type_t(*)())0, 0, (type_t(*)())0, 0},
    {"Set PHY 1000BaseT Test mode", (type_t(*)())diag_util_ge_set_test_mode, PLAT_GE0_ETHNUM, 0,
     (type_t(*)())0, 0, (type_t(*)())0, 0},
    {"Set PHY Transmitter Type",    (type_t(*)())diag_util_ge_set_tx_type, PLAT_GE0_ETHNUM, 0,
     (type_t(*)())0, 0, (type_t(*)())0, 0},
    {"VOD Adjustments",             (type_t(*)())diag_util_ge_set_vod,
     GE0,                       0,
     (type_t(*)())0,                0,
     (type_t(*)())0,                0},
    {"GE0 stat LED utils", (type_t(*)())diag_util_ge_led, 0, 0,
      (type_t(*)())0, 0, (type_t(*)())0, 0},
};
...
static submenu_xtable_t gephy1_util_items[] = {
    {"GE PHY register read", (type_t(*)())diag_util_ge_rd_reg, PLAT_GE1_ETHNUM, 0,
     (type_t(*)())0, 0, (type_t(*)())0, 0},
    {"GE PHY register write", (type_t(*)())diag_util_ge_wr_reg, PLAT_GE1_ETHNUM, 0,
     (type_t(*)())0, 0, (type_t(*)())0, 0},
    {"CPU register Read", (type_t(*)())diag_cpu_reg_rd_util, 0, 0,
     (type_t(*)())0, 0, (type_t(*)())0, 0},
    {"CPU register Write", (type_t(*)())diag_cpu_reg_wr_util, 0, 0,
     (type_t(*)())0, 0, (type_t(*)())0, 0},
    {"Send packet to GE PHY 1", (type_t(*)())diag_util_ge_send_packet_util, PLAT_GE1_ETHNUM, 0,
     (type_t(*)())0, 0, (type_t(*)())0, 0},
    {"Set PHY 1000BaseT Test mode", (type_t(*)())diag_util_ge_set_test_mode, PLAT_GE1_ETHNUM, 0,
     (type_t(*)())0, 0, (type_t(*)())0, 0},
    {"Set PHY Transmitter Type", (type_t(*)())diag_util_ge_set_tx_type, PLAT_GE1_ETHNUM, 0,
     (type_t(*)())0, 0, (type_t(*)())0, 0},
    {"VOD Adjustments",             (type_t(*)())diag_util_ge_set_vod,
     GE1,                       0,
     (type_t(*)())0,                0,
...
static int diag_ge_phy_reg_test (int ge_num) {
    ...
    sprintf(test_name, "GE%d %s", ge_num, "Register Test");
    testname(test_name);
...
static int diag_ge_phy_copper_mac_lpbk_test (int ge_num)
{
    ...
    char test_name[32];
    memset(test_name, 0, sizeof(test_name));
    sprintf(test_name, "GE%d %s", ge_num, "MAC loopback test");
    testname(test_name);
    prpass(testpass, "%s, ", test_name);
    printf("\n");
...
static int diag_ge_phy_copper_ext_lpbk_test (int ge_num)
{
    ...
    char test_name[32];
    memset(test_name, 0, sizeof(test_name));
    sprintf(test_name, "GE%d %s", ge_num, "External loopback test");
    testname(test_name);
    prpass(testpass, "%s, ", test_name);
    printf("\n");
...
static int diag_ge_phy_sfp_ext_lpbk_test (int ge_num)
{
    ...
    char test_name[32];
    memset(test_name, 0, sizeof(test_name));
    sprintf(test_name, "GE%d %s", ge_num, "SFP External loopback test");
    testname(test_name);
    prpass(testpass, "%s, ", test_name);
    printf("\n");


    /* Config GE0 PHY fiber */
    if (diag_ge_phy_config_gephy_fiber() != PASSED) {
