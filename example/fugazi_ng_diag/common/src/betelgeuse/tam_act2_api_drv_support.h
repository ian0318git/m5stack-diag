/* $Id: tam_act2_api_drv_support.h,v 1.2 2019/01/10 06:36:29 wilbhuan Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/betelgeuse/tam_act2_api_drv_support.h,v $
 *------------------------------------------------------------------
 * 
