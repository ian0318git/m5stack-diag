/* $Id: platform_cookie.c,v 1.2 2019/01/10 06:36:25 wilbhuan Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/betelgeuse/platform_cookie.c,v $
 *------------------------------------------------------------------
 * 
 * platform_cookie.c
 *
...
static struct pid_list invalid_pid = {(uchar*)"INVALID-PID", FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, ESW_MRVL88E6390};
static struct pid_list betelgeuse_pid_list[PLATFORM_PID_LIST_LENGTH] = {
    /*
     * Betelgeuse PID list
     * Format: (PID and each functional flag)
     *       PID,            (1)WiFi   (2)Pluggable (3)GE1   (4)xDSL  (5)Sirius FPGA (6)G.SHDSL (7)ESW Type
     */
    {(uchar*)"C1121-8PLTEPWE",TRUE,     TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1121-8PLTEPWB",TRUE,     TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1121-8PLTEPWZ",TRUE,     TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1121-8PLTEPWQ",TRUE,     TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1121-8PLTEP",  FALSE,    TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1121X-8PLTEP", FALSE,    TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1121-8P",      FALSE,    FALSE,       TRUE,    FALSE,   FALSE,         FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1121X-8P",     FALSE,    FALSE,       TRUE,    FALSE,   FALSE,         FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1161-8P",      FALSE,    FALSE,       TRUE,    FALSE,   FALSE,         FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1161X-8P",     FALSE,    FALSE,       TRUE,    FALSE,   FALSE,         FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1161-8PLTEP",  FALSE,    TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1161X-8PLTEP", FALSE,    TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1126-8PLTEP",  FALSE,    TRUE,        FALSE,   TRUE,    TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1127-8PLTEP",  FALSE,    TRUE,        FALSE,   TRUE,    TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1127-8PMLTEP", FALSE,    TRUE,        FALSE,   TRUE,    TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1126X-8PLTEP", FALSE,    TRUE,        FALSE,   TRUE,    TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1127X-8PLTEP", FALSE,    TRUE,        FALSE,   TRUE,    TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1127X-8PMLTEP",FALSE,    TRUE,        FALSE,   TRUE,    TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1121-4P",      FALSE,    FALSE,       TRUE,    FALSE,   FALSE,         FALSE,     ESW_MRVL88E6176},
    {(uchar*)"C1121-4PLTEP",  FALSE,    TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6176},
    {(uchar*)"C1128-8PLTEP",  FALSE,    TRUE,        FALSE,   FALSE,   TRUE,          TRUE,      ESW_MRVL88E6390},
    {(uchar*)"C1121X-8PLTEPWE",TRUE,    TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1121X-8PLTEPWB",TRUE,    TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1121X-8PLTEPWZ",TRUE,    TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390},
    {(uchar*)"C1121X-8PLTEPWA",TRUE,    TRUE,        TRUE,    FALSE,   TRUE,          FALSE,     ESW_MRVL88E6390}
};
...
/*
 * Function: platform_has_wifi
 *
 * Description:
 *   This function is used to distinguish the platform whether it has WiFi
 *
 * Returns:
 *   TRUE/FALSE
 */
int platform_has_wifi (void) {
    return (current_platform_pid->wifi_flag);
}
...
/*
 * Function: platform_has_ge1
 *
 * Description:
 *   This function is used to distinguish the platform whether it has GE1
 *
 * Returns:
 *   TRUE/FALSE
 */
int platform_has_2nd_ge (void) {
    return (current_platform_pid->ge1_flag);
}

/*
 * Function: platform_has_xdsl
 *
 * Description:
 *   This function is used to distinguish the platform whether it has xDSL
 *
 * Returns:
 *   TRUE/FALSE
 */
int platform_has_xdsl (void) {
    return (current_platform_pid->xdsl_flag);
}

/*
 * Function: platform_has_gshdsl
 *
 * Description:
 *   This function is used to distinguish the platform whether it has G.SHDSL
 *
 * Returns:
 *   TRUE/FALSE
 */
int platform_has_gshdsl (void) {
    return (current_platform_pid->gshdsl_flag);
}

/*
 * Function: platform_esw_type
 *
 * Description:
 *   This function is used to distinguish the 4-port and 8-port ethernet switch 
 *
 * Returns:
 *   ESW_TYPE_4PORT/ESW_TYPE_8PORT
 */
int platform_esw_type (void) {
    return (current_platform_pid->esw_type);
}

/*
 * Function: xdsl_control_type
 *
 * Description:
 *   This function is used to identify the xDSL control type what if platform is xDSL SKU
 *
 * Returns:
 *   an identifier of xDSL control type
 */
void show_xdsl_control_type (void) {
 ...
 *   an identifier of xDSL control type
 */
int xdsl_control_type (void) {
    if (platform_has_xdsl()) {

        switch (current_platform_cid) {
        case 0x1078:
        case 0x107b:
            return (XDSL_CTRL_TYPE_ANNEX_A);
        break;

        case 0x1079:
        case 0x107c:
            return (XDSL_CTRL_TYPE_ANNEX_M);
        break;

        case 0x1077:
        case 0x107a:
            return (XDSL_CTRL_TYPE_ANNEX_BJ);
        break;

        default:
            return (XDSL_CTRL_TYPE_UNKNOWN);
        break;
        }
    } else {
        printf("%s:%d:Platform is not xDSL SKU.\n", __FUNCTION__, __LINE__);
        return (0);
    }
}
 ...
 *
 * Description:
 *   This function is used to read PID from ccookies then check whether it is involved in betelgeuse_pid_list.
 *
 * Returns:
 *   PASSED/FAILED
 */
int initial_current_product_id (void) {
    ...
    if (is_set_already == NOT_SET) {   
        ...
        for (ix = 0; ix < PLATFORM_PID_LIST_LENGTH; ix++) {
            if (strcmp((char*)mb_pid, (char*)betelgeuse_pid_list[ix].pid) == PASSED) {
                current_platform_pid = &betelgeuse_pid_list[ix];
                break;
            }
        }
