/* $Id: diag.c,v 1.2 2019/01/10 06:36:21 wilbhuan Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/betelgeuse/diag.c,v $
 *------------------------------------------------------------------
 * 
 * diag.c
 *
...
static struct mitem cookie_items[] = {
    ...
    {"read SFP cookie", 0, 0,
     (type_t(*)())diag_read_sfp_cookie, &zero, 0, (type_t(*)())0, 0},
...
submenu_xtable_t main_menu_table[] = {
    ...
    ,
    {"ADSL2+VDSL2 tests", 
    (PFT)diag_dsl_test, TRUE,
    MF_CONTINUOUS | MF_DOALL | MF_SHOW_ERRCOUNT,
    (type_t(*)())platform_has_xdsl, 0, (PFT) diag_dsl_test, FALSE}
    ,
    {"PoE PSU tests", 
    ...
    ,
    {"GSHDSL tests", 
    (PFT)diag_gshdsl_test, TRUE,
    MF_CONTINUOUS | MF_DOALL | MF_SHOW_ERRCOUNT,
    (type_t(*)())platform_has_gshdsl, 0, (PFT) diag_gshdsl_test, FALSE}
    ,
};
...
static int diag_display_sys_info_util (int dummy)
{
    ...
    printf("\n======================================================\n");
    printf("========== Show Pluggable xDSL Control Type ==========\n");
    printf("======================================================\n");
    if (platform_has_xdsl()) {
        show_xdsl_control_type();
    }
