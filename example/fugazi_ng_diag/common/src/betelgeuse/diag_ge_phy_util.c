/* $Id: diag_ge_phy_util.c,v 1.2 2019/01/10 06:36:22 wilbhuan Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/betelgeuse/diag_ge_phy_util.c,v $
 *------------------------------------------------------------------
 * 
 * diag_ge_phy_util.c
 *
...
int diag_util_ge_send_packet_util (int eth_num)
{
    ...
    if (plat_sgmii_lpbk_test(eth_num, RSV_SPD_FIELD) != PASSED) {
