/* $Id: diag_i2c_util.c,v 1.2 2019/01/10 06:36:23 wilbhuan Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/betelgeuse/diag_i2c_util.c,v $
 *------------------------------------------------------------------
 *
 * diag_i2c_util.c
 *
...
static submenu_xtable_t i2c_menu_table[] = {
    ...
    {"I2C write", (PFT) i2c_reg_wr_util, TRUE,
     0, (PFT) 0, 0,
     (PFT) 0, 0},
    {"MCU utilities", (PFT)plat_mcu_utils, FALSE, 
     0, (PFT) 0, 0,
     (PFT) 0, 0},
