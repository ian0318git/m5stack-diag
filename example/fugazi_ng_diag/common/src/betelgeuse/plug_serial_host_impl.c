/* $Id: plug_serial_host_impl.c,v 1.1 2019/06/24 07:21:37 wilbhuan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/betelgeuse/plug_serial_host_impl.c,v $
 *------------------------------------------------------------------
 *
