/* $Id: i2c_api.c,v 1.4 2019/07/11 12:31:31 alicehua Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nutella/i2c_api.c,v $
 *------------------------------------------------------------------
 * Filename: i2c_api.c
 *
...
/* FRU EEPROM */
static n2g_i2c_dev_t n2g_i2c0_fru_eeprom = { CPU_I2C0, MB_I2C_ADDR_FRU_EEPROM, 1, 1, 0 };
...
static n2g_i2c_states_t i2c_mb0_state[MB_I2C_0_INVALID] = {
    ...
    {0, &n2g_i2c0_fru_eeprom, N2G_I2C_IDLE},      /* FRU EEPROM */
};
