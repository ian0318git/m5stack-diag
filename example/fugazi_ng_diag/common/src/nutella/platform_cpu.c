/* $Id: platform_cpu.c,v 1.4 2019/07/11 12:31:32 alicehua Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nutella/platform_cpu.c,v $
 *------------------------------------------------------------------
 *
 * platform_cpu.c
 *
...
int cpu_core_test (int do_more_test)
{
    ...
    if (linux_cpu_core_test(NUTELLA_CPU_NUM) != PASSED) {
