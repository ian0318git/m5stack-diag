/* $Id: dnv_gpio_lib.h,v 1.6 2020/03/04 00:02:51 alicehua Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nutella/dnv_gpio_lib.h,v $
 *------------------------------------------------------------------
 * 
 * dnv_gpio_lib.h
 *
...
#define CONFIG_NUTELLA_PCIE_ADDR          0xE0000000
...
#define PAD_CFG_DW0_GPIO_11             0xC50000 + 0x718
#define PAD_CFG_DW1_GPIO_11             0xC50000 + 0x71C
...
#define PADCFG0_GPIOTXDIS_VAL           0x100
#define PADCFG0_GPIORXDIS_VAL           0x200
...
extern int  dnv_set_pcie_register(void);
...
extern int  set_dnv_gpio_direction(int, int);
