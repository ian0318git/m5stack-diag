/* $Id: diag_spi_flash_util.h,v 1.5 2019/07/12 09:13:42 alicehua Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nutella/diag_spi_flash_util.h,v $
...
#define NUTELLA_DENVERTON_SPI_CTRL_MM_ADDR  0xFE010000

#define HW_CYCLE_POLLING_COUNT_MAX  100
#define HW_CYCLE_POLLING_LOOP_WAIT  10
...
#define GOLDEN_SPI_FLASH  (0)
#define UPGRADE_SPI_FLASH  (1)
#define FPGA_SPI_FLASH  (2)

#define GOLDEN_SPI_FLASH_NAME  "Golden Flash"
#define UPGRADE_SPI_FLASH_NAME  "Upgrade Flash"
...
#define SPI_MX25L12833F_ID 0xC22019
...
#define SPI_W25Q16JV_PROTECTED_1M_BP_CONF 0x34 /* 0011 0100 */
/* Second source*/
...
extern int nutella_spi_flash_utils (int);
extern int nutella_spi_flash_get_rdsr (int, uchar *); 
extern int nutella_spi_flash_get_prod_id (int, uint*);
