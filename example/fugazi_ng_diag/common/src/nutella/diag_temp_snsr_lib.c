/* $Id: diag_temp_snsr_lib.c,v 1.4 2019/07/11 12:31:30 alicehua Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nutella/diag_temp_snsr_lib.c,v $
 *-----------------------------------------------------------------------------
 * 
 * Filename   : diag_temp_sensor_lib.c
 * Description: Nutella NXP LM75BD module Temperature Sensor Library
 *
