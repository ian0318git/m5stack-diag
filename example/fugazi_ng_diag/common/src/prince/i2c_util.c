/* $Id: i2c_util.c,v 1.3 2013/07/16 02:36:28 liwwang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/prince/i2c_util.c,v $
 *
...
int voltage_margin_specific(void)
{
    ...
    while (1) {
        ...
        val = (uchar)getdec_answer("please input value to margin : ", 0, 0, 255);
...
/******** History ******** 
$Log: i2c_util.c,v $
Revision 1.3  2013/07/16 02:36:28  liwwang
bump up version
