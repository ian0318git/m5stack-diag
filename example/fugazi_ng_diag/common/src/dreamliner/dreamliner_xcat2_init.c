/* $Id: dreamliner_xcat2_init.c,v 1.5 2017/07/14 02:51:38 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/dreamliner_xcat2_init.c,v $
 *------------------------------------------------------------------
 *
 ...
 * Revision 1.5  2017/07/14 02:51:38  alpeng
 * fixed compiler warning, due to cross-compiler version was updated.
 *
 * Revision 1.4  2017/03/30 08:23:23  hondwang
 * Tachi-L brach merge
 *
 * Revision 1.3.14.1  2016/12/21 12:46:13  hondwang
 * Fix dreamliner loopback issue
 *
 * Revision 1.3  2016/04/20 07:06:40  benchen2
 * merge tachi branch into main trunk
 *
 * Revision 1.2.4.2  2016/04/18 08:57:39  alpeng
 * fix for prrq
 *
 * Revision 1.2.4.1  2015/12/29 12:27:07  alpeng
