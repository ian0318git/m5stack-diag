/* $Id: dreamliner_xcat2_utils.c,v 1.3 2016/04/20 07:06:40 benchen2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/dreamliner_xcat2_utils.c,v $
 *------------------------------------------------------------------
 *
