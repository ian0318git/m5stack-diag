#! /router/bin/perl5 -w
#  $Id: bin2c.pl,v 1.3 2015/03/06 07:30:35 iachang Exp $
#  $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/bin2c.pl,v $
# ------------------------------------------------------------------
...
######## HISTORY ########
#  $Log: bin2c.pl,v $
#  Revision 1.3  2015/03/06 07:30:35  iachang
#  Supported bin2c.pl tool
#
#  Revision 1.2  2015/02/27 10:02:19  iachang
# 
#  Add support dreamliner NIM
# 
#  Revision 1.1.2.1  2015/02/10 01:37:34  iachang
#  Utility to convert bin image to array format.
# ------------------------------------------------------------------
#  $Endlog$
# 
