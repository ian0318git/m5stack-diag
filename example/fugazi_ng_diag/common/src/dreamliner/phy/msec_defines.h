/* $Id: msec_defines.h,v 1.1 2015/02/13 11:35:40 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/phy/msec_defines.h,v $
 *------------------------------------------------------------------
 *
 * dmsec_defines.h - Definitions for MacSec control functions's
 *
...
#define GET_REV_DATA(_dev, a, b, c)    \
 (((_dev)->deviceId==MAD_88E1540 || (_dev)->deviceId==MAD_88E1548 || (_dev)->deviceId==MAD_88E1680 || (_dev)->deviceId==MAD_88E3183)?a:    \
...
/* #if defined (REV_A0_UP) || defined(PROD_1540L) */
  ...
  #define VN_PET_STATS(_dev) (((_dev)->deviceId==MAD_88E1540||(_dev)->deviceId==MAD_88E1548||(_dev)->deviceId==MAD_88E1680)?0x2200:0)  /*/<Per EtherType statistics */
...
/*
 *------------------------------------------------------------------
 * $Log: msec_defines.h,v $
 * Revision 1.1  2015/02/13 11:35:40  iachang
