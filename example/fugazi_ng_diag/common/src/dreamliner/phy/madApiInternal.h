/* $Id: madApiInternal.h,v 1.1 2015/02/13 11:35:39 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/phy/madApiInternal.h,v $
 *------------------------------------------------------------------
 *
