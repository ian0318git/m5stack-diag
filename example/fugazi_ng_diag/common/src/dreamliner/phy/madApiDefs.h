/* $Id: madApiDefs.h,v 1.1 2015/02/13 11:35:39 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/phy/madApiDefs.h,v $
 *------------------------------------------------------------------
 *
...
#define IS_MARVELL_OUI(_reg2,_reg3)  (((_reg2)==0x0141) && (((_reg3)&0xFC00)==0x0C00))
...

{
    ...
    MAD_88E1680  = 0x2E,    /* 88E1680, 1680L */

    MAD_88E3183  = 0x33,     /* 88E3183 */
...

{
    ...
    FMAD_READ_XMII     fmadReadXMii;

    FMAD_WRITE_XMII    fmadWriteXMii;
