/* $Id: madSmiIf.h,v 1.1 2015/02/13 11:35:39 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/phy/madSmiIf.h,v $
 *------------------------------------------------------------------
 *
 * madSmiIf.h - Includes functions prototypes for initializing and accessing the
 *       MII / SMI interface.
