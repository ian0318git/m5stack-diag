/* $Id: prvCpssGenEvReq.h,v 1.1 2015/02/13 11:31:17 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/common/h/cpss/generic/events/private/prvCpssGenEvReq.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
STR(CPSS_PP_GTS_VALID_TIME_SAMPLE_MESSAGE _E),  /* 342 */                       \
                                                                                \
    /**************************** Critical HW Error ***************************/\
STR(CPSS_PP_CRITICAL_HW_ERROR_E _E),  /* 343 */                                 \
                                                                                \
...
STR(CPSS_PP_PORT_MPCS_GB_LOCK_SYNC_CHANGE_E),  /* 354 */                        \
                                                                                \
    /**************************** DFX Server related events *******************/\
STR(CPSS_PP_DATA_INTEGRITY_ERROR_E),           /* 355 */                        \
                                                                                \
    /************************** Xbar events ********************************/   \
                                                                                \
                                                                                \
STR(CPSS_XBAR_HG_LANE_SYNCH_CHANGE_E),   /* 356 */                              \
STR(CPSS_XBAR_HG_LANE_COMMA_ALIGN_CHANGE_E),   /* 357 */                        \
STR(CPSS_XBAR_GPORT_INVALID_TRG_DROP_CNT_INC_E),   /* 358 */                    \
STR(CPSS_XBAR_GPORT_DIAG_CELL_RX_CNTR_INC_E),   /* 359 */                       \
STR(CPSS_XBAR_MISC_E),   /* 360 */                                              \
STR(CPSS_XBAR_HG_PING_RECEIVED_E),   /* 361 */                                  \
STR(CPSS_XBAR_HOST_RX_FIFO_PEND_E),   /* 362 */                                 \
STR(CPSS_XBAR_HOST_SEND_CELL_E),   /* 363 */                                    \
STR(CPSS_XBAR_HG_ALIGNMENT_LOCK_CHANGE_E),   /* 364 */                          \
STR(CPSS_XBAR_HG_PING_E),   /* 365 */                                           \
STR(CPSS_XBAR_SD_INV_ADDR_E),   /* 366 */                                       \
STR(CPSS_XBAR_SXBAR_INV_ADDR_E),   /* 367 */                                    \
STR(CPSS_XBAR_S_INV_ADDR_E),   /* 368 */                                        \
STR(CPSS_XBAR_G_INV_ADDR_E),   /* 369 */                                        \
STR(CPSS_XBAR_MC_INV_ADDR_E),   /* 370 */                                       \
                                                                                \
                                                                                \
                                                                                \
                                                                                \
    ...
    /************************** Fa events **********************************/   \
                                                                                \
                                                                                \
STR(CPSS_FA_UC_PRIO_BUF_FULL_E),   /* 371 */                                    \
STR(CPSS_FA_MC_PRIO_BUF_FULL_E),   /* 372 */                                    \
STR(CPSS_FA_UC_RX_BUF_FULL_E),   /* 373 */                                      \
STR(CPSS_FA_MC_RX_BUF_FULL_E),   /* 374 */                                      \
STR(CPSS_FA_WD_FPORT_GRP_E),   /* 375 */                                        \
STR(CPSS_FA_MC_WD_EXP_E),   /* 376 */                                           \
STR(CPSS_FA_GLBL_DESC_FULL_E),   /* 377 */                                      \
STR(CPSS_FA_MAC_UPD_THRS_E),   /* 378 */                                        \
STR(CPSS_FA_DROP_DEV_EN_E),   /* 379 */                                         \
STR(CPSS_FA_MISC_I2C_TIMEOUT_E),   /* 380 */                                    \
STR(CPSS_FA_MISC_STATUS_E),   /* 381 */                                         \
                                                                                \
                                                                                \
                                                                                \
                                                                                \
    ...
    /************************** DRAGONITE events ***************************/   \
                                                                                \
                                                                                \
STR(CPSS_DRAGONITE_PORT_ON_E),  /* 382 */                                       \
STR(CPSS_DRAGONITE_PORT_OFF_E),  /* 383 */                                      \
STR(CPSS_DRAGONITE_DETECT_FAIL_E),  /* 384 */                                   \
STR(CPSS_DRAGONITE_PORT_FAULT_E),  /* 385 */                                    \
STR(CPSS_DRAGONITE_PORT_UDL_E),  /* 386 */                                      \
STR(CPSS_DRAGONITE_PORT_FAULT_ON_STARTUP_E),  /* 387 */                         \
STR(CPSS_DRAGONITE_PORT_PM_E),  /* 388 */                                       \
STR(CPSS_DRAGONITE_POWER_DENIED_E),  /* 389 */                                  \
STR(CPSS_DRAGONITE_OVER_TEMP_E),  /* 390 */                                     \
STR(CPSS_DRAGONITE_TEMP_ALARM_E),  /* 391 */                                    \
STR(CPSS_DRAGONITE_DEVICE_FAULT_E),  /* 392 */                                  \
STR(CPSS_DRAGONITE_OVER_CONSUM_E),  /* 393 */                                   \
STR(CPSS_DRAGONITE_VMAIN_LOW_AF_E),  /* 394 */                                  \
STR(CPSS_DRAGONITE_VMAIN_LOW_AT_E),  /* 395 */                                  \
STR(CPSS_DRAGONITE_VMAIN_HIGH_E),  /* 396 */                                    \
STR(CPSS_DRAGONITE_READ_EVENT_E),  /* 397 */                                    \
STR(CPSS_DRAGONITE_WRITE_EVENT_E),  /* 398 */                                   \
STR(CPSS_DRAGONITE_ERROR_E)  /* 399 */
...
/*
 *------------------------------------------------------------------
 * $Log: prvCpssGenEvReq.h,v $
 * Revision 1.1  2015/02/13 11:31:17  iachang
