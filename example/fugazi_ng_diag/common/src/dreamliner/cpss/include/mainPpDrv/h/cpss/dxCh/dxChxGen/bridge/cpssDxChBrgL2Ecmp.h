/* $Id: cpssDxChBrgL2Ecmp.h,v 1.1 2015/02/13 11:31:30 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/bridge/cpssDxChBrgL2Ecmp.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
 ...
 *      ecmpNumOfPaths  - The number of paths in the ECMP block: (APPLICABLE RANGES: 0..63)
 *                        0x0 = 1 path, 0x1 = 2 paths and so on.
