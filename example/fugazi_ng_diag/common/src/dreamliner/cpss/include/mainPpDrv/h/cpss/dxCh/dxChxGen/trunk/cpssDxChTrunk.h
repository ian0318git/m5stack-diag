/* $Id: cpssDxChTrunk.h,v 1.1 2015/02/13 11:32:56 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/trunk/cpssDxChTrunk.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
*               DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; Lion; xCat2; - Supports up to 127 trunks.
...
/*
 * typedef: enum CPSS_DXCH_TRUNK_MEMBERS_SELECTION_FUNCTION_ENT
 *
 *      Description: enumerator that hold values for the type of how the
 *                   trunk member is selected.
 *
 * Enumerations:
 *      CPSS_DXCH_TRUNK_MEMBERS_SELECTION_FUNCTION_MODULO_E - backward compatible mode.
 *                  Performs a modulo function on the 6 lsbits of the hash,
 *                  i.e. the trunk member is Hash[5:0] % #of members.
 *
 *      CPSS_DXCH_TRUNK_MEMBERS_SELECTION_FUNCTION_DIVISION_E - In this mode the
 *                 "Index Resolution" block is used to compute the trunk member.
 *
 */
typedef enum {
    CPSS_DXCH_TRUNK_MEMBERS_SELECTION_FUNCTION_MODULO_E = 0,
    CPSS_DXCH_TRUNK_MEMBERS_SELECTION_FUNCTION_DIVISION_E
}CPSS_DXCH_TRUNK_MEMBERS_SELECTION_FUNCTION_ENT;
...
/*******************************************************************************
* cpssDxChTrunkMemberSelectionFunctionSet
*
* DESCRIPTION:
*       Function Relevant mode : ALL modes
*
*      Determines the function used in the trunk member selection
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
* INPUTS:
*       devNum              - device number
*       selectionFunction   - Selection function
*
* OUTPUTS:
*       None.
*
...
*
*******************************************************************************/
GT_STATUS cpssDxChTrunkMemberSelectionFunctionSet
(
    IN GT_U8                                            devNum,
    IN CPSS_DXCH_TRUNK_MEMBERS_SELECTION_FUNCTION_ENT   selectionFunction
);

/*******************************************************************************
* cpssDxChTrunkMemberSelectionFunctionGet
*
* DESCRIPTION:
*       Function Relevant mode : ALL modes
*
*       Return the function used in the trunk member selection
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
*
* OUTPUTS:
*       selectionFunctionPtr    - (pointer to) Selection function.
*
* RETURNS:
*       GT_OK                    - on success.
*       GT_BAD_PARAM             - on wrong input parameters
...
*
*******************************************************************************/
GT_STATUS cpssDxChTrunkMemberSelectionFunctionGet
(
    IN  GT_U8                                               devNum,
    OUT CPSS_DXCH_TRUNK_MEMBERS_SELECTION_FUNCTION_ENT      *selectionFunctionPtr
);
...
*       Relevant when
*       selectionFunction == CPSS_DXCH_TRUNK_MEMBERS_SELECTION_FUNCTION_DIVISION_E
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
/*
 *------------------------------------------------------------------
 * $Log: cpssDxChTrunk.h,v $
 * Revision 1.1  2015/02/13 11:32:56  iachang
