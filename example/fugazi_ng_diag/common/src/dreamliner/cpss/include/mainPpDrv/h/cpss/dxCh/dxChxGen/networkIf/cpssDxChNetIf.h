/* $Id: cpssDxChNetIf.h,v 1.1 2015/02/13 11:32:14 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/networkIf/cpssDxChNetIf.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
*       designatedDevNum - The designated device number
*
* OUTPUTS:
*       None
*
...
(
    IN GT_U8            devNum,
    IN GT_U32           index,
    IN GT_HW_DEV_NUM    designatedDevNum
);
...
(
    IN  GT_U8           devNum,
    IN  GT_U32          index,
    OUT GT_HW_DEV_NUM   *designatedDevNumPtr
);
