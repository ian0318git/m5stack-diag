/* $Id: cpssDxChPortCn.h,v 1.1 2015/02/13 11:32:31 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/port/cpssDxChPortCn.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
(
    ...
    IN GT_BOOL  enable,
    IN GT_U8    targetDev,
    IN GT_PHYSICAL_PORT_NUM    targetPort
);
...
(
    ...
    OUT GT_PHYSICAL_PORT_NUM   *targetPortPtr
);
