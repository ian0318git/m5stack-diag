/* $Id: cpssDxChIpLpm.h,v 1.1 2015/02/13 11:32:01 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/ipLpmEngine/cpssDxChIpLpm.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
*
* OUTPUTS:
*       numOfDevsPtr   - the number of devices retreived
...
*
* NOT APPLICABLE DEVICES:
*        DxCh1; DxCh1_Diamond; DxCh2; xCat; xCat2; Lion; Lion2; Lion3.
*
* INPUTS:
*       lpmDBId                   - the LPM DB id.
...
/*
 *------------------------------------------------------------------
 * $Log: cpssDxChIpLpm.h,v $
 * Revision 1.1  2015/02/13 11:32:01  iachang
