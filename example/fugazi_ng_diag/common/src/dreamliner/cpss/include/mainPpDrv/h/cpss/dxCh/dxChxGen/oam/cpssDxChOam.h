/* $Id: cpssDxChOam.h,v 1.1 2015/02/13 11:32:20 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/oam/cpssDxChOam.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
 ...
 *                                  loss measurement treatment;
 *   lmCountingEnable           -   Determines which packets are counted by the
 *                                  Loss Measurement counters;
 *                                  GT_FALSE - disable loss measurement counting;
 *                                  GT_TRUE - enable loss measurement counting;
 *   offsetIndex                -   Relevant only for Egress OAM.
...
/*
 *  typedef: enum CPSS_DXCH_OAM_TIMESTAMP_MODE_ENT
 *
 *  Description: Enumeratiom of timestamp mode
 *
 *  Enumerations:
 *
 *      CPSS_DXCH_OAM_TIMESTAMP_MODE_INSERT_E
 *                                      - Insert OAM timestamp mode.
 *
 *      CPSS_DXCH_OAM_TIMESTAMP_MODE_MODIFY_E
 *                                      - Modify OAM timestamp mode.
 */
typedef enum {
    CPSS_DXCH_OAM_TIMESTAMP_MODE_INSERT_E,
    CPSS_DXCH_OAM_TIMESTAMP_MODE_MODIFY_E
}CPSS_DXCH_OAM_TIMESTAMP_MODE_ENT;

/*
 *  typedef: enum CPSS_DXCH_OAM_TIMESTAMP_FORMAT_ENT
 *
 *  Description: Enumeratiom of timestamp format
 *
 *  Enumerations:
 *
 *      CPSS_DXCH_OAM_TIMESTAMP_FORMAT_Y1731_E
 *                                      - Y1731 standard timestamp format.
 *
 *      CPSS_DXCH_OAM_TIMESTAMP_FORMAT_NTP_E
 *                                      - NTP standard timestamp format.
 *
 *      CPSS_DXCH_OAM_TIMESTAMP_FORMAT_1588V2_E
 *                                      - 1588v2 standard timestamp format.
 *
*/
typedef enum {
    CPSS_DXCH_OAM_TIMESTAMP_FORMAT_Y1731_E,
    CPSS_DXCH_OAM_TIMESTAMP_FORMAT_NTP_E,
    CPSS_DXCH_OAM_TIMESTAMP_FORMAT_1588V2_E
}CPSS_DXCH_OAM_TIMESTAMP_FORMAT_ENT;

/*
 *  typedef: enum CPSS_DXCH_OAM_TIMESTAMP_ACTION_ENT
 *
 *  Description: Enumeratiom of timestamp action
 *
 *  Enumerations:
 *      CPSS_DXCH_OAM_TIMESTAMP_ACTION_NONE_E
 *                                      - egress PTP unit action according to egress parsing.
 *
 *      CPSS_DXCH_OAM_TIMESTAMP_ACTION_FORWARD_E
 *                                      - egress PTP unit action is forward.
 *
 *      CPSS_DXCH_OAM_TIMESTAMP_ACTION_DROP_E
 *                                      - egress PTP unit action is drop.
 *
 *      CPSS_DXCH_OAM_TIMESTAMP_ACTION_CAPTURE_E
 *                                      - egress PTP unit action is capture.
 *
 *      CPSS_DXCH_OAM_TIMESTAMP_ACTION_ADD_TIME_E
 *                                      - egress PTP unit action is add time.
 *
 *      CPSS_DXCH_OAM_TIMESTAMP_ACTION_ADD_CORRECTED_TIME_E
 *                                      - egress PTP unit action is add corrected time.
*/
typedef enum {
    CPSS_DXCH_OAM_TIMESTAMP_ACTION_NONE_E,
    CPSS_DXCH_OAM_TIMESTAMP_ACTION_FORWARD_E,
    ...
    CPSS_DXCH_OAM_TIMESTAMP_ACTION_ADD_TIME_E,
    CPSS_DXCH_OAM_TIMESTAMP_ACTION_ADD_CORRECTED_TIME_E
}CPSS_DXCH_OAM_TIMESTAMP_ACTION_ENT;

/*
 *  typedef: struct CPSS_DXCH_OAM_TIMESTAMP_OFFSET_ENTRY_STC
 *
 *  Description: Structure of Timestamp Offset Table
 *
 *  Fields:
 *      timeStampMode
 ...
 *                      - Timestamp format.
 *      timeStampOffsetType
 *                      - Valid if <Timestamping Mode>==ModifyTSTag,
 *                        and the <Action> field is Capture, AddTime,
 *                        or AddCorrectedTime.
 *      timeStampAction
 *                      - Timestamp egress PTP action.
 *
 *
*/
typedef struct {
    CPSS_DXCH_OAM_TIMESTAMP_MODE_ENT    timeStampMode;
    GT_U32                              timeStampOffset;
    CPSS_DXCH_OAM_TIMESTAMP_FORMAT_ENT  timeStampFormat;
    GT_U32                              timeStampOffsetType;
    CPSS_DXCH_OAM_TIMESTAMP_ACTION_ENT  timeStampAction;
}CPSS_DXCH_OAM_TIMESTAMP_OFFSET_ENTRY_STC;
...
/*******************************************************************************
* cpssDxChOamTimestampOffsetTableSet
*
* DESCRIPTION:
*      Set Timestamp Offset Table Entry
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
* INPUTS:
*       devNum                   - device number.
*       entryIndex               - entry index: (APPLICABLE RANGES: 0..15).
*       timeStampOffsetTablePtr  - pointer to timestamp offset table entry.
*
* OUTPUTS:
*       None.
*
...
*       GT_BAD_PTR               - one of the parameters is NULL pointer.
*       GT_OUT_OF_RANGE          - one of the fields in CPSS_DXCH_OAM_TIMESTAMP_OFFSET_ENTRY_STC
*                                  is out of range.
*       GT_NOT_APPLICABLE_DEVICE - on not applicable device.
*
* COMMENTS:
*
*******************************************************************************/
GT_STATUS cpssDxChOamTimestampOffsetTableSet
(
    IN  GT_U8                                       devNum,
    IN  GT_U32                                      entryIndex,
    IN  CPSS_DXCH_OAM_TIMESTAMP_OFFSET_ENTRY_STC    *timeStampOffsetTablePtr
);

/*******************************************************************************
* cpssDxChOamTimestampOffsetTableGet
*
* DESCRIPTION:
*      Get Timestamp Offset Table Entry
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
*
*******************************************************************************/
GT_STATUS cpssDxChOamTimestampOffsetTableGet
(
    IN  GT_U8                                       devNum,
    IN  GT_U32                                      entryIndex,
    OUT CPSS_DXCH_OAM_TIMESTAMP_OFFSET_ENTRY_STC    *timeStampOffsetTablePtr
);
...
*       devNum                   - device number.
*       entryIndex               - entry index: (APPLICABLE RANGES: 0..15).
*       offset                   - LM offset in bytes: (APPLICABLE RANGES: 0..255).
*
* OUTPUTS:
*       None.
*
 ...
 *------------------------------------------------------------------
 * $Log: cpssDxChOam.h,v $
 * Revision 1.1  2015/02/13 11:32:20  iachang
