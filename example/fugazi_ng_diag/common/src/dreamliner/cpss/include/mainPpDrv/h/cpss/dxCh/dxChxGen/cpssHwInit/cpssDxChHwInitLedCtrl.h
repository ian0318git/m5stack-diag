/* $Id: cpssDxChHwInitLedCtrl.h,v 1.1 2015/02/13 11:31:44 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/cpssHwInit/cpssDxChHwInitLedCtrl.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
*
* NOT APPLICABLE DEVICES:
*        DxCh1; DxCh1_Diamond; DxCh2; Lion; Lion2; Lion3.
*
* INPUTS:
*       devNum   - physical device number
...
*                         (APPLICABLE RANGES: DxCh1, DxCh2, DxCh3, xCat, xCat2 0..1;
*                         Lion, Lion2 0..0)
*       portType        - tri-speed or XG port type.
*       classNum        - class number.
*                         For tri-speed ports: (APPLICABLE RANGES: 0..6)
*                         For XG ports: (APPLICABLE RANGES: 0..11)
...
/*
 *------------------------------------------------------------------
 * $Log: cpssDxChHwInitLedCtrl.h,v $
 * Revision 1.1  2015/02/13 11:31:44  iachang
