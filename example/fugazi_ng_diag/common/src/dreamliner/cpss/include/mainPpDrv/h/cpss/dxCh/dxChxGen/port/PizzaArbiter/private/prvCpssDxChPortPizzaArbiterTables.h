/* $Id: prvCpssDxChPortPizzaArbiterTables.h,v 1.1 2015/02/13 11:32:35 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/port/PizzaArbiter/private/prvCpssDxChPortPizzaArbiterTables.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
/* default Profiles               */
/*--------------------------------*/
const extern CPSS_DXCH_PORT_PIZZA_PORTGROUP_SPEED_TO_SLICENUM_STC prvPortGroupPortSpeed2SliceNumDefault;
const extern ListDevRevTypeClockPizza_STC    prvListDevRevTypeClock2PizzaDefault;
...
/*
 *------------------------------------------------------------------
 * $Log: prvCpssDxChPortPizzaArbiterTables.h,v $
