/* $Id: cpssDxChBrgStp.h,v 1.1 2015/02/13 11:31:30 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/bridge/cpssDxChBrgStp.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
/* NOTE:
    ...
    devices with more then 64 ports (Lion2 0..127) use 8 words.

*/
#define CPSS_DXCH_STG_ENTRY_SIZE_CNS    8
