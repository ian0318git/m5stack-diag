/* $Id: cpssDxChPortPizzaArbiterProfile.h,v 1.1 2015/02/13 11:32:33 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/port/PizzaArbiter/cpssDxChPortPizzaArbiterProfile.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
typedef struct CPSS_DXCH_PORT_SPEED_TO_SLICE_NUM_STCT
{
...
typedef struct CPSS_DXCH_PORT_SPEED_TO_SLICENUM_LIST_ITEM_STC
{
    GT_U32 portN;
...
typedef struct CPSS_DXCH_PORT_PIZZA_PORTGROUP_SPEED_TO_SLICENUM_STCT
{
    /*GT_U32                                    portN;  */
...
typedef struct CPSS_DXCH_PORT_PRIORITY_MATR_STC
{
    GT_U32         portN;
...
/*--------------------------------------------------------*/
typedef struct CPSS_DXCH_PORT_PIZZA_CFG_PORT_SLICE_LIST_STCT
{
    GT_U32                   maxPortNum; 
...
/*                          port priority graph                       */
/*--------------------------------------------------------------------*/
typedef struct SliceNumXPortPizzaCfgSlicesList_STCT
{
...
typedef struct CPSS_DXCH_PORT_PIZZA_SLICENUM_TO_SLICE_LIST_STCT
{
    GT_U32                                  portNum;
    GT_U32                                  totalSlices;
...
typedef struct CPSS_DXCH_CPU_PORTDEF_STCT
{
...
/*
 *------------------------------------------------------------------
 * $Log: cpssDxChPortPizzaArbiterProfile.h,v $
