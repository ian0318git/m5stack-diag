/* $Id: cpssDxChPcl.h,v 1.1 2015/02/13 11:32:21 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/pcl/cpssDxChPcl.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
/* Size of Lion3 action is 7 words                    */
/* Size of DxCh3, xCat, Lion, xCat2 , Lion2 action is 4 words */
#define CPSS_DXCH_PCL_ACTION_SIZE_IN_WORDS_CNS 7

/* Rule entry size in words - defined by Lion3 size 7 x 3 words */
 ...
 *                  to valid state.
 *                  (APPLICABLE DEVICES: DxCh3, xCat, Lion, xCat2, Lion2, Lion3)
 *      CPSS_DXCH_PCL_RULE_OPTION_KEY_EXTENSION_ENABLED_E - if set
 *                  enables extending any standard or extended rules
 *                  with a static extension of 26 Bytes defined
 *                  in CPSS_DXCH_PCL_RULE_FORMAT_KEY_INGRESS_EXTENSION_STC
 *                   or CPSS_DXCH_PCL_RULE_FORMAT_KEY_EGRESS_EXTENSION_STC.
...
typedef enum
{
    ...
    CPSS_DXCH_PCL_RULE_OPTION_KEY_EXTENSION_ENABLED_E  = (0x1 << 1)
 ...
 *       ingressMirrorToAnalyzerIndex - index of analyzer interface (APPLICABLE RANGES: 0..6)
 *                  (APPLICABLE DEVICES: Lion3)
 ...
 *                  NOTE: for DxCh3 and above the index range is (APPLICABLE RANGES: 0..(16K-1))
 *
 ...
 *
 *    ingress members:
 *    modifyDscp             - The Modify DSCP QoS attribute of the packet.
 ...
 *                             0..127 for DxCh2, DxCh3, xCat, Lion, xCat2, Lion2
 *                             0..255 for Lion3.
 ...
 *
 *    up1Cmd                 - (APPLICABLE DEVICES: Lion3)
 *                              command for setting the Tag1 UP value.
 *    up1                    - (APPLICABLE DEVICES: Lion3)
 *                              The UP1 value to assign to the packet
 *                              according to up1Cmd.
 *    egress members:
 *    modifyDscp             - enable modify DSCP
 *                             GT_TRUE - modify DSCP, GT_FALSE - don't modify DSCP.
 *    dscp                   - The DSCP field set to the transmitted packets.
 ...
 *                     (APPLICABLE DEVICES: DxCh2, DxCh3, xCat, Lion, xCat2, Lion2, Lion3).
 ...
 *                      (relevant only if tunnelStart == GT_FALSE)
 *                      (APPLICABLE DEVICES: Lion, xCat2, Lion2, Lion3).
 ...
 *                      (APPLICABLE DEVICES: DxCh3, xCat, Lion, Lion2, Lion3).
 *
 *  Comments:
 *
 */
 ...
 *       vlanId1ModifyEnable - (APPLICABLE DEVICES: Lion3)
 ...
 *
 * APPLICABLE DEVICES: DxCh1, DxCh1_Diamond, xCat, Lion, xCat2, Lion2, Lion3.
 *
 * Fields:
 ...
 *                      Relevant to Policy Action Entry only.
 *      oam          -  OAM relevant fields. (APPLICABLE DEVICES: Lion3)
 *      flowId       -  flow Id. (APPLICABLE DEVICES: Lion3)
 *                      Relevant for ingress actions only.
 *
 * Comment:
 */
 ...
 *                 (APPLICABLE DEVICES: xCat, Lion, xCat2, Lion2, Lion3)
 *
 ...
 *    (APPLICABLE DEVICES: Lion3)
 *    CPSS_DXCH_PCL_UDB_OVERRIDE_TYPE_FLOW_ID_E     - 20-bits flow Id -
 *                                                  valid for ingress key extension only.
 *                                                  Note that 3 UDBs are overridden.
 *    (APPLICABLE DEVICES: Lion3)
 * Comment:
 ...
 *           Trunk hash in UDB3
 *           QoS profile in UDB5
 *     Ingress Key Extension:
 *           Flow Id in UDBs 40,41,42 (20 bits)
 *           relevant for all Keys.
 *
 */
typedef enum
{
 ...
 *                                             to calculate index of the PCL
 *                                             configuration table
 *   CPSS_DXCH_PCL_PORT_LOOKUP_CFG_TAB_ACC_MODE_BY_INDEX_E - By Index access mode
 *                                             Index of the PCL configuration
 *                                             table entry specified explicitly.
 *                                             Supported only for Egress PCL.
 *                                             (APPLICABLE DEVICES: Lion3)
 * Comment:
 *
 */
typedef enum
{
    ...
    CPSS_DXCH_PCL_PORT_LOOKUP_CFG_TAB_ACC_MODE_BY_INDEX_E
...
/*
 * Typedef: struct CPSS_DXCH_PCL_RULE_FORMAT_KEY_INGRESS_EXTENSION_STC
 *
 * Description:
 *     This structure describes the optional ingress key extension.
 *     (APPLICABLE DEVICES: Lion3).
 *
 * Fields:
 *     tag1Exist        - 0 - Tag1 presents in packet.
 *                        1 - Tag1 does not present in packet.
 ...
 *     srcPort          - Contains srcPort bits [19:0].
 *     flowId           - flow Id (muxed with UDB40-42)
 *     udb23_42           User defined bytes 23 - 42.
 *                        UDB40-42 muxed with FlowId.
 *
 *  Comments:
 *     The last 3 UDBs of udb23_42 parameter holds UDBs 40-42 or FlowId value.
 *     Use cpssDxChPclPortGroupOverrideUserDefinedBytesEnableSet API or
 *     cpssDxChPclOverrideUserDefinedBytesEnableSet API for that selection.
 *     This can be done for any keyFormat.
 */
typedef struct
{
    GT_U32           tag1Exist;
    ...
    GT_U32           flowId;
    GT_U8            udb23_42[20];
} CPSS_DXCH_PCL_RULE_FORMAT_KEY_INGRESS_EXTENSION_STC;

/*
 * Typedef: struct CPSS_DXCH_PCL_RULE_FORMAT_KEY_EGRESS_EXTENSION_STC
 *
 * Description:
 *     This structure describes the optional egress key extension.
 *     (APPLICABLE DEVICES: Lion3).
 *
 * Fields:
 *     tag1Vid                - Tag1 VID.
 ...
 *     tag1Cfi                - Tag1 CFI.
 *     srcPort                - Contains srcPort bits [19:0].
 *     trgPort                - Contains trgPort bits [19:0].
 *     trgPhysicalPort        - local target port (8-bit value).
 *     flowId                 - flow Id
 *     udbValid               - 1 - all UDBs valid,
 *                              0 - there is an invalid UDB.
 *     udb0_3                 - UDB0-3.
 *                              UDB3 muxed with mplsLabel2 bits[7:0]
 *     isMpls                 - 1 - MPLS, 0 - not MPLS.
 *     numOfMplsLabels        - number of MPLS Labels (APPLICABLE RANGES: 0..3).
 *     protocolTypeAfterMpls  - inner protocol type (2-bit value)
 *     mplsLabel0             - MPLS Label0.
 *     mplsExp0               - MPLS Exp0.
 *     mplsLabel1             - MPLS Label1.
 *     mplsExp1               - MPLS Exp1.
 *     mplsLabel2             - MPLS Label2.
 *                              mplsLabel2 bits[7:0]
 *                              muxed with UDB3 (udb0_3[3]).
 *     mplsExp2               - MPLS Exp2.
 *
 *  Comments:
 */
...
} CPSS_DXCH_PCL_RULE_FORMAT_KEY_EGRESS_EXTENSION_STC;
 ...
 *                   Field muxing description(APPLICABLE DEVICES: xCat2, Lion2, Lion3):
 *                   sourcePort is muxed with portListBmp[15:8]
 *     sourceTrunkId - The id of the trunk from which the packet
 *                   ingressed the device.
 *                   sourceTrunkId is muxed with portListBmp[27:16].
 *                   (APPLICABLE DEVICES: Lion3).
 *     portListBmp   - Port list bitmap. (APPLICABLE DEVICES: xCat2, Lion2, Lion3).
 ...
 *                   For DxCh, DxCh2, DxCh3, xCat, Lion, xCat2, Lion2
 *                   VLAN Id is 12 bit.
 *                   For Lion3 devices support of 16-bit VLAN Id.
 *                   Standard keys contain bits 11:0 only.
 *                   Any key with extension contains all 16 bits.
 ...
 *     extension  - rule extension (APPLICABLE DEVICES: Lion3).
 *                  Relevant only when Rule Set function parameter
 *                  ruleOptionsBmp contains bit
 *                  CPSS_DXCH_PCL_RULE_OPTION_KEY_EXTENSION_ENABLED_E
 *     isIpv4      - An indication that the packet is IPv4.
 *                  0 = Non IPv4 packet.
 *                  1 = IPv4 packet.
 ...
 *     vrfId      - VRF Id (APPLICABLE DEVICES: xCat, Lion, Lion2, Lion3)
 *                  vrfId[7:0]  muxed with UDB 15
 *                  vrfId[11:8] muxed with UDB 16
 *     trunkHash  - Trunk Hash (APPLICABLE DEVICES: Lion, xCat2, Lion2, Lion3)
...
typedef struct
{
    ...
    CPSS_DXCH_PCL_RULE_FORMAT_KEY_INGRESS_EXTENSION_STC extension;
    GT_U8                                               isIpv4;
    GT_U16                                              etherType;
    GT_U8                                               isArp;
    GT_U32                                              l2Encap;
 ...
 * sourcePort       - The port number from which the packet ingressed the device.
 *                     Port 63 is the CPU port.
 * sourceTrunkId    -  The id of trunk from which the packet
 *                     ingressed the device.
 *                     (APPLICABLE DEVICES: Lion3).
 * portListBmp       - Port list bitmap. (APPLICABLE DEVICES: xCat2, Lion2, Lion3).
 *                     Relevant only when PCL lookup works in port-list mode.
 *                     This is the field muxing:
 *                     portListBmp is muxed with pclId[7:0]  sourcePort
 *                     portListBmp is muxed also with sourceTrunkId
 *                     (APPLICABLE DEVICES: Lion2, Lion3).
 *                     The portListBmp bits in rule's mask and pattern
 *                     should be set to 0 (don't care) for matched ports.
 *                     The portListBmp bits in rule's mask should be 1 and
 ...
 *                     vrfId[11:8] muxed with UDB 1
 * qosProfile       -  QoS Profile(APPLICABLE DEVICES: xCat, Lion, xCat2, Lion2, Lion3)
 ...
 *                   Relevant only when packet is of type is FORWARD.
 *                   Fields srcTrunkId and srcDev are muxed.
 *                   For DxCh2, DxCh3, xCat, Lion, xCat2, Lion2
 *                   Trunk Id is 7 bit.
 *                   For Lion3 devices supported 12-bit Trunk Id.
 *                   Standard keys contain bits 6:0 only.
 *                   Extended keys and any keys with extension
 *                   contain all 12 bits.
 ...
 *                   For Lion3 devices supported 12-bit HW Device Ids.
 ...
 *                   For DxCh2, DxCh3, xCat, Lion, xCat2, Lion2
 *                   Source Id is 5 bit.
 *                   For Lion3 devices supported 12-bit Source Id.
 *                   Standard keys contain bits 4:0 only.
 *                   Extended keys and any keys with extension
 *                   contain all 12 bits.
...
typedef struct
{
    ...
    CPSS_DXCH_PCL_RULE_FORMAT_KEY_EGRESS_EXTENSION_STC extension;
    GT_U8                                              isIpv4;
    GT_U16                                             etherType;
    GT_U8                                              isArp;
    GT_U32                                             l2Encap;
 ...
 *     cfi1        -  CFI from Tag1, valid only if Tag1 exist.
 *                   (APPLICABLE DEVICES: Lion3)
 *     isMpls      - (APPLICABLE DEVICES: Lion3)
 *                   1 - MPLS, 0 - not MPLS.
 *     numOfMplsLabels - (APPLICABLE DEVICES: Lion3)
 *                   number of MPLS Labels (APPLICABLE RANGES: 0..3).
 *     protocolTypeAfterMpls  - (APPLICABLE DEVICES: Lion3)
 *                   inner protocol type (2-bit value)
 *     mplsLabel0  - (APPLICABLE DEVICES: Lion3)  MPLS Label0.
 *     mplsExp0    - (APPLICABLE DEVICES: Lion3)  MPLS Exp0.
 *     mplsLabel1  - (APPLICABLE DEVICES: Lion3)  MPLS Label1.
 *     mplsExp1    - (APPLICABLE DEVICES: Lion3) MPLS Exp1.
 *
 *  Comments:
 */
typedef struct
 ...
 *    enableKeyExtension     - (APPLICABLE DEVICES: Lion3)
 *                             Generate key with ePort-eVlan Architecture
 *                             extension. This extension contains extended
 *                             interface values and increases the size of
 *                             the key: standard to extended, extended to
 *                             ultra.
 *                             GT_TRUE  - Generate key with extension.
 *                             GT_FALSE - Generate key without extension.
...
*                      For Lion3 relevant for ingress only.
*       direction    - Policy direction:
*                      Ingress or Egress.(APPLICABLE DEVICES: Lion3)
*                      Ignored, configure ingress.
*                      (APPLICABLE DEVICES: DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; Lion; xCat2)
...
*                          When ruleOptionsBmp contains bit
*                          CPSS_DXCH_PCL_RULE_OPTION_KEY_EXTENSION_ENABLED_E
*                          (APPLICABLE DEVICES Lion3),
*                          the real HW size for rule with extention
*                          will be increased:
...
*                          Samples:
*                            ruleOptionsBmp = 0 - no options are defined.
*                            ruleOptionsBmp = CPSS_DXCH_PCL_RULE_OPTION_KEY_EXTENSION_ENABLED_E -
*                               Rule Extension field extracted.
*
* OUTPUTS:
...
*
* DESCRIPTION:
*    Configures VLAN/PORT/Index access mode to Ingress or Egress PCL
...
*                      Port or VLAN ID or index
*    entryIndex      - Configuration table index for user based ACLs.
*                      Controls the index used for PCL lookup.Relevant only for
*                      Egress PCL where mode equals to
*                      CPSS_DXCH_PCL_PORT_LOOKUP_CFG_TAB_ACC_MODE_BY_INDEX_E
*                      (APPLICABLE DEVICES: Lion3)
* OUTPUTS:
*       None
...
*
* DESCRIPTION:
*    Gets VLAN/PORT/Index access mode to Ingress or Egress PCL
*    configuration table per lookup.
*
* APPLICABLE DEVICES:
*        DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; Lion; xCat2; Lion2; Lion3.
...
*                      Port or VLAN ID or index
*    entryIndexPtr   - (pointer to)Configuration table index for user based ACLs.
*                      Controls the index used for PCL lookup.Relevant only for
*                      CPSS_DXCH_PCL_PORT_LOOKUP_CFG_TAB_ACC_MODE_BY_INDEX_E
*                      (APPLICABLE DEVICES: Lion3)
*
...
* INPUTS:
*       devNum        - device number
*       index         - UDE Ethertype index, (APPLICABLE RANGES:  0..4)
 ...
 *------------------------------------------------------------------
 * $Log: cpssDxChPcl.h,v $
 * Revision 1.1  2015/02/13 11:32:21  iachang
