/* $Id: mvHwsPortApInitIfPrv.h,v 1.1 2015/02/13 11:34:59 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/generic/port/private/portHwConfig/port/private/mvHwsPortApInitIfPrv.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
typedef struct
{
    unsigned long int checkCounter;
    unsigned long int apPortControl[AP_Ports_Num];
    unsigned long int apPortStatus[AP_Ports_Num];
    MV_HWS_AP_TIMER_INFO apTimerList[AP_Ports_Num];
	unsigned long int apPortActiveLanes[AP_Ports_Num];
    unsigned char minVersion;
    unsigned char fwVersion;
	unsigned char buff[2];
	unsigned long int portResolutionMask;
	unsigned long int portInitMask;
	unsigned long int reserved;
    unsigned long int flag;
    unsigned long int debug[6];
    unsigned long int portDebug[AP_Ports_Num];
    /*unsigned long int debug[8];*/
...
#define AP_CONTROL_PORT_INIT_GET(apPortControl)  ((apPortControl >> 24) & 0x1)
#define AP_CONTROL_PORT_INIT_SET(apPortControl,val)                     \
