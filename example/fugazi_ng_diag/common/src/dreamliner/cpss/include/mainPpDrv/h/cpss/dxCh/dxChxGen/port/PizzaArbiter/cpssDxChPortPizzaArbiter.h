/* $Id: cpssDxChPortPizzaArbiter.h,v 1.1 2015/02/13 11:32:33 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/port/PizzaArbiter/cpssDxChPortPizzaArbiter.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
#include <cpss/dxCh/dxChxGen/port/PizzaArbiter/private/prvCpssDxChPortPizzaArbiterTables.h> 
#include <cpss/dxCh/dxChxGen/port/PizzaArbiter/private/prvCpssDxChPortPizzaArbiterProfileStorage.h>
#include <cpss/dxCh/dxChxGen/port/PizzaArbiter/private/prvCpssDxChPortPizzaArbiterDevInfo.h>
...
/*******************************************************************************
* prvCpssDxChNetIfPizzaArbiterInit
*
* DESCRIPTION:
...
/*******************************************************************************
* prvCpssDxChPortIfPizzaArbiterIfCheckSupport
*
* DESCRIPTION:
...
*
*******************************************************************************/
GT_STATUS prvCpssDxChPortIfPizzaArbiterIfCheckSupport
(
    IN  GT_U8                   devNum,
...
typedef struct CPSS_DXCH_UNIT32_SLICES_PIZZA_ARBITER_STATE_STCT
{
...
typedef struct cpssDxChUnitTxQSlicesPizzaArbiterState_STCT
{
    GT_U32  totalConfiguredSlices;
...
typedef struct CPSS_DXCH_DEV_PIZZA_ARBITER_STATE_STCT
{
...
/*
 *------------------------------------------------------------------
 * $Log: cpssDxChPortPizzaArbiter.h,v $
 * Revision 1.1  2015/02/13 11:32:33  iachang
