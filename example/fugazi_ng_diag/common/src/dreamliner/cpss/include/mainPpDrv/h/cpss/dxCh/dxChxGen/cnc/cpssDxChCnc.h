/* $Id: cpssDxChCnc.h,v 1.1 2015/02/13 11:31:34 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/cnc/cpssDxChCnc.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
/*
 * typedef: CPSS_DXCH_CNC_COUNTER_BINDING_MODE_ENT
 *
 * Description:
 *      CNC Counter Index Binding modes
 *
 * Enumerations:
 *   CPSS_DXCH_CNC_COUNTER_BINDING_INDEX_FROM_CLIENT_E -
 *              incase of TTI client : CNC counter index is taken from the TTI
 *              action entry <CNC Counter Index>
 *              incase of TS client: TS Ptr is used as the counter index
 *
 *   CPSS_DXCH_CNC_COUNTER_BINDING_INDEX_FROM_SRC_EPORT_E -
 *              used for TTI client:
 *              CNC counter index is taken from LocalDevSRCePort[13:0] after
 *              the optional assignment of source ePort by TTI/RBridge action
 *
 *  CPSS_DXCH_CNC_COUNTER_BINDING_INDEX_FROM_TRG_EPORT_E -
 *              used for TS client: TRGePort is used as the counter index
 * Comment:
 */
typedef enum
{
    ...
    CPSS_DXCH_CNC_COUNTER_BINDING_INDEX_FROM_SRC_EPORT_E,
    CPSS_DXCH_CNC_COUNTER_BINDING_INDEX_FROM_TRG_EPORT_E
} CPSS_DXCH_CNC_COUNTER_BINDING_MODE_ENT;
...
*                         DxCh3 and xCat devices have 10 ranges of counter indexes,
...
/*******************************************************************************
* cpssDxChCncCounterBindingModeSet
*
* DESCRIPTION:
*       Set CNC counter Binding mode
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
*       devNum        - device number
*       client        - CNC client
*       mode          - CNC Counter Index Binding mode
*
* OUTPUTS:
*       None.
*
...
*
* COMMENTS:
*       In case of TTI client : Determines whether the CNC counter index used for
*       TTI client is taken from the TTI action entry, or based on source ePort[13:0]
*       In case of TS client : Determines whether TS Ptr is used as the counter index or
*       TRGePort is used as the counter index
*
*******************************************************************************/
GT_STATUS cpssDxChCncCounterBindingModeSet
(
    IN  GT_U8                                   devNum,
    IN  CPSS_DXCH_CNC_CLIENT_ENT                client,
    IN  CPSS_DXCH_CNC_COUNTER_BINDING_MODE_ENT  mode
);

/*******************************************************************************
* cpssDxChCncCounterBindingModeGet
*
* DESCRIPTION:
*       Get CNC counter Binding mode
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
*
* OUTPUTS:
*       modePtr       - (pointer to) CNC Counter Index Binding mode
*
* RETURNS:
*       GT_OK                    - on success
*       GT_BAD_PARAM             - wrong value in any of the parameters
...
*
*******************************************************************************/
GT_STATUS cpssDxChCncCounterBindingModeGet
(
    IN  GT_U8                                   devNum,
    IN  CPSS_DXCH_CNC_CLIENT_ENT                client,
    OUT CPSS_DXCH_CNC_COUNTER_BINDING_MODE_ENT  *modePtr
);

/*******************************************************************************
* cpssDxChCncVlanBaseSet
*
* DESCRIPTION:
*       Determines the base VLAN for CNC counting. I.e., ingress VLAN
*       counting is perform for VLAN values starting at <VLAN Base>.
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
* INPUTS:
*       devNum        - device number
*       vlan          - vlan number used as base Vlan for CNC counting
...
*
*******************************************************************************/
GT_STATUS cpssDxChCncVlanBaseSet
(
    IN  GT_U8       devNum,
    IN  GT_U16      vlan
);
...
/*******************************************************************************
* cpssDxChCncVlanBaseGet
*
* DESCRIPTION:
*       Returns the base VLAN for CNC counting. I.e., ingress VLAN
*       counting is perform for VLAN values starting at <VLAN Base>.
*
* APPLICABLE DEVICES:
*        Lion3.
...
*
* OUTPUTS:
*       vlanPtr      - (pointer to) vlan number used as base Vlan for CNC counting
*
* RETURNS:
*       GT_OK                    - on success
*       GT_BAD_PARAM             - wrong value in any of the parameters
...
*
*******************************************************************************/
GT_STATUS cpssDxChCncVlanBaseGet
(
    IN  GT_U8       devNum,
    OUT GT_U16      *vlanPtr
);
 ...
 *------------------------------------------------------------------
 * $Log: cpssDxChCnc.h,v $
 * Revision 1.1  2015/02/13 11:31:34  iachang
