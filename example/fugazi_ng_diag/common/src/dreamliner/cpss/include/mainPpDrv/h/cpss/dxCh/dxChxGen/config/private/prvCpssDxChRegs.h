/* $Id: prvCpssDxChRegs.h,v 1.1 2015/02/13 11:31:39 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/config/private/prvCpssDxChRegs.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
#define MAX_NUM_OF_TRILL_EXCEPTIONS_CNS 16
...
typedef struct
{
     ...
     struct _global
    {
        ...
        GT_U32          extendedGlobalControl5; /* Extended Global Control5 */
        ...
        struct{
            ...
            GT_U32      highAddressRemap[4]; /* Address remap  */
            GT_U32      baseAddressEnable; /* Base Address Enable */
    ...
    struct _bufferMng
    {
        struct _eqBlkCfgRegs
        {
            ...
            GT_U32          mirrorInterfaceParameterReg[7]; /* Mirror Interface
                                                            Parameter Register.
                                                       For xCat and above */
            GT_U32          mirrorInterfaceParameterReg2[7]; /* Mirror Interface
                                                            Parameter Register.
                                                            For Lion2 and above */
            ...
            GT_U32  cpuTargDevConfReg2;   /* CPU Code Target device configuration Register - Lion2 and above */
            GT_U32  cpuTargDevConfReg3;   /* CPU Code Target device configuration Register - Lion2 and above */
    ...
    struct _bridge
    {
        ...
        GT_U32      swPortControl2Bookmark;
        GT_U32      swPortControl2Type;
        GT_U32      swPortControl2Size;
        GT_U32      *portControl2 GT_PACKED;    /* Bridge Ports Control - Lion2 only    */
        ...
        GT_U32      macTblAction3;      /* MAC Table Action3  - Lion2 only   */
        GT_U32      macTblAction4;      /* MAC Table Action4  - Lion2 only   */
        GT_U32      macTblAction5;      /* MAC Table Action5  - Lion2 only   */
        GT_U32      macTblAction6;      /* MAC Table Action6  - Lion2 only   */
        ...
        /* Lion2 and above */
        GT_U32  globalEportRangePattern;/* Value for Global ePort    */
        GT_U32  globalEportRangeMask;   /* "0" masks the corresponding bit
                                           in the <Global ePort Range Value> */
        GT_U32  fdbAnalyzerIndexCfg; /* configuration to support mirroring to an
                                        analyzer from the FDB */

        GT_U32  l2EcmpEportPattern; /*  Defines the global ePort number range,
                                        together with <l2EcmpEportMask> .
                                        An ePort P is in the global range if
                                        P & <l2EcmpEportMask> == <l2EcmpEportPattern> */
        GT_U32  l2EcmpEportMask;  /* A bitmap that determines which bits in
                                    <l2EcmpEportPattern> are relevant.
                                    Every bit in the mask that is 1, indicates that
                                    the matching bit in <l2EcmpEportPattern> is valid.*/

        GT_U32  l2EcmpIndexBaseEport;  /* Defines the first ePort number in the L2
                                        ECMP ePort number range. The index to the
                                        L2 ECMP LTT is <Target ePort>-<Base ePort>.*/
    }bridgeRegs;
    ...
    struct _pcl
    {
        ...
        /* Base of EPCL User Defined bytes Configuration registers */
        /* 4 registers for 4 UDBs                                  */
        GT_U32 epclUdbConfigBase;
        /* Ch3 registers */
       ...
       /* CNC relted registers */
        ...
        /* Lion2 local port mapping to port list bit index */
        GT_U32 ipclLocalPortToBitIndexMap[3];
        GT_U32 epclLocalPortToBitIndexMap[3];
        ...
        /* Lion3 OAM configuration registers */
        GT_U32 ipclOamRdiConfigurations;
        GT_U32 epclOamRdiConfigurations;
        GT_U32 ipclOamMegLevelModeConfigurations;
        GT_U32 epclOamMegLevelModeConfigurations;
        GT_U32 epclOamPacketDetection;
    ...
    struct _ipRegs
    {
        ...
        GT_U32 routerExtraMngCntSetCfgRegs[4]; /* Router Extra Management Counters Set<n>
                                                  Configuration Register*/
        ...
        GT_U32 routerAdditionalCtrl2Reg; /* Router Additional Control 2 Register */
    ...
    struct _ipMtRegs
    {
        ...
        GT_U32 mllExtraOutInterfaceCfg[2];   /* MLL Extra Out Interface Counter<n> Configuration Register */
    ...
    struct _l2Mll
    {
        ...
        GT_U32 globalControlReg;            /* L2 MLL Global Control Register */

        GT_U32 globalEportRangePattern;     /* L2 MLL Global ePort value */

        GT_U32 globalEportRangeMask;        /* L2 MLL Global ePort mask */

        GT_U32 globalTtlExceptionCfgReg;    /* Global TTL Exception Configuration Register */

        GT_U32 exceptionSkipCounter;        /* L2 MLL Exception Skip Counter */

        GT_U32 exceptionDropCounter;        /* L2 MLL Exception Drop Counter */

        GT_U32 exceptionTtlCounter;         /* L2 MLL Exception TTL Counter */

        GT_U32 counter[3];                  /* L2 Mll Counter<n> */

        GT_U32 mtTcQueuesGlobalReg;     /* Multi Target TC Queues Global */
                                        /* Configuration Register */

        GT_U32 qosProfileToMtTcQueuesMapTable[8];   /* QoSProfile to Multi Target TC Queues Table */
        ...
        GT_U32 mtRateShapingCfgReg;     /* Multi Target Rate Shaping Configuration Register */

        GT_U32 mtUcSchedulerCfgReg;     /* Multi Target Vs. Unicast SDWRR */
                                        /* and Strict Priority Configuration Register */
    ...
    struct _OAM /* OAM */
    {
        GT_U32      oamGlobalControl;
        GT_U32      oamExceptionConfigurations;
        GT_U32      oamExceptionConfigurations1;
        GT_U32      oamExceptionConfigurations2;
        GT_U32      oamInvalidKeepaliveExceptionConfigurations;
        GT_U32      oamLmCountedOpcodes;
        GT_U32      oamLossMeasurementOpcodes;
        GT_U32      oamDelayMeasurementOpcodes;
        GT_U32      oamKeepAliveOpcodes;
        GT_U32      agingPeriodEntryLow[8];
        GT_U32      keepaliveAgingGroupStatus[2];
        GT_U32      keepaliveExcessGroupStatus[2];
        GT_U32      keepaliveInvalidHashGroupStatus[2];
        GT_U32      megLevelGroupStatus[2];
        GT_U32      srcInterfaceGroupStatus[2];
        GT_U32      rdiStatusChangeGroupStatus[2];
        GT_U32      txPeriodExceptionGroupStatus[2];
        GT_U32      megLevelExceptionCounter;
        GT_U32      sourceInterfaceMismatchCounter;
        GT_U32      keepaliveInvalidHashCounter;
        GT_U32      keepaliveExcessCounter;
        GT_U32      keepaliveAgingCounter;
        GT_U32      rdiStatusChangeCounter;
        GT_U32      txPeriodExceptionCounter;
    }OAM[2]; /* OAM */
    ...
    struct _ttiRegs
    {
        ...
        GT_U32 ttiMetalFix;
        GT_U32 trillEthertype; /* The Ethertype used to identify TRILL packets */
        GT_U32 trillCpuCodeBase; /* CPU Code Base Register Configuration */
        GT_U32 trillAdjacencyExceptionsCmd; /* TRILL Adjacency Check Exception Commands Register */
        GT_U32 trillGeneralExceptionCmdReg0; /* TRILL General Exception Commands Register 0 */
        GT_U32 trillGeneralExceptionCmdReg1; /* TRILL General Exception Commands Register 1 */
        GT_U32 trillDropCounter[MAX_NUM_OF_TRILL_EXCEPTIONS_CNS]; /* TRILL Exception Drop Counters Registers */
    ...
    struct _haRegs
    {
        ...
        GT_U32 hdrAltTrillEthertype; /* The Ethertype to be used when TRILL
                                        headers need to be added or recognized*/
        ...
        GT_U32 globalEportRangePattern;     /* Trunk Global ePort value */

        GT_U32 globalEportRangeMask;        /* Trunk Global ePort mask */
        ...
        GT_U32 trunkNumConfigReg2[PORTS_NUM_CNS / 4];/* 4 ports in register */
                                         /* extra 5 bits for Lion2 (for 256 ports)
                                            7 first bits are located in trunkNumConfigReg*/
    ...
    struct/*txqVer1*/
    {
        ...
        struct{/*dq*/
            ...
            struct{/*statisticalAndCpuTriggeredEgressMirroringToAnalyzerPort*/
                ...
                GT_U32  egressAnalyzerIndexBit2;/* Lion2 and above */
