/* $Id: cpssDxChDiagDescriptor.h,v 1.1 2015/02/13 11:31:53 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/diag/cpssDxChDiagDescriptor.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
*
* APPLICABLE DEVICES:
*        xCat; Lion; xCat2; Lion2.
*
* NOT APPLICABLE DEVICES:
*        DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion3.
*
* INPUTS:
...
/*
 *------------------------------------------------------------------
 * $Log: cpssDxChDiagDescriptor.h,v $
