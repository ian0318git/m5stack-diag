/* $Id: cpssDxChMirror.h,v 1.1 2015/02/13 11:32:10 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner/cpss/include/mainPpDrv/h/cpss/dxCh/dxChxGen/mirror/cpssDxChMirror.h,v $
 *------------------------------------------------------------------
 *
 * Ian Chang - Nov. 2014
 *
...
/* deprecated legacy names that should not be used ,
    ...
    CPSS_DXCH_MIRROR_TO_ANALYZER_FORWARDING_SOURCE_BASED_SEPARATE_E */
enum
{
 ...
 *     CPSS_DXCH_MIRROR_TO_ANALYZER_FORWARDING_SOURCE_BASED_SEPARATE_E - The Src/Trg
...
(
    ...
    OUT GT_HW_DEV_NUM   *analyzerDevPtr
);
...
/*******************************************************************************
* cpssDxChMirrorAnalyzerDpSet
*
* DESCRIPTION:
*       Set the Drop Precedence assigned to the mirrored copy.
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
*
*******************************************************************************/
GT_STATUS cpssDxChMirrorAnalyzerDpSet
(
    IN GT_U8                devNum,
    IN GT_U32               index,
    IN CPSS_DP_LEVEL_ENT    dpValue
);

/*******************************************************************************
* cpssDxChMirrorAnalyzerDpGet
*
* DESCRIPTION:
*       Get the Drop Precedence assigned to the mirrored copy.
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
*
* OUTPUTS:
*      dpValuePtr  - (pointer to) DP value assigned
*
* RETURNS:
*       GT_OK                    - on success.
*       GT_BAD_PARAM             - wrong device, index.
...
*
*******************************************************************************/
GT_STATUS cpssDxChMirrorAnalyzerDpGet
(
    IN  GT_U8               devNum,
    IN  GT_U32              index,
    OUT CPSS_DP_LEVEL_ENT   *dpValuePtr
);

/*******************************************************************************
* cpssDxChMirrorAnalyzerTcSet
*
* DESCRIPTION:
*       Set the traffic class assigned to the mirrored copy.
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
*
*******************************************************************************/
GT_STATUS cpssDxChMirrorAnalyzerTcSet
(
    IN GT_U8                devNum,
    IN GT_U32               index,
    IN GT_U8                tcValue
...
/*******************************************************************************
* cpssDxChMirrorAnalyzerTcGet
*
* DESCRIPTION:
*       Get the traffic class assigned to the mirrored copy.
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
*
* OUTPUTS:
*      tcValuePtr  - (pointer to) TC value assigned
*
* RETURNS:
*       GT_OK                    - on success.
*       GT_BAD_PARAM             - wrong device, index.
...
*
*******************************************************************************/
GT_STATUS cpssDxChMirrorAnalyzerTcGet
(
    IN  GT_U8               devNum,
    IN  GT_U32              index,
    OUT GT_U8               *tcValuePtr
);

/*******************************************************************************
* cpssDxChMirrorAnalyzerOverrideQoSParametersEnableSet
*
* DESCRIPTION:
*       Enable/Disable Override of QoS parameters in the mirrored copy.
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
*
*******************************************************************************/
GT_STATUS cpssDxChMirrorAnalyzerOverrideQoSParametersEnableSet
(
    IN GT_U8                devNum,
    IN GT_U32               index,
    IN GT_BOOL              enable
...
/*******************************************************************************
* cpssDxChMirrorAnalyzerOverrideQoSParametersEnableGet
*
* DESCRIPTION:
*       Return if Override of QoS parameters is enabled/disabled in the mirrored copy.
*
* APPLICABLE DEVICES:
*        Lion3.
*
...
*
*******************************************************************************/
GT_STATUS cpssDxChMirrorAnalyzerOverrideQoSParametersEnableGet
(
    IN  GT_U8               devNum,
    IN  GT_U32              index,
    OUT GT_BOOL             *enablePtr
...
/*
 *------------------------------------------------------------------
 * $Log: cpssDxChMirror.h,v $
 * Revision 1.1  2015/02/13 11:32:10  iachang
