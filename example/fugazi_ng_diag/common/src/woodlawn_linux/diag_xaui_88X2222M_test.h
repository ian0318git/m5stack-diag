/* $Id: diag_xaui_88X2222M_test.h,v 1.2 2013/10/08 08:48:29 tirawan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/woodlawn_linux/diag_xaui_88X2222M_test.h,v $
 *-----------------------------------------------------------------------------
 * diag_xaui_88X2222M_test.c
 *
...
#ifndef __DIAG_XAUI_88X2222M_TEST_H__
#define __DIAG_XAUI_88X2222M_TEST_H__

extern int xaui_88X2222M_test(int);
extern int xaui_88X222M_do_all_wrapper(void);

#endif

/*-------------------------------------------------
 * $Log: diag_xaui_88X2222M_test.h,v $
