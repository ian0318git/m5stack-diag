/* $Id: platform_sfp_cookie.h,v 1.2 2013/10/08 08:48:30 tirawan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/woodlawn_linux/platform_sfp_cookie.h,v $
 *------------------------------------------------------------------
 * Filename: platform_sfp_cookie.h
 *
 * Description: Overlord SFP Cookie structs and definitions.
 ...
 *
 * Revision 1.1.2.2  2013/05/20 06:53:32  leschen
 * Add support for fpga sfp i2c path test
 *
 * Revision 1.1.2.1  2013/04/24 10:37:24  tirawan
 * Initial check-in for woodlawn linux code
 *
 * Revision 1.2  2013/03/20 06:34:47  kuangik
 * Add support for SFP+ eeprom display and adjust port number for 6G SKU
 *
 * Revision 1.1  2013/03/13 06:43:01  kuangik
 * Add for the first time
 *
 * Revision 1.4  2012/08/03 10:16:56  evanli
 * Mapping to latest O2 source code on 20120726
 *
 * Revision 1.2  2012/07/19 06:59:35  leslie
 * Declare sfp one byte size register.
 *
