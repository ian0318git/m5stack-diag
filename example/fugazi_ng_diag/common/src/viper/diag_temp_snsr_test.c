 /* $Id: diag_temp_snsr_test.c,v 1.2 2018/08/06 02:31:51 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/viper/diag_temp_snsr_test.c,v $
 *------------------------------------------------------------------
 * Filename:  diag_temp_snsr_test.c
 *
 * Description: Viper NXP LM75BD Sensor I2C device.
 *
...
Revision 1.1.2.8  2018/06/27 06:27:52  harrchan
Follow the coding rule to clean up code

Revision 1.1.2.7  2018/04/26 08:13:22  lucywang
typo

Revision 1.1.2.6  2018/04/23 09:28:44  lucywang
Fixed Temp Sensor Interrupt test bug in low temp

Revision 1.1.2.5  2018/04/11 08:52:35  lucywang
Modified Thermal Interrupt test to use chip object

Revision 1.1.2.4  2018/04/02 07:18:30  lucywang
Added Interrupt test for Thermal Sensor

Revision 1.1.2.3  2018/03/29 06:37:42  lucywang
