 /* $Id: diag_emmc_util.h,v 1.2 2018/08/06 02:31:50 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/viper/diag_emmc_util.h,v $
 *------------------------------------------------------------------
 *
...
/* eMMC info structure */
typedef struct viper_emmc_info {
    char manf_name[32];
    char prod_name[32];
} emmc_info_t;
