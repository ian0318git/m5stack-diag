 /* $Id: dnv_gpio_lib.c,v 1.2 2018/08/06 02:31:51 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/viper/dnv_gpio_lib.c,v $
 *------------------------------------------------------------------
 * 
 * dnv_gpio_lib.c
 *
...
int dnv_set_pcie_1f_1 (void)
{
    ...
    offset = CONFIG_VIPER_PCIE_ADDR + tmp_bus_dev_fun;
