 /* $Id: diag_fpga_i2c_lib.c,v 1.2 2018/08/06 02:31:50 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/viper/diag_fpga_i2c_lib.c,v $
 *------------------------------------------------------------------
 *
...
{   
    ...
    i2c_if.i2c_dev = MB_I2C_ADDR_ACT2;
    ret_val = FAILED;
...
Revision 1.1.2.3  2018/06/27 09:11:35  lucywang
Added messages for "FPGA I2C scan" and "FPGA I2C reset"

Revision 1.1.2.2  2018/06/27 06:27:49  harrchan
