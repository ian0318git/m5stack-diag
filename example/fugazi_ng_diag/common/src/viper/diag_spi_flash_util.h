/* $Id: diag_spi_flash_util.h,v 1.3 2018/09/05 01:20:44 chieyang Exp $
 *------------------------------------------------------------------
...
#define VIPER_DENVERTON_SPI_CTRL_MM_ADDR  0xFE010000
...
/* Rommon Flash - Viper-Intel */
/* Rommon Flash - Viper-J */
/* Main source */
...
extern int viper_spi_flash_utils (int);
extern int viper_spi_flash_get_rdsr (int, uchar *); 
extern int viper_spi_flash_get_prod_id (int, uint*);
