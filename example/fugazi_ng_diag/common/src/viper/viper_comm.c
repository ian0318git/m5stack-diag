 /* $Id: viper_comm.c,v 1.2 2018/08/06 02:31:52 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/viper/viper_comm.c,v $
 *------------------------------------------------------------------
...
/*******************************************************************************
 *
 * Function    : viper_mem_read32
 * Description : Function to read Viper memory by byte.
 ...
 *******************************************************************************
 */
int viper_mem_read32 (uint offset, uint *buf)
{
    int      fd = -1;
...
/*******************************************************************************
 *
 * Function    : viper_mem_write32
 * Description : Function performs write Viper memory by byte.
 ...
 *******************************************************************************
 */
int viper_mem_write32 (uint offset, uint wr_data)
{
    int      fd = -1;
    void     *map_base, *virt_addr;
    off_t    target = 0;
 ...
 *
 * Revision 1.1.2.1  2018/05/10 09:04:37  lucywang
