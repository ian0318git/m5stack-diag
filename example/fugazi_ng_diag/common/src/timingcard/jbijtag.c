/* $Id: jbijtag.c,v 1.2 2015/02/14 12:48:42 kodko Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/timingcard/jbijtag.c,v $
 */
/*******************************************************************************
...
char *jbi_workspace = 0;
int jbi_workspace_size = 0;
...
unsigned char *jbi_dr_preamble_data  = 0;
unsigned char *jbi_dr_postamble_data = 0;
unsigned char *jbi_ir_preamble_data  = 0;
unsigned char *jbi_ir_postamble_data = 0;
unsigned char *jbi_dr_buffer         = 0;
unsigned char *jbi_ir_buffer         = 0;
...
/****************************************************************************/
{
	...
	{
		jbi_dr_preamble_data  = 0;
		jbi_dr_postamble_data = 0;
		jbi_ir_preamble_data  = 0;
		jbi_ir_postamble_data = 0;
		jbi_dr_buffer         = 0;
		jbi_ir_buffer         = 0;
	}
...
/****************************************************************************/
{
	...
	/* Timing card uses I2C to do the transaction, no needs delay. */
#ifdef ENABLE_DELAY
	if (status == JBIC_SUCCESS)
	{
		/*
