/* $Id: diag_rtc_test.c,v 1.2 2016/04/20 11:25:33 benchen2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tachi_bmc/diag_rtc_test.c,v $
 *------------------------------------------------------------------
 *
 * diag_rtc_test.c - RTC test functions
 *
 ...
 */
int diag_rtc_test(boolean);
int diag_rtc_utils(boolean);
int rtc_init(int);
...
static submenu_xtable_t rtc_main_menu_table[] = {
    {"RTC chip utilities",  (PFT)diag_rtc_utils,    0,
        MF_SHOW_ERRCOUNT,   (type_t(*)())0,     0,
        (PFT)diag_rtc_utils,  0},
 ...
 **********************************************************************
 */
int diag_rtc_test (boolean run_all_tests)
{
    char *tname = "RTC";
 ...
 *************************************************************************
 */
int diag_rtc_utils (boolean run_all_tests)
{
 ...
 *******************************************************************************
 */
int utility_display_rtc (int check)
{
    dev_ds1337_object_t ds1337;
    n2g_i2c_if_t i2c_if;
    dev_object_t *dev = (dev_object_t *)&ds1337;
...
dev_obj_create(dev_ds1337_object_t *pds1337, n2g_i2c_if_t *i2c_if)
{
    ...
    i2c_if->offset = 0;
    i2c_if->i2c_bus_type = CPU_I2C3;    /* I2C bus number */
