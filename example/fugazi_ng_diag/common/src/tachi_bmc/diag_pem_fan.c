/* $Id: diag_pem_fan.c,v 1.2 2016/04/20 11:25:30 benchen2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tachi_bmc/diag_pem_fan.c,v $
 *------------------------------------------------------------------
 *
 * diag_pem_fan.c: PSU Fan Control Utilities
 *
 * porting from o2 platform_pem_fan.c
