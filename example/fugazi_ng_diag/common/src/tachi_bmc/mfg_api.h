/* $Id: mfg_api.h,v 1.2 2016/04/20 11:25:28 benchen2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tachi_bmc/mfg_api.h,v $
 *----------------------------------------------------------------------------
...
extern int act2_drv_write(void *module, char *send_buf, unsigned int
                            length);
extern int act2_drv_read(void *module, char *status_buf, unsigned int
                            length);
