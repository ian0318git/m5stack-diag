/* $Id: diag_idprom.h,v 1.2 2016/04/20 11:25:25 benchen2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tachi_bmc/diag_idprom.h,v $
 *------------------------------------------------------------------
 *
 * diag_idprom.h: This is the header file for the Serial EEPROM
 *
...
typedef struct {
  ...
  uchar       unique_id;  
  uchar       sensor_name[PCAMAP_SENSOR_NAME_LEN];  
  uchar       vx1_scale;
  uchar       vx1_mv_hi;
  uchar       vx1_mv_lo;
  uchar       vx2_scale;
