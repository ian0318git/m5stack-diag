/* $Id: diag_fpga_prog.h,v 1.2 2016/04/20 11:25:30 benchen2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tachi_bmc/diag_fpga_prog.h,v $
 *------------------------------------------------------------------
 *
 * diag_fpga_prog.h - Header file for FPGA Programming Utility
 *
...
#ifndef __DIAG_FPGA_PROG__
#define __DIAG_FPGA_PROG__
...
#define FPGA_DEFAULT_FILE_PATH                   "/tmp/fpga_fw"
...
extern int diag_fpga_spi_prog(int);
extern int diag_fpga_set_update_flag(int);
extern int diag_fpga_set_date_revision(int);
extern int diag_fpga_display_sector(int);
extern int diag_fpga_erase_header(int);

#endif /* __DIAG_FPGA_PROG__ */

/*---------------------------------------------------------------
$Log: diag_fpga_prog.h,v $
Revision 1.2  2016/04/20 11:25:30  benchen2
add tachi fru portion

Revision 1.1.2.2  2015/09/25 02:17:57  tirawan
