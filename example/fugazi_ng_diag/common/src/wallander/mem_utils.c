/* $Id: mem_utils.c,v 1.1 2015/02/26 07:18:29 xiaoyizh Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/wallander/mem_utils.c,v $
 *------------------------------------------------------------------
 * mem_util.c - Wallander memory utilities, leverage from src/linux_main.c.
 *
 * Xiaoying Zhang -- Feb. 2015
 *
 ...
 * Return: pass/fail
 */
int module_mem_test(void)
{
#define OVRHD_FACTOR    0.010
