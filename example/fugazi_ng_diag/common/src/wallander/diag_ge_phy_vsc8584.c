/* $Id: diag_ge_phy_vsc8584.c,v 1.1 2015/02/26 07:18:29 xiaoyizh Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/wallander/diag_ge_phy_vsc8584.c,v $
 *------------------------------------------------------------------
 *
 * diag_ge_phy_vsc8584.c - Wallander PHY VSC8584 functions.
 *
...
static reg_info_t vsc8584_reg_page0[] = {   /* Page 0 */
...
static reg_info_t vsc8584_reg_page1[] = {  /* Extended Page 1 */
...
static reg_info_t vsc8584_reg_page2[] = {   /* Extended Page 2 */
...
static reg_info_t vsc8584_reg_page3[] = {   /* Extended Page 3 */
...
static reg_info_t vsc8584_reg_page4[] = {   /* Page 4*/
    /* 1588 and MACsec */
    {"CSR Access Control",      0x10, READ_ONLY,  {2}, 0x0000, 0x0000},
    {"CSR Buffer LSB",          0x11, READ_ONLY,  {2}, 0x0000, 0x0000},
    {"CSR Buffer MSB",          0x12, READ_ONLY,  {2}, 0x0000, 0x0000},
    {"CSR Access Control",      0x13, READ_ONLY,  {2}, 0x0000, 0x0000},
    {"CSR Status",              0x14, READ_ONLY,  {2}, 0x0000, 0x0000},
    {"1588 PPS0 Mux Control",   0x15, READ_ONLY,  {2}, 0x0000, 0x0000},
    {"SPI Daisy-Chain Control", 0x1A, READ_ONLY,  {2}, 0x0000, 0x0000},
    {"SPI Daisy-Chain Status",  0x1B, READ_ONLY,  {2}, 0x0000, 0x0000},
    {"SPI Daisy-Chain Counter", 0x1C, READ_ONLY,  {2}, 0x0000, 0x0000},
    {"1588 RefClk Input Buffer Control LSW", 0x1D, READ_ONLY,  {2}, 0x0000, 0x0000},
    {"1588 RefClk Input Buffer Control MSW", 0x1E, READ_ONLY,  {2}, 0x0000, 0x0000},
    {"end",                 0x00, 0, {0}, 0, 0},
};

static reg_info_t vsc8584_reg_page16[] = {   /* Page 16*/
...
vsc_phy_regs_t vsc8584_phy_reg_tbl[] = {
    {"Page  0",     0, vsc8584_reg_page0},
    {"Page  1",     1, vsc8584_reg_page1},
    {"Page  2",     2, vsc8584_reg_page2},
    {"Page  3",     3, vsc8584_reg_page3},
    {"Page  4",     4, vsc8584_reg_page4},
    {"Page 16",    16, vsc8584_reg_page16},
};


/******** History ********
$Log: diag_ge_phy_vsc8584.c,v $
