/* $Id: o2_util.c,v 1.2 2014/06/03 10:53:32 erwu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/o2_python_example/o2_util.c,v $
 *------------------------------------------------------------------
 * Filename:    o2_util.c
 *
 * Description: o2 platform common utilities
 *
 ...
 *  Function: plat_init
 *
 *  Description: platform initialize common part, it will register signal() and
 *               call py_parse() to get diag flag value.
 *
