/* $Id: platform_pem_eeprom_modify.c,v 1.2 2021/06/02 08:22:35 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/fugazi/platform_pem_eeprom_modify.c,v $
 *------------------------------------------------------------------
 *
