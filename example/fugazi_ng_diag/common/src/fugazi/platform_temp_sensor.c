/* $Id: platform_temp_sensor.c,v 1.2 2021/06/02 08:22:36 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/fugazi/platform_temp_sensor.c,v $
 *------------------------------------------------------------------
...
static submenu_xtable_t ts_menu_table[] = {
    ...
    {"Show CPU temperature", (PFT)show_cpu_temperature, 0, 0,
     (type_t(*)())0, 0, (PFT)show_cpu_temperature, 0},
 ...
 *
 *****************************************************************************/
static int set_i2c_if_struct(uint32_t ts_id, n2g_i2c_if_t* i2c_if_p, int offset, char* buf_p, int size)
{
 ...
 * Description: display sensors and CPU temperature
 * Inputs     : none
 * Outputs    : PASSED/FAILED
 *
 ******************************************************************************/
 ...
 *
 * Revision 1.1.6.3  2019/10/25 02:29:51  letsai
