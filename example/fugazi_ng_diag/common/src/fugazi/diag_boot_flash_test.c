/* $Id: diag_boot_flash_test.c,v 1.2 2021/06/02 08:22:34 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/fugazi/diag_boot_flash_test.c,v $
 *------------------------------------------------------------------
 *
...
int diag_boot_flash_test (int select)
{
    ...
    /*
     * fugazi uses fpga to mux the bootflash
     */
    ...
    /* Restore mux setting*/ 
    dash_fpga_reg_write(reg_addr, reg_bk);
    return (PASSED);
}
