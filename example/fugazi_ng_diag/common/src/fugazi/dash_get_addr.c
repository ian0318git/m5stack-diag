/* $Id: dash_get_addr.c,v 1.2 2021/06/02 08:22:34 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/fugazi/dash_get_addr.c,v $
 *------------------------------------------------------------------
 *
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_cpld_addr (void)
{
    unsigned long addr;
    assert(dash_cpld);
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_platform_i2c_addr (int ctrl)
{
    unsigned long addr;
    assert(dash_fpga);
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_platform_mbx_addr (void)
{
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_platform_intr_ctrl_addr (int plane)
{
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_platform_led_ctrl_base (void)
{
    unsigned long addr = 0;
    assert(dash_fpga);
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_sys_low_level_base (void)
{
    unsigned long addr = 0;
    assert(dash_fpga);
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_platform_net_clk_ptp_conf_base (void)
{
    unsigned long addr = 0;
    assert(dash_fpga);
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_platform_uart_mux_addr (int plane)
{   
    assert(dash_fpga);
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_platform_sfp_stat_ctrl_addr (int plane)
{   
    assert(dash_fpga);
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_platform_nios_prom_addr (void)
{
    assert(dash_fpga);
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_platform_env_mcu_base (int plane)
{
    unsigned long addr = 0;
    assert(dash_fpga);
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_platform_vm_base (int plane)
{
    unsigned long addr = 0;
    assert(dash_fpga);
 ...
 *-------------------------------------------------------------------
 */
unsigned long get_platform_multiboot_base (void)
{
    unsigned long addr = 0;
    assert(dash_fpga);
