/* $Id: tam_act2_api_drv_support.c,v 1.2 2021/06/02 08:22:36 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/fugazi/tam_act2_api_drv_support.c,v $
 *------------------------------------------------------------------
...
int32_t tam_lib_platform_write (void *platform_opaque_handle, uint8_t *send_buf, 
			uint32_t length)
{
    int ret;
    uint16_t ix;
 ...
 *
 * Revision 1.1.6.5  2020/07/29 08:57:35  iachang
 * Code clean up.
 *
 * Revision 1.1.6.4  2020/06/08 06:54:39  iachang
 * Program Aikido FPGA DEV key utility
 * Program I211 and BCM57412 MAC address utility.
 *
 * Revision 1.1.6.3  2019/04/26 08:36:21  iachang
