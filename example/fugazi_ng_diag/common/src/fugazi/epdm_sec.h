...
typedef bcm_plp_cfye_status_t (* __bcm_plp_cfye_statistics_channel_get_f)(bcm_plp_sec_phy_access_t *pa, const unsigned int stat_index, bcm_plp_cfye_statistics_channel_t *stat_p, const unsigned char fsync);

typedef bcm_plp_cfye_status_t (* __bcm_plp_cfye_rule_get_f)(bcm_plp_sec_phy_access_t *pa,  const bcm_plp_cfye_rule_handle_t rule_handle, const bcm_plp_cfye_rule_t *rule_p, unsigned char *fenabled_p);
...
typedef bcm_plp_cfye_status_t (* __bcm_plp_cfye_vport_get_f)(bcm_plp_sec_phy_access_t *pa, const bcm_plp_cfye_vport_handle_t vport_handle, const bcm_plp_cfye_vport_t *vport_p);
...
typedef bcm_plp_cfye_status_t (* __bcm_plp_cfye_diag_insert_sop_f)(bcm_plp_sec_phy_access_t *pa, const unsigned int channel_mask);

typedef bcm_plp_cfye_status_t (* __bcm_plp_cfye_diag_insert_eop_f)(bcm_plp_sec_phy_access_t *pa, const unsigned int channel_mask);
...
typedef bcm_plp_secy_status_t (* __bcm_plp_secy_diag_insert_sop_f)(bcm_plp_sec_phy_access_t *pa, const unsigned int channel_mask);

typedef bcm_plp_secy_status_t (* __bcm_plp_secy_diag_insert_eop_f)(bcm_plp_sec_phy_access_t *pa, const unsigned int channel_mask);
...
typedef bcm_plp_secy_status_t (* __bcm_plp_secy_cryptauth_bypass_len_get_f)(bcm_plp_sec_phy_access_t *pa, unsigned int *bypass_length_p);
...
typedef struct __plp__sec__dispatch__s__ {
    ...
    __bcm_plp_secy_cryptauth_bypass_len_get_f __secy_cryptauth_bypass_len_get;
...
#define bcm_plp_cfye_statistics_channel_get(_pd, _a, _b, _c, _d) \
    PLP_SEC_CALL((_pd), __cfye_statistics_channel_get, ((_a), (_b), (_c), (_d)))
...
#define bcm_plp_cfye_diag_insert_sop(_pd, _a, _b) \
    PLP_SEC_CALL((_pd), __cfye_diag_insert_sop, ((_a), (_b)))

#define bcm_plp_cfye_diag_insert_eop(_pd, _a, _b) \
    PLP_SEC_CALL((_pd), __cfye_diag_insert_eop, ((_a), (_b)))
...
#define bcm_plp_secy_diag_insert_sop(_pd, _a, _b) \
    PLP_SEC_CALL((_pd), __secy_diag_insert_sop, ((_a), (_b)))

#define bcm_plp_secy_diag_insert_eop(_pd, _a, _b) \
    PLP_SEC_CALL((_pd), __secy_diag_insert_eop, ((_a), (_b)))
...
#define bcm_plp_secy_cryptauth_bypass_len_get(_pd, _a, _b) \
    PLP_SEC_CALL((_pd), __secy_cryptauth_bypass_len_get, ((_a), (_b)))
