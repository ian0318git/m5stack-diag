/* $Id: platform_124mux.c,v 1.2 2021/06/02 08:22:35 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/fugazi/platform_124mux.c,v $
 *------------------------------------------------------------------
...
int build_mux_menu (uint32_t mux_id)
{
    ...
    /* get mux_menu_table */
    mux_menu_table = (mux_id == FUGAZI_SFP_I2C_MUX ? sfp_mux_menu_table : psu_mux_menu_table); 
