...
typedef enum bcm_plp_tech_ability_e {
    bcmplpAnCap1G_KX = 1,              /* AN_CAP_1G_KX */
    bcmplpAnCap10G_KX4 = 2,            /* AN_CAP_10G_KX4 */
    bcmplpAnCap10G_KR  = 4,            /* AN_CAP_10G_KR */
    bcmplpAnCap40G_KR4 = 8,            /* AN_CAP_40G_KR4 */
    bcmplpAnCap40G_CR4 = 0x10,         /* AN_CAP_40G_CR4 */
    bcmplpAnCap100G_CR10 = 0x20,       /* AN_CAP_100G_CR10 */
    bcmplpAnCap100G_CR4 = 0x40,        /* AN_CAP_100G_CR4 */
    bcmplpAnCap100G_KR4 = 0x80,        /* AN_CAP_100G_KR4 */
    ...
    bcmplpAnCap50G_CR_KR = 0x10000,    /* AN_CAP_50G_CR_KR */
    bcmplpAnCap100G_CR2_KR2 = 0x20000, /* AN_CAP_100G_CR2_KR2 */
    bcmplpAnCap200G_CR4_KR4 = 0x40000, /* AN_CAP_200G_CR4_KR4 */
    bcmplpAnCap50G_KP = 0x80000,       /* AN_CAP_50G_KP */
    bcmplpAnCap100G_KP2 = 0x100000,    /* AN_CAP_100G_KP2 */
    bcmplpAnCap200G_KP4 = 0x200000     /* AN_CAP_200G_KP4 */
...
typedef enum bcm_plp_barchetta_lane_data_rate_e {
    ...
    bcmpLplaneDataRate_10P70912G  = (10709),
    bcmpLplaneDataRate_10P70916G  = (10709),
 ...
 *   To select the hitless mux mode feature on the chip \n
 *
 */
...
/* Millenio FW init parameters set along with FW download */
...
typedef struct bcm_plp_pm_firmware_lane_config_s {
    bcm_plp_pm_firmware_mode_t firmware_mode; /**< Note: This field has been obsoleted for next generation chips.  Use MediaType instead */
...
typedef struct bcm_plp_fec_err_cnt_s{
	...
	unsigned long long  tot_frame_rev_cnt;
	unsigned long long  tot_frame_corr_cnt;
    unsigned long long  tot_frame_uncorr_cnt;
    unsigned long long  tot_symbols_corr_cnt;
    unsigned long long  tot_bits_corr_cnt[BCM_PLP_FEC_TOT_BITS_CORR_NUM];
    unsigned long long  bcm_plp_tot_frames_err_cnt[BCM_PLP_FEC_TOT_FRAMES_ERR_NUM];
...
typedef struct bcm_plp_fec_rx_err_cnt_s {
    unsigned long long tot_frame_rev_cnt; /**< Total frame count received */
    unsigned long long tot_frame_corr_cnt; /**< Total frame corrected count */
    unsigned long long tot_frame_uncorr_cnt; /**< Total frame un-corrected count */
    unsigned long long tot_symbols_corr_cnt; /**< based on tot_frames_err_cnt[0..15] */
    unsigned long long tot_bits_corr_cnt[2]; /**< [0] for correctable 0's; [1] for correctable 1's */
    unsigned long long tot_frames_err_cnt[16]; /**< [n] for number of cw with correstable symbol error=n */
...
typedef struct bcm_plp_fec_dump_status_s {
    bcm_plp_ieee_fec_rx_status_t ieee_fec_sts; /**< for 25g/50g/100g/200g */
...
/*Note: align_lol_sticky, align_lock  and fec_err_cnt are applicable only for estoque */
...
/*Note: fec_dump_status is applicable only for millenio*/
...
typedef enum  bcm_plp_base_t_ctrl_e {
    ...
    plpBASETCtrlMacsecEn,
    bcmplpBaseTCtrlMacsecEn = plpBASETCtrlMacsecEn,
    bcmplpBaseTCtrlSuperIsolate,
    bcmplpBaseTCtrlSgmii1GAutodetect,
    bcmplpBaseTCtrlForceFiberIface,
    bcmplpBaseTCtrlSerdesAutoNeg,
...
typedef struct bcm_plp_base_t_cable_diag_s {
    ...
    int                             cable_type;     /* Cat 5E or Cat 6A          */
    int                             partner_power;  /* link partner power status */
...
typedef struct bcm_plp_timesync_time_value_s {
    ...
    unsigned long long  time_value;   /* time value   */
...
typedef enum bcm_plp_clkgen_squelch_cfg_e {
    bcmplpClkGenSquelchDisable = 0x0, /**< Disable Clk Gen and Squelch. */
    bcmplpClkGenEnSquelchNone  = 0x1, /**< Enable Clk Gen only, no squelch needed (Clock is always sent out) */
    bcmplpClkGenEnSquelchLOS   = 0x2, /**< Enable Clk Gen and Squelch clock on Loss of Signal (LOS) */
    bcmplpClkGenEnSquelchLOL   = 0x3, /**< Enable Clk Gen with Squelch clock on Loss of Lock (LOL) */
...
typedef enum bcm_plp_recovered_clk_lane_e {
    bcmplpRecoveredClkLane0 = 0x0, /**< Select Lane 0 for recovered Clock Generation. */
    bcmplpRecoveredClkLane1 = 0x1, /**< Select Lane 1 for recovered Clock Generation. */
    bcmplpRecoveredClkLane2 = 0x2, /**< Select Lane 2 for recovered Clock Generation. */
    bcmplpRecoveredClkLane3 = 0x3, /**< Select Lane 3 for recovered Clock Generation. */
    bcmplpRecoveredClkLaneCount
...
typedef enum bcm_plp_synce_divider_e {
    bcmplpDivider20    = 0x0,  /**< Divide by 20 */
    bcmplpDivider40    = 0x1,  /**< Divide by 40*/
    bcmplpDivider80    = 0x2,  /**< Divide by 80 */
    bcmplpDivider160   = 0x3,  /**< Divide by 160 */
    bcmplpDivider400   = 0x4,  /**< Divide by 400 */
    bcmplpDivider1000  = 0x5,  /**< Divide by 1000 */
} bcm_plp_synce_divider_t;

/*! SyncE configuration
 *
 * \arg clkGenSquelchCfg \n
 *     Clock Generation and Squelch Mode Configruation. \n
 *
 * \arg recoveredClkLane \n
 *     Recovered Clock Lane selection. \n
 *
...
typedef struct bcm_plp_synce_cfg_s {
    /* Use enum bcm_plp_clkgen_squelch_cfg_t to configure this field. */
    unsigned int  clkGenSquelchCfg;
    /* Use enum bcm_plp_synce_clk_src_t to configure this field. */
    unsigned int  recoveredClkLane;
    /* Package lanes to monitor for LOS or LOL. */
    unsigned int squelchMonitorLanemap;
    /* Use enum bcm_plp_synce_divider_t to configure this field*/
...
typedef struct bcm_plp_pcs_rx_status_phylane_s {
    ...
    unsigned char  pcs_lane_mapping [5];          /*!< per pcs lane for each phy lane - valid only if corresponding am_lolock=0 */
    unsigned short pcs_bip_err_cnt [5];           /*!< per pcs lane for each phy lane - valid only if corresponding am_lolock=0 */
