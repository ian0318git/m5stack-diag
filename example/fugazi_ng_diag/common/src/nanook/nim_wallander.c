/* $Id: nim_wallander.c,v 1.2 2019/12/11 10:10:33 lucywang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nanook/nim_wallander.c,v $
 * ------------------------------------------------------------------
 *
...
#if !defined (UTAH) && !defined (CURIE_1RU) && !defined (NANOOK)
...
#if !defined(UTAH) && !defined(TACHI) && !defined (CURIE_1RU) && !defined (NANOOK)
...
wallander_bp_ge_test ()
{
    ...
    printf("Warning: not suported without BCM GESW.\n");
    return (PASSED);
#endif
