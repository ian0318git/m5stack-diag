/* $Id: platform_prom.h,v 1.2 2019/12/11 10:10:34 lucywang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nanook/platform_prom.h,v $
 *--------------------------------------------------------------------
 * fpga_prom_regs.h
 *
...
#define FPGA_CROCURS_FILE_PATH            "/firmware/crocus_fw"
...
#define PROM_RD_FIFO_FULL                   0x00000004
#define PROM_WR_FIFO_EMPTY                  0x00000008
#define PROM_WR_FIFO_FULL                   0x00000010
...
#define PROM_WRITE_ERROR                    0x00000020
#define PROM_WRITE_FIFO_OVERRUN             0x00000001
...
#define CROCUS_SPI_REGISTER_OFFSET       0x100

#define PROM_SLEEP_1_MS                  1
#define PROM_SLEEP_10_MS                 10
#define PROM_SLEEP_100_MS                100
#define PROM_SLEEP_500_MS                500
#define PROM_SLEEP_1000_MS               1000
...
extern int write_spi_prom_status_reg(prom_t *, uchar);
...
extern int prom_sector_erase (prom_t *spi_prom, ushort sector);
extern int DSWAP4(int);
extern prom_t * init_spi_prom_ds(void);
