 /* $Id: platform_cpu.c,v 1.2 2019/12/11 10:10:33 lucywang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nanook/platform_cpu.c,v $
 *------------------------------------------------------------------
 *
 * platform_cpu.c
 *
...
int cpu_core_test (int do_more_test)
{
   int rc = FAILED;
    ...
    if (linux_cpu_core_test(NANOOK_CPU_NUM) != PASSED) {
