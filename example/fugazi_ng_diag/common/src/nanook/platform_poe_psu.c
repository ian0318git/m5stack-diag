/* $Id: platform_poe_psu.c,v 1.2 2019/12/11 10:10:34 lucywang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nanook/platform_poe_psu.c,v $
 *------------------------------------------------------------------
 * 
 * Filename   : platform_poe_psu.c
 * Description: Source file of POE related function.
 *
