/* $Id: testcard_fpga.c,v 1.2 2019/12/11 10:10:36 lucywang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nanook/testcard_fpga.c,v $
 *------------------------------------------------------------------
...
static submenu_xtable_t tc_fpga_diag_tbl[] = {
    ...
    /* Mark for Nannok plus non-POE platform. */
#ifdef TC_POE_54V
