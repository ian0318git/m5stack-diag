 /* $Id: ngio.h,v 1.3 2020/01/09 01:03:00 jiajliu Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nanook/ngio.h,v $
 *------------------------------------------------------------------
 * Filename:    ngio.h
 *
 *
 ...
 * All rights reserved.
 *
 * Nanook only have WIC ngio, create this dummy file for
...
/* although there is no vm and sm on nanook
...
extern void ngiosm_enable_intr (int, int);
...
extern void ngiosata_enable_intr (int dev, int intr_type);
extern void ngiosata_disable_intr (int dev, int intr_type);
