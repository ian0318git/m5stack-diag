/* $Id: ngio.c,v 1.3 2020/01/09 01:03:00 jiajliu Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nanook/ngio.c,v $
 *------------------------------------------------------------------
...
ngiowic_disable (void *p)
{
    ...
    /* Nanook has NIM1 only */
    bus = NANOOK_NIM1_PCIE_UPPORT_BUS;
    dev = NANOOK_NIM1_PCIE_UPPORT_DEV;
    func = NANOOK_NIM1_PCIE_UPPORT_FUNC;
    offset = NANOOK_NIM1_PCIE_UPPORT_2ND_BUS_OFF;
    ...
    sprintf(file_rmv, "%s0000:%02x:00.0/remove",
            NANOOK_NIM1_PCIE_UPPORT_PATH, reg);
    ...
    offset = NANOOK_NIM1_PCIE_UPPORT_2ND_RESETOFF;
...
host_ngio_10gkr_capability (uint mod_type, uint slot)
{
    ...
    //printf("FIXME host_ngio_10gkr_capability\n");
