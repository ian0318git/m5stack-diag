 /* $Id: diag_emmc_util.h,v 1.2 2019/12/11 10:10:28 lucywang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nanook/diag_emmc_util.h,v $
 *------------------------------------------------------------------
 *
...
/* eMMC info structure */
typedef struct nanook_emmc_info {
    char manf_name[32];
    char prod_name[32];
} emmc_info_t;
