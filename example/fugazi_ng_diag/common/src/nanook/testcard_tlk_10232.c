/* $Id: testcard_tlk_10232.c,v 1.2 2019/12/11 10:10:36 lucywang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nanook/testcard_tlk_10232.c,v $
 *------------------------------------------------------------------
...
{
    int main_result = FAILED, ctrl_plane_sgmii_port; 
    int dummy = 0;
