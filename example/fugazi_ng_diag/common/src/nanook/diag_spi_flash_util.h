/* $Id: diag_spi_flash_util.h,v 1.2 2019/12/11 10:10:31 lucywang Exp $
 *------------------------------------------------------------------
...
#define NANOOK_DENVERTON_SPI_CTRL_MM_ADDR  0xFE010000
...
extern int nanook_spi_flash_utils (int);
extern int nanook_spi_flash_get_rdsr (int, uchar *); 
extern int nanook_spi_flash_get_prod_id (int, uint*);
