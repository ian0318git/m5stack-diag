 /* $Id: diag_emmc_test.c,v 1.2 2019/12/11 10:10:28 lucywang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/nanook/diag_emmc_test.c,v $
 *------------------------------------------------------------------
 *
...
int emmc_tests (int option)
{
    ...
    retval = linux_block_test(src, 0, EMMC_TEST_LENGTH, BLOCK_TEST_RANDOM, TRUE);
    return (retval);
}
