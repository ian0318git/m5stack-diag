/* $Id: plug_lte_telit_host.c,v 1.2 2019/05/14 08:48:37 sherliu2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/plug_lte/plug_lte_telit/plug_lte_telit_host.c,v $
 *------------------------------------------------------------------
 *
 * plug_lte_telit_host.c - Pluggable LTE Telit Host Functions
...
__attribute__((weak, alias("__plug_lte_telit_host_get_plug_usb_devinfo")));
int __plug_lte_telit_host_get_plug_usb_devinfo (int plug_slot,
                                                char *plug_usb2p0_ptr,
                                                char *plug_usb3p0_ptr,
                                                char *plug_usb_dport_ptr)
{
...
__attribute__((weak, alias("__plug_lte_telit_host_get_modem_drv_path")));
int __plug_lte_telit_host_get_modem_drv_path (char *drv_path)
{
    PLUG_WARNING_MSG(__func__)
    return (FAILED);
}
