/* $Id: platform_sfp_cookie.h,v 1.1 2020/08/19 09:50:05 markzha Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-mmwv/platform_sfp_cookie.h,v $
 *------------------------------------------------------------------
