/* $Id: highrise_cpld_lib.h,v 1.2 2021/06/02 02:56:21 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-mmwv/highrise_cpld_lib.h,v $
 *******************************************************************************
...
#define HR_CPLD_BOARD_HIGHTOWER_MMWV    1
#define HR_CPLD_BOARD_HIGHTOWER_SUB6    2
...
#define HR_CPLD_MODEM_STA_ANTE_REST     0x00000800
#define HR_CPLD_MODEM_STA_ANTE_NAME     0x00000400
...
#define HT_CPLD_INT_POE_I2C_BUF         0x00000080
#define HT_CPLD_INT_SFP_I2C_BUF         0x00000040
#define HT_CPLD_INT_SFP_PRESENT         0x00000020
#define HT_CPLD_INT_TEMP_SENSOR         0x00000010
#define HT_CPLD_INT_RESET_BUTTON        0x00000008
...
#define HR_CPLD_PHY_STA_POE_I2C_BUF_RDY 0x00004000
#define HR_CPLD_PHY_STA_POE_I2C_BUF_EN  0x00002000
#define HR_CPLD_PHY_STA_SFP_I2C_BUF_RDY 0x00001000
#define HR_CPLD_PHY_STA_SFP_I2C_BUF_EN  0x00000800
#define HR_CPLD_PHY_STA_SFP_PRST        0x00000400
#define HR_CPLD_PHY_STA_WOL_GPIO        0x000003C0
...
extern long hr_cpld_intr_enable(unsigned long enb_msk, int);
...
extern long hr_cpld_intr_clear(unsigned long); 
 ...
 *
 * Revision 1.1.4.4  2020/12/23 07:58:27  alpeng
 ...
 *
 * Revision 1.1.4.2  2020/09/18 07:44:37  alpeng
