/* $Id: platform_rtc.c,v 1.1 2020/08/19 09:50:05 markzha Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-mmwv/platform_rtc.c,v $
 *------------------------------------------------------------------
...
dev_obj_create(dev_ds1337_object_t *pds1337, n2g_i2c_if_t *i2c_if)
{
    ...
    i2c_if->offset = 0;
    i2c_if->i2c_bus_type = CPU_I2C1;      /* I2C bus number */
