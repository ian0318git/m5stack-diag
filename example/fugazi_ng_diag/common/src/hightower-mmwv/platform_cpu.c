/* $Id: platform_cpu.c,v 1.2 2021/06/02 02:56:21 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-mmwv/platform_cpu.c,v $
 *------------------------------------------------------------------
 *
 * platform_cpu.c
...
int highrise_show_cpuinfo (void)
{
    ...
    switch (reg_val) {
        case CPU_2000_DDR_1200_RCLK_1200:
            printf("%-16s: 0x%08x(%s)\n", "CPU Freq", reg_val, "CPU_2000_DDR_1200_RCLK_1200");
            break;
        case CPU_2200_DDR_1200_RCLK_1200:
            printf("%-16s: 0x%08x(%s)\n", "CPU Freq", reg_val, "CPU_2200_DDR_1200_RCLK_1200");
            break;
        case CPU_1600_DDR_1200_RCLK_1200:
            printf("%-16s: 0x%08x(%s)\n", "CPU Freq", reg_val, "CPU_1600_DDR_1200_RCLK_1200");
            break;
        default:
