/* $Id: platform_i2c.h,v 1.1 2020/08/19 09:50:05 markzha Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-mmwv/platform_i2c.h,v $
 *------------------------------------------------------------------
...
#define MB_I2C_BUS_CPLD        CPU_I2C2
#define MB_I2C_CTRL_CPLD       CPU_I2C2
#define MB_I2C_MUX_CPLD        I2C_MUX_ZERO

/* I2C 1 Device Addresses */
/* SFP  Lite */
#define MB_I2C_ADDR_SFP        0x50 //(0xA0 >> 1)
#define MB_I2C_BUS_SFP         CPU_I2C1
#define MB_I2C_CTRL_SFP        CPU_I2C1
#define MB_I2C_MUX_SFP         I2C_MUX_ZERO

/* ACT2 Lite */
#define MB_I2C_ADDR_ACT2       0x74 //(0xE8 >> 1)
#define MB_I2C_BUS_ACT2        CPU_I2C1
#define MB_I2C_CTRL_ACT2       CPU_I2C1
#define MB_I2C_MUX_ACT2        I2C_MUX_ZERO

/* RTC */
#define MB_I2C_ADDR_RTC        0x68 //(0x68 >> 1)
#define MB_I2C_BUS_RTC         CPU_I2C1
#define MB_I2C_CTRL_RTC        CPU_I2C1
#define MB_I2C_MUX_RTC         I2C_MUX_ZERO

/* TMP75 */
#define MB_I2C_ADDR_TMP75      0x4C /* update from 0x48 to 0x4c on P1A */
#define MB_I2C_BUS_TMP75       CPU_I2C1
#define MB_I2C_CTRL_TMP75      CPU_I2C1
