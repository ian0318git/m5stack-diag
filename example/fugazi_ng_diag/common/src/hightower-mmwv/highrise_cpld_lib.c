 /* $Id: highrise_cpld_lib.c,v 1.2 2021/06/02 02:56:21 alpeng Exp $
 *  $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-mmwv/highrise_cpld_lib.c,v $
 *******************************************************************************
...
static reg_info_t cpld_test_regs[] = {
    ...
    HR_CPLD_REG(CPU_RESET_TRIGGER,  RONLY,  0xFFFFFFFF, 0x00000000), //to be updated
  ...
  //HR_CPLD_REG(DEBUG,              RW,     0x0000000F, 0x00000000),
 ...
 *
 * Revision 1.1.4.1  2021/02/12 01:16:57  tshanmug
 * Chrysler CPLD reg 0x60 access for modem power
 *
