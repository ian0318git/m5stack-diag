/* $Id: hightower_5g_modem_lib.c,v 1.2 2021/06/02 02:56:21 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-mmwv/hightower_5g_modem_lib.c,v $
 *********************************************************************
 *
 ...
 *              ID and speed
 * Inputs     : pci_businfo - USB device info
 *              vid - Vendor ID
 *              speed - 8GT/s (PCIe)
 * Outputs    : PASSED or FAILED
 *******************************************************************************
 ...
 *
 * Revision 1.1.4.2  2021/05/12 17:54:23  tshanmug
