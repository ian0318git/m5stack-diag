/* $Id: object.h,v 1.1 2013/05/09 05:42:38 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/object.h,v $
 *----------------------------------------------------------------------------
...
OBJECT_ID act2_test_create_object(void *module, SESSION_ID session_id, POBJECT_ATTRIBUTES obj_attributes, ACT2_STATUS expected_result);
OBJECT_ID act2_create_object(void *module, SESSION_ID session_id, POBJECT_ATTRIBUTES obj_attributes);
...
u2 act2_get_object_length(void *module, SESSION_ID session_id, OBJECT_ID object_id);
ACT2_STATUS secure_object_enumerate(void *module, IN SESSION_ID session_id, IN p_u1 num_objects, OUT ACT2_OBJECT_ENUM *object_list);
#endif
...
Revision 1.2  2012/11/07 10:58:15  alpeng
remove useless file and clean up code

Revision 1.1  2012/06/20 20:29:58  mcharon
support wdc
