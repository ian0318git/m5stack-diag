/* $Id: platform_led.c,v 1.2 2013/12/20 10:30:30 danchung Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/utah/platform_led.c,v $
 *------------------------------------------------------------------
...
static struct mitem led_items[] = {
    {"Flash LED util",             0, 0, (type_t(*)())led_cf_util,
    ...
    {"SFP1 LED util",                       0,0, (type_t(*)())led_sfp_util, 
                             (type_t *)&one,  0, (type_t(*)())is_utah,       0},
    {"SFP2 LED util",                       0,0, (type_t(*)())led_sfp_util, 
                             (type_t *)&two,  0, (type_t(*)())is_us_machines,       0},
...
led_cf_util (void) 
{
	...
	printf("  3. Show activity signal status\n");
        ...
        printf("  6. Show LED flash On/Off register\n");
	printf("  7. exit\n");
	...
	case 6:   	    
	    printf("LED Flash On/Off Register %#.8x\n", led_cf_reg);
	    continue;
	break;   
	case 7:
	    exit_flag = TRUE;
...
Revision 1.2  2013/12/20 10:30:30  danchung
Minor change for USD led utils
