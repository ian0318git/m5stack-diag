/* $Id: platform_idprom_utils.h,v 1.1 2014/01/13 09:35:42 hroni Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/utah/platform_idprom_utils.h,v $
 *------------------------------------------------------------------
 *
