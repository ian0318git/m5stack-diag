/* $Id: platform_led.h,v 1.1 2013/05/09 05:42:39 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/platform_led.h,v $
 *--------------------------------------------------------------------
 ...
 */
#define HDD2_STAT_LED_MSK         0xE0000000
#define HDD2_LED_OFF              0x00000000
#define HDD2_LED_GREEN            0x40000000
#define HDD2_LED_GREEN_BLINK      0x60000000
#define HDD2_LED_YELLOW           0x80000000
#define HDD2_LED_YELLOW_BLINK     0xA0000000
#define HDD1_STAT_LED_MSK         0x1C000000
#define HDD1_LED_OFF              0x00000000
#define HDD1_LED_GREEN            0x08000000
#define HDD1_LED_GREEN_BLINK      0x0C000000
#define HDD1_LED_YELLOW           0x10000000
#define HDD1_LED_YELLOW_BLINK     0x14000000
#define HDD_STAT_BLINK_TIME_MSK   0x03FF0000
#define HDD_STAT_BLINK_TIME_OFF   16
#define HDD_ACT_INVERSION         0x00008000
#define HDD_ACT_STAT              0x00004000
#define HDD_ACT_GREEN             0x00001000
...
Revision 1.7  2012/11/29 02:14:34  palin2
To add HDD and Environmental LEDs control utility spoort.

Revision 1.6  2012/11/28 02:36:17  palin2
Fixed Ethernet LED utility: Management and RJ45.

Revision 1.5  2012/11/07 10:58:16  alpeng
remove useless file and clean up code

Revision 1.4  2012/10/11 08:24:42  alpeng
unsupported SATA on wic slot 3

Revision 1.3  2012/07/23 08:58:14  alpeng
