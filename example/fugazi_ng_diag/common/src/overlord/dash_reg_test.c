/* $Id: dash_reg_test.c,v 1.14 2018/05/18 09:24:51 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/dash_reg_test.c,v $
 *------------------------------------------------------------------
 *
...
dash_rd_wr_test (int flag)
{
    ...
    if (is_goldbeach()) {
        /*CSCvc48599 : Goldbeach Rangeley CPU has LPC interface issue.
         *Diag enhance the LPC register test.*/
...
Revision 1.14  2018/05/18 09:24:51  alpeng
 Neptune merge to trunk with tag <neptune-branch-0518>

Revision 1.13  2017/08/10 10:10:41  iachang
CSCvf44161: Merge Goldbeach into USD platform as one image

Revision 1.12  2016/12/21 07:08:07  iachang
Fixed Cavium compile issue.

Revision 1.11  2016/12/21 01:59:57  iachang
CSCvc48599:Enhance LPC register test

Revision 1.10.68.4  2018/05/17 10:50:22  alpeng
 sync with trunk <trunk-051618>

Revision 1.10.68.3  2017/04/05 06:41:58  leschen
Sync with <ng_diag-tag-032917>

Revision 1.10.68.2  2016/10/20 01:51:33  leschen
Modify to use scratchpad reg to do FPGA register test

Revision 1.10.68.1  2016/10/12 23:28:17  leschen
Modify Neptune fpga register test
...
Revision 1.10  2013/03/13 23:00:25  mcharon
don't test mailbox during reg test. mailbox is used by NIOS.

Revision 1.9  2012/11/06 20:39:50  mcharon
add headers/cleanup/remove unneeded functions/files

Revision 1.8  2012/06/07 00:15:44  palin2
Clean up compiler warnings.

Revision 1.7  2012/06/07 00:09:39  palin2
Clean up compiler warnings.

Revision 1.6  2012/06/06 15:00:27  palin2
Clean up compiler warnings.

Revision 1.5  2012/06/05 11:44:30  palin2
Clean up compiler warnings.

Revision 1.4  2012/05/10 07:48:06  alpeng
moving DASH FPGA reg test to MB test, fixed printing message

Revision 1.3  2012/05/04 23:28:15  ptong
Remove prcomplete call
