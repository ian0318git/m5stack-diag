/* $Id: mfg_api.h,v 1.1 2013/05/09 05:42:38 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/mfg_api.h,v $
 *----------------------------------------------------------------------------
...
//ACT2_STATUS get_hash ( void *module, SESSION_ID session_id, HASH_ALGORITHM hash_algorithm, u4 data_length, p_u1 data_block, p_u1 message_digest_length, p_u1 message_digest );
...
extern int act2_drv_write(void *module, unsigned char *send_buf, unsigned int
                            length);
extern int act2_drv_read(void *module, unsigned char *status_buf, unsigned int
                            length);
...
Revision 1.4  2012/06/26 16:59:45  mcharon
add extern for act2_get_random_number

Revision 1.3  2012/06/20 20:29:58  mcharon
support wdc
