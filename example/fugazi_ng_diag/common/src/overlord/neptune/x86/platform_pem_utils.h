/* $Id: platform_pem_utils.h,v 1.2 2018/05/18 09:25:00 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/x86/platform_pem_utils.h,v $
 *------------------------------------------------------------------
 *
...
uchar pem_dev_addr( int ps );
int rp1ruve_pem_check_present( int ps_num, int *size );
 ...
 *
 * Revision 1.5  2014/07/01 10:32:31  danchung
 * Support Juno AC+IP supply registers read utility for different page
 *
 * Revision 1.4  2013/08/22 07:53:25  alpeng
 * fix compile warning
 *
 * Revision 1.3  2013/08/22 07:43:30  alpeng
