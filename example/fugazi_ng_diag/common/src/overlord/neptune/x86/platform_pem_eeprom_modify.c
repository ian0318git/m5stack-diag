/* $Id: platform_pem_eeprom_modify.c,v 1.2 2018/05/18 09:25:00 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/x86/platform_pem_eeprom_modify.c,v $
 *------------------------------------------------------------------
 *
...
extern boolean is_utah(void);
extern boolean is_neptune(void);
extern boolean is_ntpn_machines(void);
extern boolean is_vg450(void);
...
{
    if (is_overlord() || is_utah() || is_ntpn_machines() || is_vg450()) {
 ...
 *
 * Revision 1.1.2.4  2017/11/22 07:35:10  leschen
 * Supporting Barsoom VG450 which FGPA sub board type is 0x43.
 *
 * Revision 1.1.2.3  2017/03/13 07:34:55  leschen
 * Support Triton system.
 *
 * Revision 1.1.2.2  2016/10/12 23:38:19  leschen
