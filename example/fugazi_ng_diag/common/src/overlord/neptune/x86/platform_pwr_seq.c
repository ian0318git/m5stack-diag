/* $Id: platform_pwr_seq.c,v 1.4 2019/08/06 06:56:15 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/x86/platform_pwr_seq.c,v $
 *------------------------------------------------------------------
...
static pwr_seq_v_t voltage_test_table[] =
{
    ...
    {"12 Current",         PWR_SEQ_12_0_C_OVER, PWR_SEQ_12_0_C_UNDER,
      PWR_SEQ_12_0_C_LR,   PWR_SEQ_12_0_C_MAX,  PWR_SEQ_12_0_C_MIN},
    {"5.0 Volt",           PWR_SEQ_5_0_OVER,    PWR_SEQ_5_0_UNDER, 
      PWR_SEQ_5_0_LR,      PWR_SEQ_5_0_MAX,     PWR_SEQ_5_0_MIN},
    {"3.3 Volt CP CPU",    PWR_SEQ_3_3_CP_CPU_OVER,    PWR_SEQ_3_3_CP_CPU_UNDER,
    ...
    {"CP CPU CORE",        PWR_SEQ_CP_CPU_CORE_OVER,    PWR_SEQ_CP_CPU_CORE_UNDER,
      PWR_SEQ_CP_CPU_CORE_LR,      PWR_SEQ_CP_CPU_CORE_MAX,     PWR_SEQ_CP_CPU_CORE_MIN},
    {"1.8 Volt",           PWR_SEQ_1_8_OVER,    PWR_SEQ_1_8_UNDER, 
      PWR_SEQ_1_8_LR,      PWR_SEQ_1_8_MAX,     PWR_SEQ_1_8_MIN},
    {"1.7 Volt",           PWR_SEQ_1_7_OVER,    PWR_SEQ_1_7_UNDER, 
    ...
    {"1.3 Volt",           PWR_SEQ_1_2_OVER,    PWR_SEQ_1_3_UNDER,
    ...
    {"1.2 Volt CP CPU",    PWR_SEQ_1_2_CP_CPU_OVER,    PWR_SEQ_1_2_CP_CPU_UNDER,
      PWR_SEQ_1_2_CP_CPU_LR,    PWR_SEQ_1_2_CP_CPU_MAX,     PWR_SEQ_1_2_CP_CPU_MIN},
    {"1.1 Volt",           PWR_SEQ_1_1_OVER,    PWR_SEQ_1_1_UNDER,
      PWR_SEQ_1_1_LR,      PWR_SEQ_1_1_MAX,     PWR_SEQ_1_1_MIN},
    {"1.05 Volt",          PWR_SEQ_1_05_OVER,   PWR_SEQ_1_05_UNDER,
    ...
    {"0.9 Volt",           PWR_SEQ_0_9_OVER,    PWR_SEQ_0_9_UNDER,
      PWR_SEQ_0_9_LR,      PWR_SEQ_0_9_MAX,     PWR_SEQ_0_9_MIN},
    {"0.85 Volt",          PWR_SEQ_0_85_OVER,   PWR_SEQ_0_85_UNDER,
      PWR_SEQ_0_85_LR,     PWR_SEQ_0_85_MAX,    PWR_SEQ_0_85_MIN},
    {"0.6 CP DDR Volt",    PWR_SEQ_0_6_CP_DDR_OVER,   PWR_SEQ_0_6_CP_DDR_UNDER, 
      PWR_SEQ_0_6_CP_DDR_LR, PWR_SEQ_0_6_CP_DDR_MAX,    PWR_SEQ_0_6_CP_DDR_MIN},
    {"0.6 DP DDR Volt",    PWR_SEQ_0_6_DP_DDR_OVER,   PWR_SEQ_0_6_DP_DDR_UNDER, 
      PWR_SEQ_0_6_DP_DDR_LR, PWR_SEQ_0_6_DP_DDR_MAX,    PWR_SEQ_0_6_DP_DDR_MIN},
...
Revision 1.3.2.1  2019/05/27 03:21:49  yozou
...
Revision 1.1.2.8  2018/05/07 06:04:09  leschen
Add 1s delay before reset the system for MCU upgrade.

Revision 1.1.2.7  2018/04/18 02:08:58  leschen
Add barrier to prevent user using the incorrect fw image to upgrade MCU.

Revision 1.1.2.6  2018/04/11 08:27:10  leschen
Add new argument to display plug-in itmes and env status.

Revision 1.1.2.5  2017/12/11 01:49:29  alpeng
fix alter reg data size from 8 to 16-bit

Revision 1.1.2.4  2017/10/13 06:37:04  leschen
Enhance MCU firmware upgrade utility as more flexible and user friendly.

Revision 1.1.2.3  2017/06/06 06:22:52  leschen
