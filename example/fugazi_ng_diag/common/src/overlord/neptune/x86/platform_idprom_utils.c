/* $Id: platform_idprom_utils.c,v 1.2 2018/05/18 09:25:00 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/x86/platform_idprom_utils.c,v $
 *------------------------------------------------------------------
 *
...
void idprom_display_env_voltages (idprom_env_voltage_t *env_voltages) 
{
    ...
    sprintf(sensor_name, "%s", env_voltages->sensor_name);
