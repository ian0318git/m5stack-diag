/* $Id: platform_pwr_seq.h,v 1.2 2018/05/18 09:25:00 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/x86/platform_pwr_seq.h,v $
 *------------------------------------------------------------------
...
#define PWR_SEQ_CP_CPU_CORE_LR	0x3C
#define PWR_SEQ_CP_CPU_CORE_MAX	0x3D
#define PWR_SEQ_CP_CPU_CORE_MIN	0x3E
#define PWR_SEQ_CP_CPU_CORE_RPT	0x3F
...
#define PWR_SEQ_1_2_CP_CPU_LR	0x54
#define PWR_SEQ_1_2_CP_CPU_MAX	0x55
#define PWR_SEQ_1_2_CP_CPU_MIN	0x56
#define PWR_SEQ_1_2_CP_CPU_RPT	0x57
#define PWR_SEQ_1_1_LR		0x58
#define PWR_SEQ_1_1_MAX		0x59
#define PWR_SEQ_1_1_MIN		0x5A
#define PWR_SEQ_1_1_RPT		0x5B
#define PWR_SEQ_1_05_LR		0x5C
#define PWR_SEQ_1_05_MAX	0x5D
#define PWR_SEQ_1_05_MIN	0x5E
#define PWR_SEQ_1_05_RPT	0x5F
#define PWR_SEQ_1_0_LR		0x60
#define PWR_SEQ_1_0_MAX		0x61
#define PWR_SEQ_1_0_MIN		0x62
#define PWR_SEQ_1_0_RPT		0x63
#define PWR_SEQ_0_9_LR		0x64
#define PWR_SEQ_0_9_MAX		0x65
#define PWR_SEQ_0_9_MIN		0x66
#define PWR_SEQ_0_9_RPT		0x67
#define PWR_SEQ_0_85_LR		0x68
#define PWR_SEQ_0_85_MAX	0x69
#define PWR_SEQ_0_85_MIN	0x6A
#define PWR_SEQ_0_85_RPT	0x6B
#define PWR_SEQ_0_6_CP_DDR_LR	0x6C
#define PWR_SEQ_0_6_CP_DDR_MAX	0x6D
#define PWR_SEQ_0_6_CP_DDR_MIN	0x6E
#define PWR_SEQ_0_6_CP_DDR_RPT	0x6F
#define PWR_SEQ_0_6_DP_DDR_LR	0x70
#define PWR_SEQ_0_6_DP_DDR_MAX	0x71
#define PWR_SEQ_0_6_DP_DDR_MIN	0x72
#define PWR_SEQ_0_6_DP_DDR_RPT	0x73
#define PWR_SEQ_NIM_CR_LR	0x74
#define PWR_SEQ_NIM_CR_MAX	0x75
#define PWR_SEQ_NIM_CR_MIN	0x76
#define PWR_SEQ_NIM_CR_RPT	0x77
#define PWR_SEQ_FAN_CR_LR	0x78
#define PWR_SEQ_FAN_CR_MAX	0x79
#define PWR_SEQ_FAN_CR_MIN	0x7A
#define PWR_SEQ_FAN_CR_RPT	0x7B
#define PWR_SEQ_3_3_STV_LR	0x7C
#define PWR_SEQ_3_3_STV_MAX	0x7D
#define PWR_SEQ_3_3_STV_MIN	0x7E
#define PWR_SEQ_3_3_STV_RPT	0x7F
#define PWR_SEQ_DEBUG_LR	0x80
#define PWR_SEQ_DEBUG_MAX	0x81
#define PWR_SEQ_DEBUG_MIN	0x82
#define PWR_SEQ_DEBUG_RPT	0x83
 ...
 */
/* Neptune */
#define PWR_SEQ_12_0_PON	0x88
#define PWR_SEQ_12_0_POFF	0x89
#define PWR_SEQ_12_0_OVER	0x8A
#define PWR_SEQ_12_0_UNDER	0x8B

#define PWR_SEQ_12_0_C_PON	0x8C
#define PWR_SEQ_12_0_C_POFF	0x8D
#define PWR_SEQ_12_0_C_OVER	0x8E
#define PWR_SEQ_12_0_C_UNDER	0x8F

#define PWR_SEQ_5_0_PON	        0x90
#define PWR_SEQ_5_0_POFF	0x91
#define PWR_SEQ_5_0_OVER	0x92
#define PWR_SEQ_5_0_UNDER	0x93

#define PWR_SEQ_3_3_CP_CPU_PON		0x94
#define PWR_SEQ_3_3_CP_CPU_POFF		0x95
#define PWR_SEQ_3_3_CP_CPU_OVER		0x96
#define PWR_SEQ_3_3_CP_CPU_UNDER	0x97

#define PWR_SEQ_3_3_PON	        0x98
#define PWR_SEQ_3_3_POFF	0x99
#define PWR_SEQ_3_3_OVER	0x9A
#define PWR_SEQ_3_3_UNDER	0x9B

#define PWR_SEQ_3_0_PON		0x9C
#define PWR_SEQ_3_0_POFF	0x9D
#define PWR_SEQ_3_0_OVER	0x9E
#define PWR_SEQ_3_0_UNDER	0x9F

#define PWR_SEQ_2_5_PON		0xA0
#define PWR_SEQ_2_5_POFF	0xA1
#define PWR_SEQ_2_5_OVER	0xA2
#define PWR_SEQ_2_5_UNDER	0xA3

#define PWR_SEQ_CP_CPU_CORE_PON		0xA4
#define PWR_SEQ_CP_CPU_CORE_POFF	0xA5
#define PWR_SEQ_CP_CPU_CORE_OVER	0xA6
#define PWR_SEQ_CP_CPU_CORE_UNDER	0xA7

#define PWR_SEQ_1_8_PON		0xA8
#define PWR_SEQ_1_8_POFF	0xA9
#define PWR_SEQ_1_8_OVER	0xAA
#define PWR_SEQ_1_8_UNDER	0xAB

#define PWR_SEQ_1_7_PON		0xAC
#define PWR_SEQ_1_7_POFF	0xAD
#define PWR_SEQ_1_7_OVER	0xAE
#define PWR_SEQ_1_7_UNDER	0xAF

#define PWR_SEQ_1_5_PON		0xB0
#define PWR_SEQ_1_5_POFF	0xB1
#define PWR_SEQ_1_5_OVER	0xB2
#define PWR_SEQ_1_5_UNDER	0xB3

#define PWR_SEQ_1_3_PON		0xB4
#define PWR_SEQ_1_3_POFF	0xB5
#define PWR_SEQ_1_3_OVER	0xB6
#define PWR_SEQ_1_3_UNDER	0xB7

#define PWR_SEQ_1_2_PON		0xB8
#define PWR_SEQ_1_2_POFF	0xB9
#define PWR_SEQ_1_2_OVER	0xBA
#define PWR_SEQ_1_2_UNDER	0xBB

#define PWR_SEQ_1_2_CP_CPU_PON		0xBC
#define PWR_SEQ_1_2_CP_CPU_POFF		0xBD
#define PWR_SEQ_1_2_CP_CPU_OVER		0xBE
#define PWR_SEQ_1_2_CP_CPU_UNDER	0xBF

#define PWR_SEQ_1_1_PON		0xC0
#define PWR_SEQ_1_1_POFF	0xC1
#define PWR_SEQ_1_1_OVER	0xC2
#define PWR_SEQ_1_1_UNDER	0xC3

#define PWR_SEQ_1_05_PON	0XC4
#define PWR_SEQ_1_05_POFF	0xC5
#define PWR_SEQ_1_05_OVER	0xC6
#define PWR_SEQ_1_05_UNDER	0xC7

#define PWR_SEQ_1_0_PON		0xC8
#define PWR_SEQ_1_0_POFF	0xC9
#define PWR_SEQ_1_0_OVER	0xCA
#define PWR_SEQ_1_0_UNDER	0xCB

#define PWR_SEQ_0_9_PON		0xCC
#define PWR_SEQ_0_9_POFF	0xCD
#define PWR_SEQ_0_9_OVER	0xCE
#define PWR_SEQ_0_9_UNDER	0xCF

#define PWR_SEQ_0_85_PON	0xD0
#define PWR_SEQ_0_85_POFF	0xD1
#define PWR_SEQ_0_85_OVER	0xD2
#define PWR_SEQ_0_85_UNDER	0xD3

#define PWR_SEQ_0_6_CP_DDR_PON		0xD4
#define PWR_SEQ_0_6_CP_DDR_POFF		0xD5
#define PWR_SEQ_0_6_CP_DDR_OVER		0xD6
#define PWR_SEQ_0_6_CP_DDR_UNDER	0xD7

#define PWR_SEQ_0_6_DP_DDR_PON		0xD8
#define PWR_SEQ_0_6_DP_DDR_POFF		0xD9
#define PWR_SEQ_0_6_DP_DDR_OVER		0xDA
#define PWR_SEQ_0_6_DP_DDR_UNDER	0xDB

#define PWR_SEQ_NIM_CR_PON	0xDC
#define PWR_SEQ_NIM_CR_POFF	0xDD
#define PWR_SEQ_NIM_CR_OVER	0xDE
#define PWR_SEQ_NIM_CR_UNDER	0xDF

#define PWR_SEQ_FAN_CR_PON	0xE0
#define PWR_SEQ_FAN_CR_POFF	0xE1
#define PWR_SEQ_FAN_CR_OVER	0xE2
#define PWR_SEQ_FAN_CR_UNDER	0xE3

#define PWR_SEQ_3_3_STV_PON	0xE4
#define PWR_SEQ_3_3_STV_POFF	0xE5
#define PWR_SEQ_3_3_STV_OVER	0xE6
#define PWR_SEQ_3_3_STV_UNDER	0xE7

#define PWR_SEQ_DEBUG_PON	0xE8
#define PWR_SEQ_DEBUG_POFF	0xE9
#define PWR_SEQ_DEBUG_OVER	0xEA
#define PWR_SEQ_DEBUG_UNDER	0xEB
...
Revision 1.1.2.4  2017/06/06 06:22:52  leschen
Support MCU firmware upgrade feature.

Revision 1.1.2.3  2016/09/12 09:23:06  leschen
Update registers map again base on HW's latest change.

Revision 1.1.2.2  2016/09/05 06:29:53  leschen
1.Update registers map. 2.FW update feature is available on P1b. 3.Margin feature move to FPGA.

Revision 1.1.2.1  2016/08/10 09:05:09  leschen
Support power sequencer utility
