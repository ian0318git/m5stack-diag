/* $Id: platform_pem_fan.c,v 1.2 2018/05/18 09:25:00 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/x86/platform_pem_fan.c,v $
 *------------------------------------------------------------------
 *
