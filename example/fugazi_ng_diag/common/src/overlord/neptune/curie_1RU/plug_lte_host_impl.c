/* $Id: plug_lte_host_impl.c,v 1.2 2019/08/06 06:56:15 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/curie_1RU/plug_lte_host_impl.c,v $
 *------------------------------------------------------------------
 *
