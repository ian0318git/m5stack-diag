/* $Id: i350_test.c,v 1.2 2019/08/06 06:56:12 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/curie_1RU/i350_test.c,v $
*-----------------------------------------------------------------------------
...
int i350_int_ext_loopback_test (int port)
{
    ...
    /* Remove file celo_i350_logs.txt */
    if (access(CELO_LOGS_FILE, F_OK) != -1) {
        system(RM_CELO_LOGS_FILE);
    }
...
Revision 1.1.2.5  2019/06/04 06:49:15  leschen
...
Revision 1.1.2.3  2018/09/18 09:46:54  meho
