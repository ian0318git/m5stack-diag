/* $Id: platform_pem_utils.h,v 1.2 2019/08/06 06:56:14 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/curie_1RU/platform_pem_utils.h,v $
 *------------------------------------------------------------------
 *
