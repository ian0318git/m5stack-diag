// $Id: fpga_smartfan.c,v 1.3 2020/06/10 07:40:21 leschen Exp $
// $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/curie_1RU/fpga_smartfan.c,v $
//------------------------------------------------------------------------------
...
void fpga_smartfan_display (unsigned fan)
{
    ...
    unsigned int timeout = 10, ret = 0, retry, retry_max = 3;

    /*  Based on HW's request to retry 3 times to get correct fan info */
