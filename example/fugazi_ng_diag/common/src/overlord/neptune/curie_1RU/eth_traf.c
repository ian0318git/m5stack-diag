/* $Id: eth_traf.c,v 1.3 2021/10/20 06:10:20 iachang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/curie_1RU/eth_traf.c,v $
 *------------------------------------------------------------------
 *
 * eth_raf.c
                    ...
                    time_t timeout)
{
    ...
    if (flag) {
        eth_traf_statistic(tx_traf, &tx_info, 1);
        eth_traf_statistic(rx_traf, &rx_info, 1);
