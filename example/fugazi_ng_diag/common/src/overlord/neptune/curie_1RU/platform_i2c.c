/* $Id: platform_i2c.c,v 1.2 2019/08/06 06:56:13 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/curie_1RU/platform_i2c.c,v $
 *-----------------------------------------------------------------------------
...
int curie_x86_i2c_scan_test (int option)
{
    ...
    for (now_test = 0, test_num = 1; now_test < test_end; now_test++) {
        ...
        if ((fpga_i2c_dev[now_test].i2c_ctrl == I2C_CTRL_ZERO) &&
            (fpga_i2c_dev[now_test].i2c_dev == MB_I2C_ADDR_ACT2)) {
            /* FPGA is updated and disable act2 i2c features on p2b and later */
            continue;
        }
...
Revision 1.1.2.13  2019/04/18 08:42:02  alpeng
skip act2 from i2c scan test; HW disable ACT2 i2c access

Revision 1.1.2.12  2019/02/11 07:33:37  meho
Support new PIM test-card (PCIe)

Revision 1.1.2.11  2018/12/27 08:55:41  alpeng
clean up code

Revision 1.1.2.10  2018/10/31 12:27:37  alpeng
curie psu is the same as Juno, fixed basic util, will fix the remaining psu utils.

Revision 1.1.2.9  2018/10/16 12:11:34  alpeng
fix voltage regultor util

Revision 1.1.2.8  2018/10/05 10:09:10  alpeng
support PIM cookie

Revision 1.1.2.7  2018/10/03 10:06:19  alpeng
fixed ngio using mb act2 structure problem

Revision 1.1.2.6  2018/08/18 07:00:05  meho
Added more i2c control number in FPGA I2C scan addr utility

Revision 1.1.2.5  2018/08/16 17:30:27  alpeng
fixed comiple warning 'unsued var'

Revision 1.1.2.4  2018/08/15 23:00:17  alpeng
fixed ir3570 addr and test for curie

Revision 1.1.2.3  2018/08/15 19:37:27  alpeng
