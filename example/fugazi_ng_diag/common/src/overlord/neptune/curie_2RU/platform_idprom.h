/* $Id: platform_idprom.h,v 1.1 2020/01/09 01:02:02 jiajliu Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/curie_2RU/platform_idprom.h,v $
 *------------------------------------------------------------------
 *
