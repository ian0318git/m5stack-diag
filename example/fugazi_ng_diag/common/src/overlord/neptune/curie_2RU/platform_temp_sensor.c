/* $Id: platform_temp_sensor.c,v 1.1 2020/01/09 01:02:04 jiajliu Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/curie_2RU/platform_temp_sensor.c,v $
 *------------------------------------------------------------------
