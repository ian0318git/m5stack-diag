/* $Id: plug_common_host_impl.c,v 1.1 2020/01/09 01:02:05 jiajliu Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/curie_2RU/plug_common_host_impl.c,v $
 *------------------------------------------------------------------
 *
...
int plug_common_host_usb_3p0_mode_set (int slot)
{
    ...
    if (is_curie_2ru())
        return c2ru_usb_3p0_mode_set(C2RU_USB_PORT_MASK_PIM);
...
{
    if (is_curie_2ru())
        return c2ru_usb_2p0_mode_set(C2RU_USB_PORT_MASK_PIM);
