/* $Id: ovld_common_utils.c,v 1.2 2018/05/18 09:24:56 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/neptune/cavium/ovld_common_utils.c,v $
 *------------------------------------------------------------------
 * Filename: ovld_common_utils.c
 *
 ...
 */
static uint
new_register_read(reg_info_t *reg_ptr, ulong reg_addr, volatile uint *buf)
{
