/* $Id: platform_pem_monitor_read.c,v 1.3 2013/08/14 06:01:35 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/x86/platform_pem_monitor_read.c,v $
 *------------------------------------------------------------------
 *
