/* $Id: platform_pem_utils.h,v 1.5 2014/07/01 10:32:31 danchung Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/x86/platform_pem_utils.h,v $
 *------------------------------------------------------------------
 *
