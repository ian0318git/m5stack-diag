/* $Id: platform_pem_utils.c,v 1.9 2014/07/01 10:32:30 danchung Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/x86/platform_pem_utils.c,v $
 *------------------------------------------------------------------
 *
