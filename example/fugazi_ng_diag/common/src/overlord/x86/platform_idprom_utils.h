/* $Id: platform_idprom_utils.h,v 1.1 2013/05/31 12:43:15 danchung Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/x86/platform_idprom_utils.h,v $
 *------------------------------------------------------------------
 *
