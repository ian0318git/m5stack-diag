/* $Id: i2c_drv.c,v 1.20 2019/08/06 06:56:09 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/i2c_drv.c,v $
 *------------------------------------------------------------------
 *
 ...
 */
int
gfy_i2c_master_reg_test (goofy_i2c_t *i2c)
{
    ulong reg_addr;
 ...
 */
int
gfy_i2c_master_reg_display (goofy_i2c_t *i2c)
{
    ulong reg_addr;
 ...
 */
void
gfy_init_dbgbus (dev_object_t *dev)
{
 ...
 */
void
gfy_wr_i2c_reg (goofy_i2c_t *i2c, uint32_t addr_offset, uint32_t val)
{
 ...
 */
int
gfy_display_i2c_reg (goofy_i2c_t *i2c)
{
 ...
 */
boolean
gfy_chk_i2c_idle(goofy_i2c_t *i2c)
{
 ...
 */
static int
i2c_flush_fifo (goofy_i2c_t *i2c, int byte)
{
    unsigned int tmp;
 ...
 */
void
gfy_rd_i2c_data_fifo(goofy_i2c_t *i2c, uint32_t data_len,
		     uchar *data_p)
{
 ...
 */
void
gfy_wr_i2c_data_fifo(goofy_i2c_t *i2c, uint32_t data_len,
		     uchar *data_p)
{
    uint32_t i, j, word_count, byte_count;
    uint32_t dword;
 ...
 */
int
gfy_i2c_normal_op (goofy_i2c_t *i2c, uint8_t mux,
...
static int
gfy_i2c_send_reg_offset (goofy_i2c_t *i2c, uint32_t mux, uint32_t slv_addr,
 ...
 */
int
gfy_i2c_rd (goofy_i2c_t *i2c, uint8_t mux, uint32_t slv_addr, 
...
*/
int
gfy_i2c_wr (goofy_i2c_t *i2c, uint8_t mux, uint32_t slv_addr,
...
/******** History ******** 
$Log: i2c_drv.c,v $
Revision 1.20  2019/08/06 06:56:09  alpeng
merge curie, switzer and nightwatch to trunk

Revision 1.19.46.2  2018/09/18 22:36:33  ptong
Add i2c address in print statement. Use PIM for pluggable in test menu

Revision 1.19.46.1  2018/08/16 18:22:37  alpeng
...
Revision 1.19  2017/07/14 02:51:38  alpeng
fixed compiler warning, due to cross-compiler version was updated.

Revision 1.18  2013/12/12 01:27:33  mcharon
change timeout_val in gfy_idle from 3000 to 30

Revision 1.17  2013/03/19 05:24:29  mcharon
add error message

Revision 1.16  2013/03/14 18:18:14  mcharon
add argument to i2c_err_no

Revision 1.15  2013/02/26 23:34:25  mcharon
dont' flush fifo, which might cause underflow

Revision 1.14  2013/02/26 17:51:34  mcharon
change error message

Revision 1.13  2013/02/16 06:37:05  mcharon
improve error msg

Revision 1.12  2013/02/08 22:26:58  mcharon
write i2c erro messages to log file

Revision 1.11  2013/02/06 06:09:34  mcharon
add i2c err_no . when fail use this to get failure reason

Revision 1.10  2012/11/07 23:35:28  mcharon
flush i2c data buffer in case i2c not stable when powered up

Revision 1.9  2012/10/25 18:56:18  mcharon
improve error reporting

Revision 1.7  2012/07/17 23:59:11  mcharon
