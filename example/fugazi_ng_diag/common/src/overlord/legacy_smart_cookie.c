/* $Id: legacy_smart_cookie.c,v 1.3 2019/12/18 09:18:37 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/legacy_smart_cookie.c,v $
 *------------------------------------------------------------------
 *
 * from tachi - 
...
static scc_return_status_t scc_process_cmd(sc_context *, void *, ushort, uchar *, 
                                           uint);
static scc_return_status_t i2c_scc_process_cmd(sc_context *, void *, ushort, 
                                               uchar *, uint);
static scc_return_status_t i2c_scc_process_cmd_simple(sc_context *, void *, ushort,
                                                      uchar *, uint);
static scc_return_status_t send_i2c_cmd(sc_context *, void *, uint, void *, uint);
...
Revision 1.1.2.4  2019/01/16 08:08:52  alpeng
update coding rule based on prrq suggestion

Revision 1.1.2.3  2018/10/15 03:31:00  alpeng
update for prrq comments such as coding styles

Revision 1.1.2.2  2018/10/05 08:44:44  alpeng
revert change since the issue is hw problem with special image
