/* $Id: testcard_pcie.c,v 1.11 2018/05/18 09:24:52 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/testcard_pcie.c,v $
 *------------------------------------------------------------------
...
extern int pcie_dump_port_regs_util(uint32_t);
...
static submenu_xtable_t tc_pcie_diag_table[] = {
    ...
    {"PCIe 8-bit PRBS Master loopback test(loopback at TestCard)",
     ...
     (MF_CONTINUOUS | MF_DOALL),    (PFT)is_not_plx, 0, (PFT)0,                   0},
    {"PCIe UTP Master loopback test(loopback at TestCard)",
     (PFT)tc_pcie_8prbs_lpbk_test, FALSE,
     (MF_CONTINUOUS | MF_DOALL),    (PFT)is_plx_wrapper, 0, (PFT)0,                   0},
};
...
Revision 1.11  2018/05/18 09:24:52  alpeng
 Neptune merge to trunk with tag <neptune-branch-0518>

Revision 1.10.30.3  2017/11/27 05:59:42  leschen
Initial check in to support VG450.

Revision 1.10.30.2  2017/03/13 07:49:18  leschen
Support Triton system.

Revision 1.10.30.1  2017/01/06 07:57:14  alpeng
neptune pcie sw is not support PRBS, skip pcie lpbk test on old testcard

Revision 1.10  2014/09/25 09:30:18  danchung
add pcie bus rescan after reset plx pcie switch

Revision 1.9  2014/08/05 13:51:54  danchung
add retry in sm testcard pcie loopback test

Revision 1.8  2014/05/28 14:13:09  danchung
Add fix for sm testcard pcie loopback test intermittent error

Revision 1.7  2013/12/27 09:48:29  danchung
Fix typo of test card PCIe test

Revision 1.6  2013/12/18 00:24:40  mcharon
file_exist now returns size of file

Revision 1.5  2013/11/26 08:40:37  hroni
fix compiler warning

Revision 1.4  2013/11/19 13:40:52  danchung
...
Revision 1.3  2012/09/19 07:29:02  palin2
...
Revision 1.2  2012/08/14 11:30:55  palin2
