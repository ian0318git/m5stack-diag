/* $Id: platform_124mux.c,v 1.4 2013/11/26 08:40:37 hroni Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/cavium/platform_124mux.c,v $
 *------------------------------------------------------------------
 * Filename:	platform_124mux.c
 *
 * Description: Overlord Cavium TI PCA9545A 1:4 Mux I2C device.
