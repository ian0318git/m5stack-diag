/* $Id: diag.c,v 1.24 2013/11/13 11:47:13 hroni Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/cavium/diag.c,v $
 *-----------------------------------------------------------------------------
 * diag.c - Menus for Overlord Cavium data plane
 *
 * March 2011, Paul Tong
 * Copyright (c) 2011-2012, 2013 by Cisco Systems, Inc.
 * All rights reserved.
 *-----------------------------------------------------------------------------
 */
#include <stdint.h>
...
static struct mitem utilmenuitems[] = {
    ...
    {"SFP0 cookie utility",         0,0,(PFT)build_sfp_cookie_menu,     (type_t *)&one,        0,            (type_t(*)())0, 0},
    {"SFP1 cookie utility",         0,0,(PFT)build_sfp_cookie_menu,     (type_t *)&two,        0,            (type_t(*)())0, 0},
    {"SFP2 cookie utility",         0,0,(PFT)build_sfp_cookie_menu,     (type_t *)&three,      0,            (type_t(*)())0, 0},
    {"SFP3 cookie utility",         0,0,(PFT)build_sfp_cookie_menu,     (type_t *)&four,       0,            (type_t(*)())0, 0},
...
submenu_xtable_t main_menu_table[] = {
	...
	F_ALL_E, (type_t(*)())0, 0, (type_t(*)())eth_port_test_main,   0},
