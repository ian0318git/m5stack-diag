/* $Id: platform_barometer.c,v 1.5 2020/01/09 01:02:19 jiajliu Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/overlord/platform_barometer.c,v $
 *------------------------------------------------------------------
 *
...
/*******************************************************************************
 *
 * Function   : ovld_check_system_pressure
 ...
 *******************************************************************************
 */
int ovld_check_system_pressure (void)
{
    unsigned int sys_pressure = 0;
    ...
    if (sys_pressure <= OVLD_SYS_PRESS_THRE) {
        cterr('f', 0, "System Pressure (from Barometer) below %3dKpa"
                      " (now = %3dKpa)",
                      OVLD_SYS_PRESS_THRE, sys_pressure);
...
Revision 1.5  2020/01/09 01:02:19  jiajliu
Merge Curie 2RU to main trunk

Revision 1.4  2019/08/06 06:56:10  alpeng
