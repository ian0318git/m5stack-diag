/* $Id: platform_mcu.h,v 1.3 2018/02/09 09:56:55 hondwang Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tsn/platform_mcu.h,v $ 
 *------------------------------------------------------------------
 *
 * Filename   : platform_mcu.h
 * Description: Header file of TSN MCU Library.
 *
...
/* C1109-4P  */
#define TSN_MCU_VP12P0_VOLTAGE_REG   0x20
#define TSN_MCU_MB12V_CUR_REG        0x58

/* PS Margin Reg(0x17) */
#define TSN_MCU_R17_PS_MSK      0x0003
#define TSN_MCU_R17_PS_NORMAL   0x0000
#define TSN_MCU_R17_PS_ML       0x0001
#define TSN_MCU_R17_PS_MH       0x0002
...
#define STAR_MCU_FILE     	"/firmware/mcuimg"
#define STAR_MCU_AP_SIZE    0x5000  /* noraml 0x3000 =0x9000 ~ 0xC000 */
...
/* Externs */
extern int tsn_mcu_utils(int);
extern int tsn_volts_margin_util(int);
extern int tsn_display_voltage(void);
extern int tsn_mcu_reg_rd(uint32_t, uint16_t *);
extern int tsn_mcu_reg_wr(uint32_t, uint16_t);
extern int srec2bin_main(int, char *argv[], int*, int*);

typedef struct star_mcu_table_t {
...
Revision 1.2.4.5  2017/12/09 04:14:19  steja
Support CISCO MCU upgrade

Revision 1.2.4.4  2017/11/20 07:54:32  lucywang
Changed PID to C1101/C1109-2P/C1109-4P

Revision 1.2.4.3  2017/10/20 04:41:53  hondwang
Add C949-4P MCU voltage and currently display by HW request.

Revision 1.2.4.2  2017/09/30 01:40:58  hondwang
...
Revision 1.1.4.2.2.1  2017/07/20 11:29:02  steja
Code cleanup

Revision 1.1.4.2  2016/06/30 06:22:51  steja
tsn-branch2 sync with main trunk

Revision 1.1.2.1  2016/06/21 04:36:34  palin2
