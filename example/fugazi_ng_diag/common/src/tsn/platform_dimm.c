/* $Id: platform_dimm.c,v 1.2 2017/08/02 14:21:47 steja Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tsn/platform_dimm.c,v $
 *------------------------------------------------------------------
 * platform_dimm.c - TSN DIMM main function/menu.
 *
 * June 2011, Paul Lin
 * 
...
extern uint32_t api_mb_i2c_read(n2g_i2c_dev_t *, uint32_t, uint8_t,
                                char *);
extern uint32_t api_mb_i2c_write(n2g_i2c_dev_t *, uint32_t, uint8_t,
                                 char *);
...
Revision 1.1.2.1  2016/04/23 15:00:29  steja
