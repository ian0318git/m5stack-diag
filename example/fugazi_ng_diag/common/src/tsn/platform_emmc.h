/* $Id: platform_emmc.h,v 1.4 2020/08/28 06:42:59 hondwang Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tsn/platform_emmc.h,v $ 
 *------------------------------------------------------------------
 *
 * Filename   : platform_emmc.h
 * Description: Header file of TSN eMMC Library.
 * 
...
/* Common */
#define TSN_EMMC_BUF_SIZE      64
#define TSN_EMMC_DEVNAME       "/dev/mmcblk0"
#define TSN_EMMC_SYSFS_MANFID  "/sys/block/mmcblk0/device/manfid"
#define TSN_EMMC_SYSFS_NAME    "/sys/block/mmcblk0/device/name"
...
/* TSN eMMC info structure */
typedef struct tsn_emmc_info {
    char manf_name[32];
    char prod_name[32];
} tsn_emmc_info_t;
