/* $Id: tsn_rbcp_main.c,v 1.3 2018/06/01 08:16:10 letsai Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tsn/tsn_rbcp_main.c,v $
 *------------------------------------------------------------------
 * Filename: tsn_rbcp_main.c
 *
...
int tsn_rbcp_pwroff_intel(void);
int tsn_rbcp_pwron_intel(void);
int tsn_rbcp_registration_test(int);  /* also called by interface test */
void clear_tsn_regis_done_flag(int);
int tsn_rbcp_memory_test(int);
int tsn_rbcp_ecc_test(int);
int tsn_rbcp_etsec1_rmii_lpbk_test(int);
int tsn_rbcp_etsec3_rmii_lpbk_test(int);
int tsn_rbcp_ucc1_rmii_lpbk_test (int);
int tsn_rbcp_ucc5_rmii_lpbk_test(int);
int tsn_rbcp_ucc3_utopia_lpbk_test(int);
int tsn_rbcp_spi_flash_test(int);
int tsn_rbcp_margin_high (int);
int tsn_rbcp_margin_low (int);
int terminate_rbcp_test(void);
int tsn_rbcp_recv_msgs(char *, ushort, int *);
int tsn_rbcp_led_test(int);
...
extern int tsn_test_slot;
extern ushort tsn_board_id;
 ...
 *  Global Variable
 ************************************************************************/
static int regis_done_flag[MAX_NUM_TSN_SLOTS]={FALSE};
...
int tsn_rbcp_recv_msgs (char *buf, ushort opcode, int *len)
{
    struct cisco_scp_hdr *hdr;
    int ix=0;
    int msg_size;

    for (ix = 0; ix < TSN_RBCP_PKT_RECV_TIMEOUT; ix++) {
        msg_size=0;
        /* See if we get any message */
        printf("\n%s(): Wait loop# %d\n",__FUNCTION__, ix);
        if (tsn_rbcp_recv((uchar *)buf, &msg_size) == PASSED) {
...
int tsn_rbcp_send_msgs (char *buf, int id_flag, uchar req_resp, 
                             ushort opcode, int len)
{
    ...
    return (tsn_rbcp_send((uint8_t *)buf, total_size));
}

/*
 **********************************************************************
 *
 *  Function: tsn_build_command_packet
 *
 ...
 **********************************************************************
 */
void tsn_build_command_packet (uint16_t select_test, uint32_t param1, 
...
int tsn_rbcp_register (void)
{
    ...
    if (tsn_rbcp_send_msgs(buf, FALSE, RBCP_FLAG_REQ,CISCO_SCP_OP_REQ_REG,
                             pkt_len) == FAILED) {
    ...
    if ((rc = tsn_rbcp_recv_msgs(buf, CISCO_SCP_OP_REG, &pkt_len))) {
        cterr('f', 0, "RBCP Register Test Failed");
        return (FAILED);
    }

    if (rc) {
        printf("\nDid not receive any Register opcode from BMC\n");
        return(FAILED);
    }
    ...
    /* Send RBCP message */
    if (tsn_rbcp_send_msgs(buf, TRUE, RBCP_FLAG_RESP, CISCO_SCP_OP_REG, 
                             pkt_len) == FAILED) {
        return (FAILED);
    }
...
/**********************************************************************
 *
 * Function: tsn_rbcp_registration_test
 *
 ...
 **********************************************************************
 */
int tsn_rbcp_registration_test (int menu_option)
{
    ...
    if (menu_option==TRUE) {
        regis_done_flag[tsn_test_slot] = FALSE;
    }

    if (!regis_done_flag[tsn_test_slot]) {
#ifdef ENHANCED_ERR_MSG_EXAMPLE
        /*
         ...
         memcpy(ngwic_get_pid,(char*)&tsn_board_id,2); 
    ...
    regis_done_flag[tsn_test_slot] = TRUE;
    return (PASSED);
}

/**********************************************************************
 *
 * Function: tsn_rbcp_test
 *
 * Description: This function provides RBCP testing.
 *
...
int tsn_rbcp_test (int opcode)
{
    ...
    tsn_rbcp_registration_test(FALSE);
    ...
    pkt_len = msglen + LLC_LEN_802 + SNAP_LEN_802 + TSN_RBCP_PKT_PADDING;
    ...
    /* Send message */
    if (tsn_rbcp_send_msgs(buf, TRUE, RBCP_FLAG_REQ, opcode,
                             pkt_len) == FAILED) {
        return (FAILED);
    }
    ...
    if ((rc = tsn_rbcp_recv_msgs(buf, opcode, &pkt_len))) {
    ...
    if (test_result == FAILED) {
        ...
        cterr('f', 0, "Gshdsl RBCP Test Failed");
        return (FAILED);
    }
 ...
 **********************************************************************
 */
int tsn_rbcp_ecc_test (int menu_option)
{
    testname(" ECC Memory");
    prpass(testpass,"RBCP"); 

    if (tsn_rbcp_test(CISCO_SCP_NIM_ECC_TEST) == FAILED) {
 ...
 **********************************************************************
 */
int tsn_rbcp_memory_test (int menu_option)
{
    testname(" Memory");
    prpass(testpass,"RBCP"); 

    if (tsn_rbcp_test(CISCO_SCP_NIM_DRAM_TEST) == FAILED) {
...
/**********************************************************************
 *
 * Function: tsn_rbcp_spi_flash_test
 *
 ...
 **********************************************************************
 */
int tsn_rbcp_spi_flash_test (int menu_option)
{
    testname(" SPI FLASH");
    prpass(testpass,"RBCP"); 

    if (tsn_rbcp_test(CISCO_SCP_NIM_SPI_FLASH_TEST) == FAILED) {
...
/**********************************************************************
 *
 * Function: tsn_rbcp_spi_flash_protect
 *
 * Description: This function provides RBCP SPI Flash testing.
 *
 * Input :  menu_option - 0 : indicates its a test
 ...
 **********************************************************************
 */
int tsn_rbcp_spi_flash_protect (int menu_option)
{
    testname(" Check FLASH Protection");
    prpass(testpass,"RBCP"); 

    if (tsn_rbcp_test(CISCO_SCP_NIM_SPI_FLASH_PROTECT) == FAILED) {
...
/**********************************************************************
 *
 * Function: tsn_rbcp_etsec1_rmii_lpbk_test
 *
 ...
 **********************************************************************
 */
int tsn_rbcp_etsec1_rmii_lpbk_test (int menu_option)
{
    testname(" ETSEC1 RMII Loopback");
    prpass(testpass,"RBCP"); 

    if (tsn_rbcp_test(CISCO_SCP_NIM_ETSEC1_TEST) == FAILED) {
...
/**********************************************************************
 *
 * Function: tsn_rbcp_etsec3_rmii_lpbk_test
 *
 ...
 **********************************************************************
 */
int tsn_rbcp_etsec3_rmii_lpbk_test (int menu_option)
{
    testname(" ETSEC3 RMII loopback");
    prpass(testpass, "RBCP"); 

    if (tsn_rbcp_test(CISCO_SCP_NIM_ETSEC3_TEST) == FAILED) {
...
/**********************************************************************
 *
 * Function: tsn_rbcp_ucc1_rmii_lpbk_test
 *
 ...
 **********************************************************************
 */
int tsn_rbcp_ucc1_rmii_lpbk_test (int menu_option)
{
    testname(" UCC1 RMII Loopback");
    prpass(testpass, "RBCP"); 

    if (tsn_rbcp_test(CISCO_SCP_NIM_UCC1_TEST) == FAILED) {
...
/**********************************************************************
 *
 * Function: tsn_rbcp_ucc5_rmii_lpbk_test
 *
 ...
 **********************************************************************
 */
int tsn_rbcp_ucc5_rmii_lpbk_test (int menu_option)
{
    testname(" UCC5 RMII Loopback");
    prpass(testpass, "RBCP"); 

    if (tsn_rbcp_test(CISCO_SCP_NIM_UCC5_TEST) == FAILED) {
...
/**********************************************************************
 *
 * Function: tsn_rbcp_ucc3_utopia_lpbk_test
 *
 ...
 **********************************************************************
 */
int tsn_rbcp_ucc3_utopia_lpbk_test (int menu_option)
{
    testname(" UCC3 UTOPIA Loopback");
    prpass(testpass, "RBCP"); 

    if (tsn_rbcp_test(CISCO_SCP_NIM_UCC3_TEST) == FAILED) {
 ...
 **********************************************************************
 */
int tsn_rbcp_led_test (int menu_option)
{
    testname(" LED");
    prpass(testpass, "RBCP"); 

    if (tsn_rbcp_test(CISCO_SCP_NIM_LED_TEST) == FAILED) {
 ...
 **********************************************************************
 */
int tsn_rbcp_margin_high (int menu_option)
{

    if (tsn_rbcp_test(CISCO_SCP_NIM_MARGIN_HIGH) == FAILED) {
 ...
 **********************************************************************
 */
int tsn_rbcp_margin_low (int menu_option)
{

    if (tsn_rbcp_test(CISCO_SCP_NIM_MARGIN_LOW) == FAILED) {
...
/**********************************************************************
 *
 * Function: clear_tsn_regis_done_flag
 *
 ...
 **********************************************************************
 */
void clear_tsn_regis_done_flag (int slot)
{
...
int terminate_rbcp_test (void)
{
    ...
    /* Send message */
    if (tsn_rbcp_send_msgs(buf, TRUE, RBCP_FLAG_REQ, CISCO_SCP_OP_TERMINATE_RBCP,
                             pkt_len) == FAILED) {
        return (FAILED);
    }
    ...
    int on_off;
     ...
     switch (choose) {
            case GSHDSL_ATM_LED:
                ...
                if (on_off == 1) {
                      if (tsn_rbcp_test(CISCO_SCP_LED_ATM) == FAILED) {
                          printf("Gshdsl RBCP LED Test Failed");
                          return (FAILED);
                      }
                } else if (on_off == 2) {
                      if (tsn_rbcp_test(CISCO_SCP_LED_OFF) == FAILED) {
                          printf("Gshdsl RBCP LED Test Failed");
                          return (FAILED);
                      }
                } else {
            ...
            case GSHDSL_EFM_LED:
                on_off = gethex_answer("\n1.Turn EFM On\n2.Turn EFM Off\n3.Exit\n",0, 0, 3);
                if (on_off == 1) {
                      if (tsn_rbcp_test(CISCO_SCP_LED_EFM) == FAILED) {
                          printf("Gshdsl RBCP LED Test Failed");
                          return (FAILED);
                      }
                } else if (on_off ==2) {
            ...
            case GSHDSL_L0_LED:
                 on_off = gethex_answer("\n1.Turn L0 Green On\n2.Turn L0 Yellow On\n"
                                        "3.Turn L0 Off\n4.Exit\n",0, 0, 4);
                 if (on_off == 1) {
                       if (tsn_rbcp_test(CISCO_SCP_LED_L0_G) == FAILED) {
                           printf("Gshdsl RBCP LED Test Failed");
                           return (FAILED);
                       }
                 } else if (on_off == 2) {
                       if (tsn_rbcp_test(CISCO_SCP_LED_L0_Y) == FAILED) {
                           printf("Gshdsl RBCP LED Test Failed");
                           return (FAILED);
                       }
                 } else if (on_off == 3) {
            ...
            case GSHDSL_L1_LED:
                 on_off = gethex_answer("\n1.Turn L1 Green On\n2.Turn L1 Yellow On\n"
                                        "3.Turn L1 Off\n4.Exit\n",0, 0, 4);
                 if (on_off == 1) {
                       if (tsn_rbcp_test(CISCO_SCP_LED_L1_G) == FAILED) {
                           printf("Gshdsl RBCP LED Test Failed");
                           return (FAILED);
                       }
                 } else if (on_off == 2) {
                       if (tsn_rbcp_test(CISCO_SCP_LED_L1_Y) == FAILED) {
                           printf("Gshdsl RBCP LED Test Failed");
                           return (FAILED);
                       }
                 } else if (on_off == 3) {
            ...
            case GSHDSL_L2_LED:
                 on_off = gethex_answer("\n1.Turn L2 Green On\n2.Turn L2 Yellow On\n"
                                        "3.Turn L2 Off\n4.Exit\n",0, 0, 4);
                 if (on_off == 1) {
                       if (tsn_rbcp_test(CISCO_SCP_LED_L2_G) == FAILED) {
                           printf("Gshdsl RBCP LED Test Failed");
                           return (FAILED);
                       }
                 } else if (on_off == 2) {
                       if (tsn_rbcp_test(CISCO_SCP_LED_L2_Y) == FAILED) {
                           printf("Gshdsl RBCP LED Test Failed");
                           return (FAILED);
                       }
                 } else if (on_off == 3) {
            ...
            case GSHDSL_L3_LED:
                 on_off = gethex_answer("\n1.Turn L3 Green On\n2.Turn L3 Yellow On\n"
                                        "3.Turn L3 Off\n4.Exit\n",0, 0, 4);
                 if (on_off == 1) {
                       if (tsn_rbcp_test(CISCO_SCP_LED_L3_G) == FAILED) {
                           printf("Gshdsl RBCP LED Test Failed");
                           return (FAILED);
                       }
                 } else if (on_off == 2) {
                       if (tsn_rbcp_test(CISCO_SCP_LED_L3_Y) == FAILED) {
                           printf("Gshdsl RBCP LED Test Failed");
                           return (FAILED);
                       }
                 } else if (on_off == 3) {
