/* $Id: dsl_tests.h,v 1.6 2018/11/16 09:46:10 steja Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tsn/dsl_tests.h,v $ 
 *------------------------------------------------------------------
 * 
 * dsl_tests.h 
 *
...
#define TSN_IOS_HOST_FIRMWARE_FOLDER_STRING "firmware/"
#define TSN_IOS_VADSL_FIRMWARE_STRING "c1100_vadsl_fw.img"
#define TSN_IOS_GFAST_FIRMWARE_STRING "c1100_gfast_fw.img"
...
#define TSN_DSL_PRESS_KEY_STRING        "Press any key"
#define TSN_DSL_BOARD_ID                "Board Id"
#define TSN_DSL_BOARD_IP_STRING         "Board IP address"
#define TSN_DSL_HOST_IP_STRING          "Host IP address"
#define TSN_DSL_GATEWAY_IP_STRING       "Gateway IP address"
#define TSN_DSL_IMG_RUN_STRING          "Run from flash/host/tftp (f/h/c)"
#define TSN_DSL_BOARD_ID_NUM            "2"
#define TSN_DSL_MAC_NUM                 "10"
#define TSN_DSL_MAC_ADDR                "00:10:18:00:00:00"
#define TSN_DSL_PSI_SIZ                 "128"  /* Refer to CSCvn01520 */
#define TSN_DSL_RESET_STRING            "reset"
#define TSN_DSL_CFE_STRING              "CFE>"
#define TSN_DSL_CHANGE_CFE_PARMS_STRING "c"
#define TSN_DSL_RUN_IMAGE_LOCATION      "c"
#define TSN_DSL_RUN_IMAGE_LOCATION_H    "h"
...
#define CLEAR_PARAM                     " "
#define TSN_DSL_PRINT_CFE_PARMS_STRING  "p"
#define TSN_DSL_IMG_RUN_FROM_HOST_STR   "h"
#define TSN_DSL_COMMAND_STATUS_STRING   "command status"
//leslie - tftpd server default will use directory /var/lib/tftpboot
//#define TSN_HOST_FIRMWARE_FOLDER_STRING "/firmware/"
#define TSN_HOST_FIRMWARE_FOLDER_STRING "/var/lib/tftpboot/"
#define TSN_DSL_CR_STRING               "\r"
#define TSN_DSL_LINUX_PROMPT            ">"
#define TSN_DSL_IFCONFIG_BR0_STRING     "ifconfig br0 "
#define TSN_DSL_SHELL_STRING            "sh"
#define TSN_DSL_LINUX_PROMPT_RETRY      (10)
#define TSN_DSL_MAX_LENGTH              (128)
...
/*-------------------------------------------------
$Log: dsl_tests.h,v $
Revision 1.6  2018/11/16 09:46:10  steja
Refer to CSCvn01520 for Gfast PSI size default valut is 128
