/* $Id: plug_host_fpga_prog.h,v 1.2 2018/11/23 08:49:53 hondwang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tsn/plug_host_fpga_prog.h,v $
 *------------------------------------------------------------------
 *
 * Filename: plug_host_fpga_prog.h 
 * Description: Header file for plug host functions for program fpga
 * 
