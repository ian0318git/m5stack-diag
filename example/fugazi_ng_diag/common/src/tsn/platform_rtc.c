/* $Id: platform_rtc.c,v 1.2 2017/08/02 14:21:49 steja Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tsn/platform_rtc.c,v $
 *------------------------------------------------------------------
 * platform_rtc.c - TSN RTC main function/menu.
 *
 *
...
*
* Revision 1.1.4.4  2016/11/09 06:49:44  petteng
...
*
* Revision 1.1.2.4  2016/06/17 12:30:20  steja
* Add prpass
*
* Revision 1.1.2.3  2016/05/06 16:10:18  steja
* Bring up I2C-2 for RTC
*
* Revision 1.1.2.2  2016/04/29 10:07:20  steja
* skip RTC and eMMC test
*
* Revision 1.1.2.1  2016/03/20 14:06:28  steja
