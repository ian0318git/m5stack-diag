/* $Id: vg400_virtual_nim.h,v 1.3 2018/12/21 00:57:19 haohsu Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/vg400/vg400_virtual_nim.h,v $
 *******************************************************************************
 * vg400_virtual_nim.h : Vg400 defines
 *
 * Sep 2017 - Sam Hsu
 *
...
#define BUF_WAIT_TIME         1000
#define ETH_PORT0             0
#define ETH_PORT1             1
#define SYS_getcpu            309
#define TFTP_IMG_NAME         "oakenshield_dsp_diag.img"
#define IMG_PATH              "/firmware/sm_dsp_sp2700_fw.img"
#define PWR_WAIT_TIME         50
#define VG400_OFF_TIME        1000
...
#define FPGA_SIZE             1000
#define DSP_BOOT_TIME         300
#define DSP_TIME_OUT          299

/****************
$Log: vg400_virtual_nim.h,v $
Revision 1.3  2018/12/21 00:57:19  haohsu
...
Revision 1.1.2.2  2018/04/13 03:16:20  haohsu
Check calibration value in SPI ROM after doing calibratio utilityn

Revision 1.1.2.1  2018/02/24 07:40:14  haohsu
*** empty log message ***
...
Revision 1.3  2017/09/29 03:04:55  harrchan
