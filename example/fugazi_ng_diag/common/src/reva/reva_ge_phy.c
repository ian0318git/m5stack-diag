/* $Id: reva_ge_phy.c,v 1.3 2016/05/09 05:51:57 umlin Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/reva/reva_ge_phy.c,v $
 *------------------------------------------------------------------
 *
 * reva_ge_mac.c - Reva GE PHY function.
 *
...
static const reg_info_t marvell_88e1512_reg_page0[] = {   /* Page 0 */
    ...
    {"PHY ID2",             0x03, READ_ONLY,  {2}, 0x0000, 0x0dd1},
...
/*******************************************************************************
 * Function: dev_phy_read_reg
 *
 * Description: Read dev PHY registers
 *
 * Inputs: page    - page of address registers
           offset  - offset of address registers
           data    - data of registers
 ...
 *
 * Description: Read the Phy ID registers to check with the desired value.
 *
 * Input: None
 * Output: PASSED/FAILED
 *******************************************************************************/
int phy_id_check()
{
    ...
    if (data != marvell_88e1512_reg_page0[MRV88E1512_PHY_ID1].reset_val ) {
        buf_p += sprintf(buf_p, "%s(): phy id1 check failed, Expected %#x, Read %#x\n",
                                 __FUNCTION__, marvell_88e1512_reg_page0[MRV88E1512_PHY_ID1].reset_val,
                                 data);
        return (FAILED);
    }
    ...
    if (data != marvell_88e1512_reg_page0[MRV88E1512_PHY_ID2].reset_val) {
        buf_p += sprintf(buf_p, "%s(): phy id2 check failed, Expected %#x, Read %#x\n",
                                 __FUNCTION__, marvell_88e1512_reg_page0[MRV88E1512_PHY_ID2].reset_val,
                                 data);
        return (FAILED);
    }
    return (PASSED);
...
/*******************************************************************************
 * Function: phy_reg_test_all_pages
 *
 * Description: Test all of PHY registers pages
 *
 * Input: None
 * Output: PASSED/FAILED
 *******************************************************************************/
 ...
 *
 * Description: Test PHY registers 
 *
 * Input: None
 * Output: PASSED/FAILED
 *******************************************************************************/
 ...
 *
 * Description: This function reports error or warning depends on the error ID flag
 *
 ...
 *
 * Description: This function resets the phy and waits for its completion before returning
 *
 ...
 *
 * Description: Test PHY interrupt
 *
 * Input: None
 * Output: PASSED/FAILED
 *******************************************************************************/
...
*/
    ...
    if(get_gic_spi_status1() == 0) {
        perror("Cannot Force MRV88E1512 INTR.");
        return (FAILED);
    } else {
        prpass(testpass, "Force interrupt");
        data &= ~(MRV88E1512_FIBER_FORCE_INT);
        retval = dev_phy_write_reg(MRV88E1512_REG_PAGE_1,
                          MRV88E1512_SPECIFIC_CONTROL2_REG, &data);
        if (retval != PASSED) {
 ...
 *
 * Description: This function set PHY loopback mode and speed.
 *
 * Input: phy_addr  - PHY address
 *        speed     - 10/100/1G
 *        lpbk      - loopback mode
...
{
    int retval = PASSED;
    int phy_speed = -1, mac_speed = -1, polling = 0;
    ushort data;
    ...
    do {
        ...
        if (!(data & MRV88E1512_LINK_UP)) {
            if ((NVRAM)->diagflag & D_VERBOSE) {
                printf("%s(): Copper is NOT link up. Retry...\n", __FUNCTION__);
            }
        }
        polling++;
    } while(polling < 10);
 ...
 *
 * Description: This function disable loopbacks and sets Marvell GE PHY
 ...
 *
 * Description: This function initialize the PHY.
 *
 * Input: phy_addr - PHY address
 * Output: PASSED/FAILED
 *******************************************************************************/
...
/*******************************************************************************
 * Function: phy_int_lpbk_test_raw_skt
 *
 * Description: Test PHY internal loopback
 *
 * Input: None
 * Output: PASSED/FAILED
 *******************************************************************************/
...
/*******************************************************************************
 * Function: phy_ext_lpbk_test
 *
 * Description: Test PHY external loopback
 *
 * Input: None
 * Output: PASSED/FAILED
 *******************************************************************************/
...
/*******************************************************************************
 * Function: phy_ext_lpbk_test_raw_skt
 *
 * Description: Test PHY external loopback
 *
 * Input: None
 ...
 * Function: phy_reg_rd
 *
 * Description: Read PHY registers
 *
 * Input: None
 * Output: PASSED/FAILED
 *******************************************************************************/
 ...
 * Function: phy_reg_wr
 *
 * Description: Write PHY registers
 *
 * Input: None
 * Output: PASSED/FAILED
 *******************************************************************************/
 ...
 * Function: phy_reg_dp
 *
 * Description: Dump PHY registers
 *
 * Input: None
 * Output: PASSED/FAILED
 *******************************************************************************/
