/* $Id: reva_ge_dma.c,v 1.3 2016/05/09 05:51:57 umlin Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/reva/reva_ge_dma.c,v $
 *------------------------------------------------------------------
 *
 * reva_ge_dma.c - Reva GE DMA function.
 *
...
/*********************************************************************
 * Function: ge_dma_reg_rd
 *
 * Description: Read GE DMA registers
 *
 * Inputs: None
...
/*********************************************************************
 * Function: ge_dma_reg_wr
 *
 * Description: Write GE DMA registers
 *
 * Inputs: None
 * Outputs: PASSED/FAILED
 *********************************************************************/
...
/*********************************************************************
 * Function: ge_dma_reg_dp
 *
 * Description: Dump GE DMA registers
 *
 * Inputs: None
 * Outputs: PASSED
 *********************************************************************/
...
/*********************************************************************
 * Function: ge_dma_reg_test
 *
 * Description: Test GE DMA regsters
 *
 * Inputs: None
 * Outputs: PASSED/FAILED
 *********************************************************************/
...
/*********************************************************************
 * Function: ge_tx_intr_test_one
 *
 * Description: Test GE DMA tx interrupt 
 *
 * Input: tx_dring - Number of TX dring 
 * Outputs: PASSED/FAILED
 *********************************************************************/
...
/*********************************************************************
 * Function: ge_rx_intr_test
 *
 * Description: Test GE DMA rx interrupt
 *
 * Inputs: None
 * Outputs: PASSED/FAILED
 *********************************************************************/
...
/*********************************************************************
 * Function: ge_dma_intr_test
 *
 * Description: Test GE DMA interrupt
 *
 * Inputs: None
 * Outputs: PASSED/FAILED
 *********************************************************************/
...
/*********************************************************************
 * Function: ge_dma_buf_alloc
 *
 * Description: The DMA memory is allocated by kernel driver,
   so we assign the physical & virtual memory address here. 
 *
 * Inputs: dev_dma_p - Pointer of FPGA DMA registers 
 * Outputs: PASSED
 *********************************************************************/
...
/*********************************************************************
 * Function: ge_dma_setup_rxbd
 *
 * Description: Setup GE DMA Receive buffer descriptors
 *
 * Inputs: dev_dma_p - Pointer of FPGA DMA registers
 * Outputs: PASSED
 *********************************************************************/
...
/*********************************************************************
 * Function: ge_dma_read
 *
 * Description: Read GE DMA registers
 *
 * Inputs: dev_dma_p     - Pointer of FPGA DMA registers
           rx_buf_virt   - Virtual address for receive buffer
...
/*********************************************************************
 * Function: get_tx_qhead
 *
 * Description: Get transmit queue head
 *
 * Inputs: txbd_index - Index of transmit buffer descriptor
 * Outputs: bits value of tx dring
 *********************************************************************/
...
/*********************************************************************
 * Function: get_tx_qtail
 *
 * Description: Get transmit queue tail
 *
 * Inputs: txbd_index - Index of transmit buffer descriptor
 * Outputs: bits value of tx dring
 *********************************************************************/
...
/*********************************************************************
 * Function: set_tx_qtail
 *
 * Description: Set transmit queue tail
 *
 * Inputs: txbd_index   - Index of transmit buffer descriptor
           value        - Value of tx index
 * Outputs: None
 *********************************************************************/
...
/*********************************************************************
 * Function: ge_dma_write
 *
 * Description: Write GE DMA
 *
 * Inputs: dev_dma_p   - Pointer of FPGA DMA registers
           txbd_index  - Index of transmit buffer descriptor
           data        - Data
 * Outputs: PASSED/FAILED
 *********************************************************************/
...
/*********************************************************************
 * Function: ge_dma_init
 *
 * Description: initialize GE DMA 
 *
 * Inputs: dev_dma_p - Pointer of FPGA DMA registers
 * Outputs: PASSED/FAILED
 *********************************************************************/
 ...
 *
 * Description: This function implements GMII test.
 *
 ...
 *
 * Description: This function implements prince packet loopback test. 
 *
 * Input: None
 * Output: PASSED/FAILED
 *********************************************************************/
