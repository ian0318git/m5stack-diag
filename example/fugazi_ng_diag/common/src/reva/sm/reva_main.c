/* $Id: reva_main.c,v 1.2 2017/03/16 05:20:24 umlin Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/reva/sm/reva_main.c,v $
 *------------------------------------------------------------------
 *
 * reva_main.c - Reva-SM main entry.
 *
...
int get_virt_base_addr()
{
    ...
    /* Memory map for SCC */
    /* ZYNC_SCC_CSR_LENGTH = 0x10000, Reva-SM has 16 blocks CSR, it needs 0x68000. */
    scc_base_ptr = (void *)mmap(NULL, (ZYNC_SCC_CSR_LENGTH * 7), (PROT_READ | PROT_WRITE), 
...
/******** History ********
$Log: reva_main.c,v $
Revision 1.2  2017/03/16 05:20:24  umlin
