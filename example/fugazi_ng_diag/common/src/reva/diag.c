/* $Id: diag.c,v 1.4 2018/07/23 06:45:00 easochen Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/reva/diag.c,v $
 *------------------------------------------------------------------
 *
 * diag.c - Reva diagmon main menu and supporting wrappers.
 *
 *
...
int fpga_version()
{
    ...
    case BOARD_ID_NIM_16A:
        sprintf(board_type, "NIM-16A-2G");
        sprintf(as_pid, "NIM-16A-2G");
        break;
    case BOARD_ID_NIM_24A:
        sprintf(board_type, "NIM-24A-2G");
        sprintf(as_pid, "NIM-24A-2G");
        break;
    case BOARD_ID_NIM_16A_4G:
        sprintf(board_type, "NIM-16A-4G");
        sprintf(as_pid, "NIM-16A-4G");
        break;
    case BOARD_ID_NIM_24A_4G:
        sprintf(board_type, "NIM-24A-4G");
        sprintf(as_pid, "NIM-24A-4G");
        break;
    default:
...
/******** History ******** 
$Log: diag.c,v $
Revision 1.4  2018/07/23 06:45:00  easochen
