 /* $Id: diag_fpga_i2c_lib.c,v 1.3 2019/12/30 05:59:18 kehuang2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tabei-l/diag_fpga_i2c_lib.c,v $
 *------------------------------------------------------------------
 *
 ...
 */
void gfy_i2c_reset (fpga_i2c_t *i2c)
{
    int ctr = 0;
 ...
 *
 */
boolean gfy_chk_i2c_idle(fpga_i2c_t *i2c)
{
...
static int gfy_i2c_send_reg_offset (fpga_i2c_t *i2c, uint32_t mux, uint32_t slv_addr,
 ...
 *
 */
static int gfy_i2c_normal_op (fpga_i2c_t *i2c, uint8_t mux,
...
*
 */
void gfy_rd_i2c_data_fifo(fpga_i2c_t *i2c, uint32_t data_len,
                     uchar *data_p)
{   
 ...
 *******************************************************************************
 */
void *platform_get_wic_oir (int slot)
{   
    if (slot == 0) {
        assert(!"slot is 0");
    }
...
Revision 1.1.2.6  2019/08/07 11:54:20  olin2
Clean up code

Revision 1.1.2.5  2018/10/17 09:29:48  olin2
Support FPGA I2C write

Revision 1.1.2.4  2018/10/17 06:14:28  olin2
