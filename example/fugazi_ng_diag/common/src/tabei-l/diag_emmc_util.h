 /* $Id: diag_emmc_util.h,v 1.3 2020/08/17 07:21:28 kehuang2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tabei-l/diag_emmc_util.h,v $
 *------------------------------------------------------------------
 *
...
#define ENH_SIZE_MULT_MASK         0xff
...
/* eMMC info structure */
typedef struct tabei_emmc_info {
    char manf_name[32];
    char prod_name[32];
} emmc_info_t;
...
#endif   /* __DIAG_EMMC_UTIL_H__ */

/*------------------------------------------------------------------
$Log: diag_emmc_util.h,v $
Revision 1.3  2020/08/17 07:21:28  kehuang2
CSCvv34796: Support WD eMMC

Revision 1.2  2019/10/17 02:16:20  kehuang2
Collapse Tabei-L into main trunk

Revision 1.1.2.3  2018/12/13 02:49:43  olin2
