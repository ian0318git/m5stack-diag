/* $Id: ngio.c,v 1.3 2020/01/09 01:02:42 jiajliu Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tabei-l/ngio.c,v $
 *------------------------------------------------------------------
...
ngiowic_disable (void *p)
{
    ...
    /* Tabei has NIM1 only */
    bus = TABEI_NIM1_PCIE_UPPORT_BUS;
    dev = TABEI_NIM1_PCIE_UPPORT_DEV;
    func = TABEI_NIM1_PCIE_UPPORT_FUNC;
    offset = TABEI_NIM1_PCIE_UPPORT_2ND_BUS_OFF;
    reg = pci_config_read(bus, dev, func, offset);
    /* step 1 - remove device */
    /* echo 1 > /sys/devices/pci0000:00/0000:00:0e.0/0000:12:00.0/remove */
    sprintf(file_rmv, "%s0000:%02x:00.0/remove",
            TABEI_NIM1_PCIE_UPPORT_PATH, reg);
    ...
    offset = TABEI_NIM1_PCIE_UPPORT_2ND_RESETOFF;
...
get_ngio_pcie_dev_bus_num (uint mod_type, uint slot)
{
    ...
    /* Tabei-L
     * 04:00.0 Ethernet controller: Marvel Technology Group Ltd.
     * Device e61e (rev 03 )
     */
    ...
    if (is_tabeil() == TRUE) {
        ...
        printf("Warning!!!, Don't support on this Platform\n");
    }
...
Revision 1.1.2.11  2019/07/31 08:00:48  olin2
Clean up code

Revision 1.1.2.10  2019/07/23 11:00:39  olin2
Update pcie number for Promethium platform

Revision 1.1.2.9  2019/07/16 09:33:36  olin2
Support Promethium platform

Revision 1.1.2.8  2019/05/16 03:03:35  olin2
Remove debug message

Revision 1.1.2.7  2019/03/26 06:09:16  olin2
...
Revision 1.1.2.4  2018/11/02 07:44:20  olin2
Update PCIE setting
