/* $Id: diag_spi_flash_util.h,v 1.2 2019/10/17 02:16:23 kehuang2 Exp $
 *------------------------------------------------------------------
...
#define TABEI_DENVERTON_SPI_CTRL_MM_ADDR  0xFE010000
...
extern int tabei_spi_flash_utils (int);
extern int tabei_spi_flash_get_rdsr (int, uchar *); 
extern int tabei_spi_flash_get_prod_id (int, uint*);
