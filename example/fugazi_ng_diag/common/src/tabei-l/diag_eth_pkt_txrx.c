 /* $Id: diag_eth_pkt_txrx.c,v 1.3 2019/11/25 08:55:51 kehuang2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tabei-l/diag_eth_pkt_txrx.c,v $
 *-----------------------------------------------------------------------------
...
int get_host_mac_addr (uint port, unsigned char *mac_buf)
{
    ...
    system_mac_addr_get(TABEI_ETH_BP, &local_mac_addr[0]);

    memcpy(mac_buf, &local_mac_addr[0], sizeof(mac_addr_t));
...
Revision 1.1.2.4  2019/03/13 09:05:58  olin2
Support legacy function for do loopback

Revision 1.1.2.3  2019/03/07 06:38:09  olin2
Support Arkentone on Tabei-L

Revision 1.1.2.2  2018/12/24 08:04:43  olin2
