 /* $Id: diag_boot_flash_test.c,v 1.3 2020/08/06 07:54:55 kehuang2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tabei-l/diag_boot_flash_test.c,v $
 *------------------------------------------------------------------
 *
...
int diag_boot_flash_test (int select)
{
    ...
    uint reg_addr, sector_offset;
    uint32_t  reg_bk;
    uint wr_data;
    char src[32];

    if (is_tabeil() == TRUE) {
        sector_offset = TABEI_SECTOR_OFFSET;
    } else {
        sector_offset = PMTM_SECTOR_OFFSET;
    }
...
Revision 1.1.4.5  2019/08/27 07:45:04  kehuang2
Clean up code

Revision 1.1.4.4  2019/04/25 01:57:50  olin2
Support bootflash 1 test

Revision 1.1.4.3  2018/11/16 05:42:09  olin2
Clean up code
