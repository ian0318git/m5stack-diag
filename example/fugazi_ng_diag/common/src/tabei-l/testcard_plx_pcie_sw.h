/* $Id: testcard_plx_pcie_sw.h,v 1.2 2019/10/17 02:16:28 kehuang2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tabei-l/testcard_plx_pcie_sw.h,v $
 *------------------------------------------------------------------
 *
