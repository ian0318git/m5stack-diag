 /* $Id: diag_temp_snsr_test.c,v 1.2 2019/10/17 02:16:23 kehuang2 Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/tabei-l/diag_temp_snsr_test.c,v $
 *------------------------------------------------------------------
...
static char ts_name_tabeil[4][16] =
{
    "Inlet (0x90)",
    "Outlet (0x94)",
    "Inlet (0x92)",
...
static char ts_name_fortnite[2][16] =
{
    "Outlet (0x90)",
    "Inlet (0x94)",
};
...
submenu_xtable_t diag_ts_submenu_table[] = {
    ...
    {"Register register test", (PFT)register_test_all, 0, 
     MF_CONTINUOUS | MF_DOGRP | MF_DOALL,
...
static uint32 show_temperature (int ts_id)
{
    ...
    if (is_fortnite() == TRUE) {
        memcpy(ts_name, ts_name_fortnite, sizeof(ts_name_fortnite));
    } else {
        memcpy(ts_name, ts_name_tabeil, sizeof(ts_name_tabeil));
    }
...
static uint32 show_ts_reg(void)
{
    ...
    if (is_fortnite() == TRUE) {
        ts_id = gethex_answer("Enter the thermal sensor number:\n"
                "(0.Outlet(0x90), 1.Inlet(0x94))",
                TS_INLET_SIDE0, TS_INLET_SIDE0, TS_OUTLET_SIDE0);
    } else {
        ts_id = gethex_answer("Enter the thermal sensor number:\n"
...
Revision 1.1.4.13  2019/08/27 07:45:06  kehuang2
Clean up code

Revision 1.1.4.12  2019/05/29 12:01:20  kehuang2
Rename function by the platform name

Revision 1.1.4.11  2019/05/29 09:17:45  kehuang2
Fix Utility for thermal sensor

Revision 1.1.4.10  2019/05/29 03:16:17  kehuang2

1.Merge image according to official board type.
2.Reform the structure of diag menu

Revision 1.1.4.9  2019/05/24 09:56:11  kehuang2

1.Update Temp Interrupt test
2.Clean up code

Revision 1.1.4.8  2019/05/22 09:01:57  kehuang2
Clean up code

Revision 1.1.4.7  2019/05/16 08:48:14  kehuang2
Clean up code by the comment of code review.

Revision 1.1.4.6  2019/03/19 09:26:26  kehuang2
Merge Sku1 and Sku2 into same image

Revision 1.1.4.5  2019/01/25 07:42:24  harrchan
Add SKU1 in Makefile for seperature sku in future

Revision 1.1.4.4  2019/01/21 10:42:09  harrchan
