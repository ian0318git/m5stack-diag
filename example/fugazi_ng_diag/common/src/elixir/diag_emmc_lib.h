/* $Id: diag_emmc_lib.h,v 1.2 2021/09/24 01:21:05 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/elixir/diag_emmc_lib.h,v $
 *------------------------------------------------------------------
 *
 * diag_dimm_lib.h
 *
...
/* Common */
#define PLAT_EMMC_BUF_SIZE      64
#define PLAT_EMMC_DEVNAME       "/dev/mmcblk0"
#define PLAT_EMMC_SYSFS_MANFID  "/sys/block/mmcblk0/device/manfid"
#define PLAT_EMMC_SYSFS_NAME    "/sys/block/mmcblk0/device/name"
...
#define EMMC_WD_MANFID_STR        "45"

/* eMMC info structure */
typedef struct plat_emmc_info {
    char manf_name[32];
    char prod_name[32];
} plat_emmc_info_t;
...
/* Extern */
extern struct mmc_ioc_cmd mmc_local_cmd;
extern int ExecuteCmdbyPopen(char *, char *, int);
extern uchar get_ecsd_byte_val(uchar *, int);
extern int get_emmc_cid_info(plat_emmc_info_t *);
extern int diag_emmc_parse_and_issue_cmd(int, char *, char *);
extern int get_emmc_size(char*, int, char*);

#endif   /* __PLATFORM_EMMC_H__ */

/*-------------------------------------------------
 * $Log: diag_emmc_lib.h,v $
