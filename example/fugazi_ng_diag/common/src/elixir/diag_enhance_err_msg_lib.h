/* $Id: diag_enhance_err_msg_lib.h,v 1.2 2021/09/24 01:21:06 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/elixir/diag_enhance_err_msg_lib.h,v $
 *------------------------------------------------------------------
 * 
