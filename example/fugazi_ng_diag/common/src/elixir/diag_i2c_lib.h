/* $Id: diag_i2c_lib.h,v 1.2 2021/09/24 01:21:06 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/elixir/diag_i2c_lib.h,v $
 *------------------------------------------------------------------
 *
 * diag_i2c_lib.h
 *
...
#define PLUG_TC_I2C_ADDR_GPIO_EXP      (0x3E >> 1)   /* Pluggable PCIE Test Card GPIO Expander */
