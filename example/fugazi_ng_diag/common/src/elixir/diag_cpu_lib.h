/* $Id: diag_cpu_lib.h,v 1.2 2021/09/24 01:21:05 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/elixir/diag_cpu_lib.h,v $
 *------------------------------------------------------------------
 * 
 * diag_cpu_lib.h
 *
...
#define CP_GPIO_DATA_OUT_REG(n)      (0xF2440100 + (0x40 * n))
 ...
 *
 * Revision 1.1.2.2  2020/11/12 08:56:54  harrchan
