/* $Id: diag_moka_fpga_test.c,v 1.2 2021/09/24 01:21:06 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/elixir/diag_moka_fpga_test.c,v $
 *------------------------------------------------------------------
 * 
...
static reg_info_t fpga_reg_test_tbl[] = {
    ...
    {"Force External Interrupt Mask",      FPGA_EXT_INTR_MASK_REG,   FPGA_RW,
     {(unsigned long)&plat_fpga_reg_ext},   0x000FF8EE,               0x0},
    {"END",                                0x00,                     0,
     {0},                                  0x0,                      0x0},
};
...
int diag_fpga_f_intr_test (int opt)
{
    ...
    if ((gpio_dout_en & MOKA_INTR_BIT8) != 1) {
        gpio_dout_en |= MOKA_INTR_BIT8;
    ...
    if ((gpio_din_polar & MOKA_INTR_BIT8) != 1) {
        gpio_din_polar |= MOKA_INTR_BIT8;
 ...
 *
 * Revision 1.1.2.4  2021/08/18 10:54:20  illiu
 * Use macro according to PRRQ
 *
 * Revision 1.1.2.3  2021/07/01 02:36:27  harrchan
