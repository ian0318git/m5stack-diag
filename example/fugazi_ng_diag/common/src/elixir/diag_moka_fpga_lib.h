/* $Id: diag_moka_fpga_lib.h,v 1.2 2021/09/24 01:21:06 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/elixir/diag_moka_fpga_lib.h,v $
 *------------------------------------------------------------------
 * 
...
#define PENDING_BIT_GE1           1<<5 /* 0:no pending, 1:pending */
#define PENDING_BIT_ESW           1<<6 /* 0:pending, 1:no pending */
#define PENDING_BIT_GE0           1<<7 /* 0:no pending, 1:pending */
...
#define SFP0_SC_MODULE_DEF          (1 << 5)
#define SFP0_SC_TX_DIS              (1 << 4)
#define SFP1_SC_MODULE_DEF          (1 << 1)
#define SFP1_SC_TX_DIS              (1 << 0)
...
#define SFP_MUX_SEL                 (1 << 3)
#define SFP_I2C_ENABLE_             (1 << 2)
...
extern int            sfp_tx_enable_switch(int, int);
...
extern int diag_moka_fpga_get_ext_intr_pending(int);
 ...
 *
 * Revision 1.1.2.6  2021/03/15 10:19:50  illiu
 * Rename diag_check_esw_ext_intr_pending() to diag_moka_fpga_get_ext_intr_pending()
 *
 * Revision 1.1.2.5  2020/11/05 06:40:37  harrchan
 ...
 *
 * Revision 1.1.2.4  2020/09/24 09:26:51  illiu
 * Add macro for AC3/AC5 Switch test item
 *
