...
void jbi_ltoa(char *buffer, int number)
{
    int index = 0;
    int rev_index = 0;
    char reverse[32];
...
void jbi_make_dword(unsigned char *buf, unsigned int num)
{
...
unsigned int jbi_get_dword(unsigned char *buf)
{
    return
        (((unsigned int) buf[0]) |
        (((unsigned int) buf[1]) << 8L) |
        (((unsigned int) buf[2]) << 16L) |
        (((unsigned int) buf[3]) << 24L));
}
...
/****************************************************************************/
{
    ...
    unsigned int first_word = 0L;
    unsigned int action_table = 0L;
    unsigned int proc_table = 0L;
    unsigned int string_table = 0L;
    unsigned int symbol_table = 0L;
    unsigned int data_section = 0L;
    unsigned int code_section = 0L;
    unsigned int debug_section = 0L;
    unsigned int action_count = 0L;
    unsigned int proc_count = 0L;
    unsigned int symbol_count = 0L;
    char message_buffer[JBIC_MESSAGE_LENGTH + 1];
    SQWORD *variables = SQWORD_NULL;
    int *variable_size = NULL;
    ...
    */
    ...
    {
        variables = (SQWORD *)(QWORD *) jbi_malloc (
            (unsigned int) symbol_count * sizeof(SQWORD));

        if (variables == NULL) status = JBIC_OUT_OF_MEMORY;

        if (status == JBIC_SUCCESS)
        {
            variable_size = (int *) jbi_malloc(
                (unsigned int) symbol_count * sizeof(int));
            ...
            for (i = 0; i < (unsigned int) symbol_count; ++i)
            {
                ...
                */
                ...
                else if ((attributes[i] & 0x1e) == 0x0e)
                {
                    ...
                    int_index = data_section + value;
                    uncompressed_size =
                        (((unsigned int) GET_BYTE(int_index)) |
                        (((unsigned int) GET_BYTE(int_index + 1L)) << 8L) |
                        (((unsigned int) GET_BYTE(int_index + 2L)) << 16L) |
                        (((unsigned int) GET_BYTE(int_index + 3L)) << 24L));
                    ...
                    variables[i] = (SQWORD)((QWORD) jbi_malloc(uncompressed_size));

                    if (variables[i] == SQWORD_NULL)
                    {
                ...
                else if ((attributes[i] & 0x1e) == 0x0c)
                {
                    ...
                    if (variable_size[i] > 0)
                    {
                        ...
                        variables[i] = (SQWORD)(QWORD) jbi_malloc(size);
...
#else
                    variables[i] = SQWORD_NULL;
                    variables[i] = value + data_section + (SQWORD) program;
#endif
                }
    ...
    */
    ...
    while (!done)
    {
        ...
        case 0x02: /* SWP  */
            IF_CHECK_STACK(2)
            {
                int_temp = stack[stack_ptr - 2];
                stack[stack_ptr - 2] = stack[stack_ptr - 1];
                stack[stack_ptr - 1] = int_temp;
            }
            break;
        ...
        case 0x12: /* CMPS */
            ...
            */
            IF_CHECK_STACK(4)
            {
                ...
                {
                    int_temp &= ((-1L) >> (32 - count));

                    stack[stack_ptr - 1] =
                        ((a & int_temp) == (b & int_temp)) ? 1L : 0L;
                }
            }
            break;
        ...
        case 0x15: /* DSS  */
            ...
            */
            IF_CHECK_STACK(2)
            {
                ...
                jbi_make_dword(charbuf, int_temp);
        ...
        case 0x2D: /* BCH0  */
            ...
            */
            ...
            {
                int_temp = stack[stack_ptr - index];
        ...
        case 0x40: /* PSHL */
            stack[stack_ptr++] = (int) args[0];
            break;

        case 0x41: /* PSHV */
            stack[stack_ptr++] = (int) variables[args[0]];
            break;
        ...
        case 0x44: /* NEXT */
            ...
            */
            IF_CHECK_STACK(3)
            {
                int step = stack[stack_ptr - 1];
                int end = stack[stack_ptr - 2];
                int top = stack[stack_ptr - 3];
                int iterator = (int) (variables[args[0]]);
                int break_out = 0;
        ...
        case 0x45: /* PSTR */
            ...
            */
#if PORT==DOS
            int_index = string_table + args[0];
            index2 = jbi_strlen(message_buffer);

            do
            {
                i = GET_BYTE(int_index);
                ...
                */
                    ...
                    ((attributes[variable_id] & 0x9c) == 0x1c))
                {
                    ...
                    */
                    ...
                    sqword_temp = variables[variable_id];
                    intptr_temp = (int *) jbi_malloc(count * sizeof(int));
                    variables[variable_id] = (SQWORD)((QWORD) intptr_temp);
                    ...
                    else
                    {
                        ...
                        for (i = 0; i < count; ++i)
                        {
                            intptr_temp[i] = GET_DWORD(sqword_temp);
                            sqword_temp += 4L;
                        }
                ...
                {
                    intptr_temp = (int *) variables[variable_id];

                    /* pop the array index */
                    index = (unsigned int) stack[--stack_ptr];

                    /* pop the value and store it into the array */
                    intptr_temp[index] = stack[--stack_ptr];
                }
            }
            break;
            ...
            IF_CHECK_STACK(3)
            {
                ...
                */
                    ...
                    ((attributes[variable_id] & 0x9c) == 0x0c))
                {
                    ...
                    *    Allocate a writable buffer for this array
                    */
                    int_temp = (variable_size[variable_id] + 7L) >> 3L;
                    charptr_temp2 = (unsigned char *) variables[variable_id];
                    charptr_temp = jbi_malloc((unsigned int) int_temp);
                    variables[variable_id] = (SQWORD)((QWORD) charptr_temp);
                    ...
                    else
                    {
                        ...
                        for (int_index = 0L;
                            ...
                            ++int_index)
                        {
                            charptr_temp[int_index] = 0;
                        }

                        /* copy previous contents into buffer */
                        for (int_index = 0L;
                            int_index < variable_size[variable_id];
                            ++int_index)
                        {
#if PORT==DOS
                            if ((attributes[variable_id] & 0x02) &&
                                ((int_index & 0x0000FFFF) == 0L))
                            {
                                /* initialized compressed Boolean array */
                                jbi_uncompress_page(variable_id,
                                    (int) (int_index >> 16), version);
                                charptr_temp = jbi_aca_out_buffer;
                                int_index2 = int_index & 0xFFFF;
                            }
#else
                            int_index2 = int_index;
#endif

                            if (charptr_temp2[int_index2 >> 3] &
                                (1 << (int_index2 & 7)))
                            {
                                charptr_temp[int_index >> 3] |=
                                    (1 << (int_index & 7));
                            }
                        }
                ...
                else
                {
                    ...
                    int_count = stack[--stack_ptr];

                    /* pop the array index */
                    int_index = stack[--stack_ptr];
                    ...
                    if (version > 0)
                    {
                        ...
                        if (int_index > int_count)
                        {
                            reverse = 1;
                            int_temp = int_count;
                            int_count = 1 + int_index - int_count;
                            int_index = int_temp;
                        ...
                        {
                            int_count = 1 + int_count - int_index;
                        }
                    }
                    ...
                    {
                        for (i = 0; i < (unsigned int) int_count; ++i)
                        {
                            if (int_temp & (1L << (int) i))
                            {
                                charptr_temp[int_index >> 3L] |=
                                    (1L << (int_index & 7L));
                            }
                            else
                            {
                                charptr_temp[int_index >> 3L] &=
                                    ~ (unsigned int) (1L << (int_index & 7L));
                            }
                            ++int_index;
                        }
                    }
            ...
            IF_CHECK_STACK(2)
            {
...
#if PORT==DOS
                if (((int_index & 0xFFFF0000) == 0) &&
                    ((int_count & 0xFFFF0000) == 0))
                {
                    variable_id = (unsigned int) args[0];
                    ...
                    if (reverse)
                    {
                        ...
                        {
                            int_temp = int_index + int_count - 1;
                            int_index2 = 0;
                            while (int_index2 < int_count)
                            {
                                if (charptr_temp2[int_temp >> 3] &
                                    (1 << (int_temp & 7)))
                                {
                                    charptr_temp[int_index2 >> 3] |=
                                        (1 << (int_index2 & 7));
                                }
                                else
                                {
                    ...
                    if (opcode == 0x51)    /* DS */
                    {
                        status = jbi_do_drscan((unsigned int) int_count,
                            charptr_temp, (unsigned int) int_index);
                    }
                    else    /* IS */
                    {
                        status = jbi_do_irscan((unsigned int) int_count,
                            charptr_temp, (unsigned int) int_index);
                    }
                ...
                else if ((opcode == 0x51) && !reverse)
                {
                    status = jbi_do_drscan_multi_page(
                        ...
                        (unsigned int) int_index, version);
                }
                else
                {
                ...
                if (reverse)
                {
                    /* allocate a buffer and reverse the data order */
                    charptr_temp2 = charptr_temp;
                    charptr_temp = jbi_malloc((int_count >> 3) + 1);
                    if (charptr_temp == NULL)
                    {
                        status = JBIC_OUT_OF_MEMORY;
                        break;
...
#endif
                int_temp = stack[--stack_ptr];
                jbi_export_integer(name, int_temp);
            }
            break;
            ...
            */
            IF_CHECK_STACK(1)
            {
                ...
                if ((attributes[variable_id] & 0x1f) == 0x19)
                {
                    ...
                    intptr_temp = (int *) variables[variable_id];
                    stack[stack_ptr - 1] = (int) (intptr_temp[index]);
                }
                else if ((attributes[variable_id] & 0x1f) == 0x1c)
                {
                    /* read-only integer array */
                    sqword_temp = (SQWORD) (variables[variable_id]) + (4L * index);
                    stack[stack_ptr - 1] = GET_DWORD(sqword_temp);
                }
                else
                {
                    status = JBIC_BOUNDS_ERROR;
        ...
        case 0x5A: /* DYNA */
            ...
            */
            IF_CHECK_STACK(1)
            {
                ...
                if ((SQWORD) ((QWORD)int_temp) > variable_size[variable_id])
                {
                    variable_size[variable_id] = (SQWORD) ((QWORD)int_temp);
                    ...
                    */
                    if ((attributes[variable_id] & 0x80) &&
                        (variables[variable_id] != SQWORD_NULL))
                    {
                    ...
                    */
                    variables[variable_id] = (SQWORD)((QWORD)
                                                jbi_malloc((unsigned int) int_temp));

                    if (variables[variable_id] == SQWORD_NULL)
                    {
                        status = JBIC_OUT_OF_MEMORY;
                    }
                    else
        ...
        case 0x5C: /* EXPV */
            ...
            */
            IF_CHECK_STACK(3)
            {
                ...
                int_index = stack[--stack_ptr];    /* right index */
                int_index2 = stack[--stack_ptr];    /* left index */

                if (int_index > int_index2)
                {
                ...
                int_count = 1 + int_index2 - int_index;
                ...
                {
                    charptr_temp = &charptr_temp[int_index >> 3];
                }

                jbi_export_boolean_array(name, charptr_temp, int_count);

                /* free allocated buffer */
                if (((int_index & 7L) != 0) && (charptr_temp2 != NULL))
                {
        ...
        case 0x80: /* COPY */
            ...
            */
            IF_CHECK_STACK(3)
            {
                int copy_count = stack[--stack_ptr];
                int copy_index = stack[--stack_ptr];
                int copy_index2 = stack[--stack_ptr];
                int destleft;
                int src_count;
                int dest_count;
                int src_reverse = 0;
        ...
        case 0x83: /* ISC  */
            ...
            */
            IF_CHECK_STACK(3)
            {
                int scan_right, scan_left;
                int capture_count = 0;
                int scan_count = 0;
                int capture_index = stack[--stack_ptr];
                int scan_index = stack[--stack_ptr];
                if (version > 0)
                {
                ...
                */
                ...
                if ((version > 0) &&
                    ((int_count > capture_count) || (int_count > scan_count)))
                {
                    status = JBIC_BOUNDS_ERROR;
                }
                ...
                if (status == JBIC_SUCCESS)
                {
                    if (opcode == 0x82) /* DSC */
                    {
                        status = jbi_swap_dr((unsigned int) int_count,
                            charptr_temp, (unsigned int) scan_index,
                            charptr_temp2, (unsigned int) capture_index);
                    }
                    else /* ISC */
                    {
                        status = jbi_swap_ir((unsigned int) int_count,
                            charptr_temp, (unsigned int) scan_index,
                            charptr_temp2, (unsigned int) capture_index);
                    }
                }
        ...
        case 0x84: /* WAIT */
            ...
            */
            IF_CHECK_STACK(2)
            {
                ...
                if (int_temp != 0L)
                {
                    status = jbi_do_wait_cycles(int_temp, (unsigned int) args[0]);
                }

                int_temp = stack[--stack_ptr];

                if ((status == JBIC_SUCCESS) && (int_temp != 0L))
                {
                    status = jbi_do_wait_microseconds(int_temp, (unsigned int) args[0]);
                }
        ...
        case 0xC0: /* CMPA */
            ...
            */
            IF_CHECK_STACK(4)
            {
                ...
                unsigned int index1 = stack[--stack_ptr];
                unsigned int index2 = stack[--stack_ptr];
                unsigned int mask_index = stack[--stack_ptr];
                int_count = stack[--stack_ptr];
                ...
                if (version > 0)
                {
                    ...
                    int mask_right = stack[--stack_ptr];
                    int mask_left = stack[--stack_ptr];
                    a = 1 + index2 - index1; /* source 1 count */
                    b = 1 + int_count - mask_index; /* source 2 count */
                    a = (a < b) ? a : b;
        ...
        if (status != JBIC_SUCCESS)
        {
            ...
            *error_address = (int) (opcode_address - code_section);
        }
    }
    ...
    */
    if ((attributes != NULL) && (variables != NULL))
    {
        for (i = 0; i < (unsigned int) symbol_count; ++i)
        {
            if ((attributes[i] & 0x80) && (variables[i] != SQWORD_NULL))
            {
    ...
    if (variables != SQWORD_NULL) jbi_free(variables);
...
/****************************************************************************/
{
    ...
    unsigned int note_strings = 0L;
    unsigned int note_table = 0L;
    unsigned int note_count = 0L;
    unsigned int first_word = 0L;
    int version = 0;
    int delta = 0;
    char *key_ptr;
        ...
        if (offset == NULL)
        {
            ...
            */
            for (i = 0; (i < (int) note_count) && (status != JBIC_SUCCESS); ++i)
            {
                ...
                count = 0;
                int_index = note_strings + GET_DWORD(note_table + (8 * i));
                while ((count < 255) && !done)
                {
                    key_buffer[count] = GET_BYTE(int_index);
                ...
                if ((key != NULL) && (jbi_stricmp(key, key_ptr) == 0))
                {
                    ...
                    count = 0;
                    int_index = note_strings + GET_DWORD(note_table + (8 * i) + 4);
                    while ((count < 255) && !done)
                    {
                        value_buffer[count] = GET_BYTE(int_index);
            ...
            */
            ...
            if ((i >= 0) && (i < (int) note_count))
            {
                ...
                if (key != NULL)
                {
                    ...
                    count = 0;
                    int_index = note_strings +
                        GET_DWORD(note_table + (8 * i));

                    while ((count < length) && !done)
                    {
                        key[count] = GET_BYTE(int_index);
                ...
                if (value != NULL)
                {
                    ...
                    while ((count < length) && !done)
                    {
                        value[count] = GET_BYTE(int_index);
...
/****************************************************************************/
{
    ...
    if (crc_section >= (unsigned int) program_size)
    {
        status = JBIC_IO_ERROR;
    }
...
)
{
    ...
    unsigned int action_count = 0L;
    unsigned int proc_count = 0L;
    unsigned int act_name_id = 0L;
    unsigned int act_desc_id = 0L;
    unsigned int act_proc_id = 0L;
    unsigned int act_proc_name = 0L;
