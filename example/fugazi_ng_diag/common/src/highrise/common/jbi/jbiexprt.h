...
#define GET_DWORD(x) \
    (((((unsigned int) GET_BYTE(x)) << 24L) & 0xFF000000L) | \
    ((((unsigned int) GET_BYTE((x)+1)) << 16L) & 0x00FF0000L) | \
    ((((unsigned int) GET_BYTE((x)+2)) << 8L) & 0x0000FF00L) | \
    (((unsigned int) GET_BYTE((x)+3)) & 0x000000FFL))
