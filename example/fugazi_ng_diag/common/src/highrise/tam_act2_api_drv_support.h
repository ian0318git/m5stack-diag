/* $Id: tam_act2_api_drv_support.h,v 1.1 2020/08/19 09:49:36 markzha Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/highrise/tam_act2_api_drv_support.h,v $
 *------------------------------------------------------------------
 * 
