 /*------------------------------------------------------------------
 *
 * diag.c - Highrise diagmon main menu and supporting wrappers.
 *
 * May 2019, markzha
 *
...
extern int phy_show_phy_dev_info(const char *tag);
extern int hr_cpld_pwr_st_chk_util(void);
extern int hr_cpld_pwr_fault_clr_util(void);
...
static struct mitem utilmenuitems[] = {
    ...
    {"Power Status Check", 0, 0,
    (PFT) hr_cpld_pwr_st_chk_util, (type_t *) &zero, 0,
    (type_t(*)())0, 0},

    {"Power Fault Clear", 0, 0,
    (PFT) hr_cpld_pwr_fault_clr_util, (type_t *) &zero, 0,
    (type_t(*)())0, 0},
...
static int display_sys_info (int dummy)
{
    ...
    ERR_RET_COND(PASSED != phy_show_phy_dev_info("Phy Info"), FAILED, "Failed show phy device info.\n");
