/* $Id: highrise_cpld_lib.c,v 1.1 2020/08/19 09:49:35 markzha Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/highrise/highrise_cpld_lib.c,v $
 *******************************************************************************
...
static reg_info_t cpld_test_regs[] = {
    ...
    HR_CPLD_REG(MODEM_CTRL,         RW,     0x00000003, 0x00000000),
