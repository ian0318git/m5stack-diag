/* $Id: nvmonvars.h,v 1.2 2015/05/25 03:59:10 steja Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/skye_linux/include/nvmonvars.h,v $
 *------------------------------------------------------------------
 *
 * nvmonvars.h: Headfile for the Monitor's NVRAM structure.
 *
...
/*
 * Definition of bootstuff[], ported from mon_boot.h
 */
