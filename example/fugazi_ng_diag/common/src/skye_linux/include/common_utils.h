 /*$Id: common_utils.h,v 1.2 2015/05/25 03:59:09 steja Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/skye_linux/include/common_utils.h,v $
 *------------------------------------------------------------------
 * common_utils.h: Definitions file for common utility .
 *
...
typedef struct reg_info_t_ext_ {
    uint   size;
    int	  (*rd_ptr) (int addr, uint *buf);
    int	  (*wr_ptr) (int addr, int data);
...
/*
 * Physical DRAM definitions. (Ported from common/src/overlord/x86/pcmap.h)
 */
