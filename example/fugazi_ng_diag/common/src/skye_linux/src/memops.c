/* $Id: memops.c,v 1.2 2015/05/25 03:59:16 steja Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/skye_linux/src/memops.c,v $ 
 *------------------------------------------------------------------
 *
 * File: memops.c
 *
 ...
 * Function   : getopsize
 *
 * Description: get memory operation size.
 *
 ...
 * Function   : getaddr
 *
 * Description: get memory address
 *
 * Inputs     : argptr - argument pointer to char
 *              locptr - argument location of pointer
 *
 * Outputs    : return 0 / -1.
 *******************************************************************************
 */
 ...
 * Function: cmp_mem
 *
 * Description: memory compare wrap
 *
 * Input:
 * argc - argument count
 * argv - argument vector
 ...
 * Function: cmpbyte
 *
 * Description: memory compare of byte
 *
 * Input:
 * addr0 - argument address 0
 * addr1 - argument address 1
 ...
 * Function: cmpword
 *
 * Description: memory compare of word
 *
 * Input:
 * addr0 - argument address 0
 * addr1 - argument address 1
 ...
 * Function: cmplword
 *
 * Description: memory compare of long word
 *
 * Input:
 * addr0 - argument address 0
 * addr1 - argument address 1
 ...
 * Function: cmpdlword
 *
 * Description: memory compare of double long word
 *
 * Input:
 * addr0 - argument address 0
 * addr1 - argument address 1
...
/**********************************************************************
 *
 * Function: linux_mov_mem
 *
 * Description: memory move
 *
 * Input:
 * addr0 - argument count
 * argv  - argument vector
 *
 * Return: return value
 */
 ...
 * Function: movlword
 *
 * Description: memory move long word
 *
 * Input:
 * addr0 - argument address 0
 * addr1 - argument address 1
 ...
 * Function: movdlword
 *
 * Description: memory move double long word
 *
 * Input:
 * addr0 - argument address 0
 * addr1 - argument address 1
...
/**********************************************************************
 *
 * Function: linux_fil_mem
 *
 * Description: memory fil
 *
 * Input:
 * addrc - argument count
 * argv - argument vector
 *
 * Return: return value
 */
 ...
 * Function: filbyte
 *
 * Description: memory fill byte
 *
 * Input:
 * addr - argument memory address
 * length - argument length
 * val  - value
 *
 * Return: return value
 ...
 * Function: filword
 *
 * Description: memory fill long word
 *
 * Input:
 * addr - argument memory address
 * length - argument length
 ...
 * Function: filword
 *
 * Description: memory fill double long word
 *
 * Input:
 * addr - argument memory address
 * length - argument length
...
/**********************************************************************
*
* Function: linux_alt_mem
*
* Description: alter memory
*
* Input:
* phyaddr - physical address
...
* Function: addrtest
*
* Description:  memory address test
*
* Input:
* phyaddr - physical address
...
* Function: addrloop
*
* Description:  memory address loop test
*
* Input:
* argc - argument counter
* argv - argument vector
...
/**********************************************************************
*
* Function: memory_checksum
*
* Description:  memory check sum
*
* Input: argc, argv
*
* Return: return value
 ...
 * Initial check-in ShrinkRay SM side Diag code.
 *
 * Revision 1.1.2.2  2013/05/09 04:19:13  iachang
