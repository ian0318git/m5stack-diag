/* $Id: linux_error.c,v 1.2 2015/05/25 03:59:16 steja Exp $ 
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/skye_linux/src/linux_error.c,v $
 *------------------------------------------------------------------
 *
 * linux_error.c: Common code for error display based on Linux.
 *
...
/*
 * Function flush_test_progress_buf.
 * input : none
 * output :return none
 */
void
 ...
 *
 * This function is used to clear test name
 */
void
clrtestname (void)
{
...
------------------------------------------------ 
Revision 1.1.2.3  2014/08/25 06:49:04  palin2
Fix compile issue after maksed out enhanced error message code in Skye temporarily.
...
Revision 1.1.2.2  2013/04/29 08:25:07  iachang
Support memory test
