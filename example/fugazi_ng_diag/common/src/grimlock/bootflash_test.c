/* $Id: bootflash_test.c,v 1.2 2020/03/13 12:06:53 letsai Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/grimlock/bootflash_test.c,v $
 *------------------------------------------------------------------
 * bootflash_test.c
 *
...
int boot_flash_util (void) 
{
    ...
    printf("2. Read  Flash Sector 1 Data\n");
    printf("3. Write Flash Sector 1 Data\n");
    ...
    case 1:
        ...
        break;
    case 2:
        srom_no1 = open(BOOTFLASH_MTD_TEST1, O_RDWR | O_SYNC);    
 ...
 ******************************************************************************/
 ...
 int bootflash_test (void)
 {
    ...
    printf("\nThe boot flash test at unused sector 1:\n");   
    /* (step 1) Save original sector data to memory */
    /* Open MTD(mtd1) */
    fwh_fd = open(BOOTFLASH_MTD_TEST1, O_RDWR | O_SYNC);    
    if (fwh_fd < 0) {
        system("mknod /dev/mtd1  c 90 2");
        fwh_fd = open(BOOTFLASH_MTD_TEST1, O_RDWR | O_SYNC);    
        if (fwh_fd < 0) {
