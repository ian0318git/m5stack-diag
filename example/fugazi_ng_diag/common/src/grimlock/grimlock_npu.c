/* $Id: grimlock_npu.c,v 1.2 2020/03/13 12:06:53 letsai Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/grimlock/grimlock_npu.c,v $
 *------------------------------------------------------------------
 * grimlock_npu.c
 *
...
static int tdm_init_t1 (int loop_mode)
{
...
static int tdm_init_e1 (int loop_mode)
{
...
static int host_sgmii_init (int enet_num, int loop_mode)
{
...
static int host_sgmii_iwcreate (int enet_num)
{
...
static int host_sgmii_enable (int enet_num)
{
...
static int npu_tdi_config (int enet_num, int tdi_num, int loop_mode, int op_mode)
{
    WP_handle status;
...
static int npu_bp_sgmii_config (int enet_num, int loop_mode)
{
    WP_handle status;
...
static int npu_dc_sgmii_config (int bp_enet, int dc_enet, int loop_mode)
{
    WP_handle status;
    WP_handle bp_port, bp_dev, bp_iwport, bp_rx_channel, bp_tx_channel, bp_agg;
...
static int npu_host_send (WP_handle object, WP_handle dev_handle)
{
...
static int npu_host_receive (WP_handle dev_handle)
{
    WP_status status;
    WP_data_unit du;
    WP_data_segment seg;
...
int npu_loopback_test (int bp_enet, int dc_enet, int tdi_num, 
