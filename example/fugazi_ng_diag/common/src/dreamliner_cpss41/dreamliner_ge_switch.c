/* $Id: dreamliner_ge_switch.c,v 1.2 2019/12/11 10:10:25 lucywang Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/dreamliner_cpss41/dreamliner_ge_switch.c,v $
 *------------------------------------------------------------------
 *
