/* $Id: platform_i2c.c,v 1.2 2021/06/02 02:56:24 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-sub6/platform_i2c.c,v $
 *-----------------------------------------------------------------------------
...
{
    int rc = 0;
    /* To solve reboot command hang issue.
     * No device on /dev/i2c-2 since P3. P2 has unknown device 0x64.
     * DTS will not initialize i2c-2 so create soft link here 
     * for DIAG related testing.
     */
    system("ln -s /dev/i2c-1 /dev/i2c-2");
    msleep(50);
...
Revision 1.1.4.1  2021/03/04 08:01:59  leschen
To solve kernel command reboot hang issue.
