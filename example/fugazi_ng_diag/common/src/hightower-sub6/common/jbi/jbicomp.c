...
unsigned int jbi_in_length = 0L;
unsigned int jbi_in_index = 0L;    /* byte index into compressed array */
...
int jbi_version = 0;
unsigned int jbi_out_length = 0L;
unsigned int jbi_out_index = 0;    /* byte index into jbi_aca_out_buffer[] */
unsigned int jbi_aca_in_offset = 0L;
...
/****************************************************************************/
{
    ...
    else
    {
        ...
        int_end = jbi_out_length -
            ((int) jbi_current_page * (int) MATCH_DATA_LENGTH);
        end_index = (int_end < JBI_ACA_BUFFER_SIZE) ?
            (unsigned int) int_end : JBI_ACA_BUFFER_SIZE;
...
/****************************************************************************/
{
    unsigned int i, j, data_length = 0L;
