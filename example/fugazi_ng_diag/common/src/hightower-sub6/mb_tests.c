/* $Id: mb_tests.c,v 1.1 2020/08/19 09:50:53 markzha Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-sub6/mb_tests.c,v $
 *------------------------------------------------------------------
 *
 * mb_test.c
 *
...
/**************************************************************
 * Function: nandflash_tests
 * Description : nandflash r/w tests.
 * Inputs: option - for future use
 * Output: PASSED/FAILED
 **************************************************************/
int nandflash_test(int option)
