/* $Id: highrise_eth_traf.c,v 1.2 2021/06/02 02:56:23 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-sub6/highrise_eth_traf.c,v $
 *------------------------------------------------------------------
 *
 * eth_raf.c
