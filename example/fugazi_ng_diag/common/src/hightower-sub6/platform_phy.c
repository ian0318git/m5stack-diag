/* $Id: platform_phy.c,v 1.2 2021/06/02 02:56:24 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-sub6/platform_phy.c,v $
 *********************************************************************
 *
 * platform_phy.c -
 *
...
static long _phy_deep_mac_lpbk_test(void)
{
    ...
    ATTEMPT(marvell_mtd_enable_deep_mac_loopback(pMtdDev, port, speed, 1));
    sleep(5);
    ...
    ATTEMPT(marvell_mtd_enable_deep_mac_loopback(pMtdDev, port, speed, 0));
    sleep(2);
        ...
        MTD_U16 *linkup_p)
{
    ...
    *linkup_p = 0;
    ...
    if ((i == LINK_UP_MAX_POLL) && !(*linkup_p)) {
        printf("Error: H-unit link error for 10M/100M/1G after polling 10s\n");
        return (FAILED);
    }
    return(PASSED);
}
