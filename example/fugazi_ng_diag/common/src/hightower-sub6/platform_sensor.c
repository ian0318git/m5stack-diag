/* $Id: platform_sensor.c,v 1.2 2021/06/02 02:56:24 alpeng Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/src/hightower-sub6/platform_sensor.c,v $
 *------------------------------------------------------------------
 * platform_sensor.c
 *
...
static void ht_dispaly_cpu_intr_reg(void); 
static void ht_cleanup_cpu_intr_reg(void); 
/******************************************************************************
 *                                 Global variables
 ******************************************************************************/
...
static submenu_xtable_t ts_menu_table[] = {
    ...
    {"DBG ht_dispaly_cpu_intr_reg", 
        (PFT)ht_dispaly_cpu_intr_reg, 0, 
        0, 
        (type_t(*)())0, 0,
        (PFT)ht_dispaly_cpu_intr_reg, 0},

    {"DBG ht_cleanup_cpu_intr_reg", 
        (PFT)ht_cleanup_cpu_intr_reg, 0, 
        0, 
        (type_t(*)())0, 0,
        (PFT)ht_cleanup_cpu_intr_reg, 0},
...
{
    printf("0xf244010C = \n"); 
    system("devmem 0xf244010C 32");
    printf("0xf2440110 = \n"); 
    system("devmem 0xf2440110 32");
    printf("0xf2440114 = \n"); 
    system("devmem 0xf2440114 32");
}

static void ht_cleanup_cpu_intr_reg (void)
{
    printf("0xf2440114 = 0 \n"); 
    system("devmem 0xf2440114 32 0");
 ...
 *
 * Revision 1.1.4.6  2020/12/09 01:52:01  alpeng
 * use C comment
 *
 * Revision 1.1.4.5  2020/11/26 03:38:00  alpeng
 * support temperature interrupt test for all version
 *
 * Revision 1.1.4.4  2020/11/25 02:38:06  alpeng
 * update cvs id field
 *
 *
 *********************************************************************
