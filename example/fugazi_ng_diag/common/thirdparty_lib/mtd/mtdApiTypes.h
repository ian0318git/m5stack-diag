...
typedef enum
{
    ...
    MTD_REV_E2010P_B0 = (MTD_E20X0_DEVICE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_SINGLE_PORTB0),
    MTD_REV_E2020P_B0 = (MTD_E20X0_DEVICE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_DUAL_PORTB0),
    MTD_REV_E2040P_B0 = (MTD_E20X0_DEVICE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_QUAD_PORTB0),
    MTD_REV_E2010_B0 = (MTD_E20X0_DEVICE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_SINGLE_PORTB0),
    MTD_REV_E2020_B0 = (MTD_E20X0_DEVICE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_DUAL_PORTB0),
    MTD_REV_E2040_B0 = (MTD_E20X0_DEVICE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_QUAD_PORTB0),
    ...
    MTD_REV_E2010P_B1 = (MTD_E20X0_DEVICE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_SINGLE_PORTB1),
    MTD_REV_E2020P_B1 = (MTD_E20X0_DEVICE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_DUAL_PORTB1),
    MTD_REV_E2040P_B1 = (MTD_E20X0_DEVICE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_QUAD_PORTB1),
    MTD_REV_E2010_B1 = (MTD_E20X0_DEVICE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_SINGLE_PORTB1),
    MTD_REV_E2020_B1 = (MTD_E20X0_DEVICE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_DUAL_PORTB1),
    MTD_REV_E2040_B1 = (MTD_E20X0_DEVICE | MTD_COPPER_CAPABLE | MTD_X33X0_BASE | MTD_X33X0BASE_QUAD_PORTB1),
...
#define MTD_DBG_ERROR(format, ...)       mtdDbgPrint(stderr, MTD_DBG_ERR_LVL, "%s:%s:%d:" format, \
    ({const char *p____ = strrchr(__FILE__, '/'); p____ ? p____ + 1 : __FILE__;}), __func__, __LINE__, ##__VA_ARGS__)

/* macro for informational messages */
#define MTD_DBG_INFO(format, ...)        mtdDbgPrint(stdout, MTD_DBG_ALL_LVL, "%s:%s:%d:" format, \
    ({const char *p____ = strrchr(__FILE__, '/'); p____ ? p____ + 1 : __FILE__;}), __func__, __LINE__, ##__VA_ARGS__)

/* macro for informational messages */
#define MTD_DBG_CRITIC_INFO(format, ...) mtdDbgPrint(stdout, MTD_DBG_INF_LVL, "%s:%s:%d:" format, \
    ({const char *p____ = strrchr(__FILE__, '/'); p____ ? p____ + 1 : __FILE__;}), __func__, __LINE__, ##__VA_ARGS__)
