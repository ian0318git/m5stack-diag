/* $Id: goofy_i2c.h,v 1.4 2012/11/17 01:15:16 mcharon Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/chips/include/goofy_i2c.h,v $
 *------------------------------------------------------------------
...
/*
 * Goofy I2C master register address offset
 */
...
// ZZZ not used #define MSK_GFY_I2C_CTRL_HI_DRIVE_SEL       0x00100000
...
//#define L_SHFT_GFY_I2C_CTRL_HI_DRIVE_SEL       20
...
//#define GFY_I2C_CTRL_NORMAL_DRIVE_SEL   0x00000000
//#define GFY_I2C_CTRL_HI_DRIVE_SEL       0x00100000
...
//extern int gfy_i2c_master_reg_test(goofy_i2c_t *i2c);
//extern int gfy_i2c_master_reg_display (goofy_i2c_t *i2c);
extern void gfy_i2c_reset(goofy_i2c_t *i2c);
extern int gfy_i2c_rd(goofy_i2c_t *i2c, uint8_t, uint32_t, int32_t, 
                       uint32_t, uint32_t, uchar *);
extern int gfy_i2c_wr(goofy_i2c_t *, uint8_t, uint32_t, int32_t, 
                      uint32_t, uint32_t, uchar *);
#endif      /* GOOFY_I2C_H */

/******** History ******** 
$Log: goofy_i2c.h,v $
Revision 1.4  2012/11/17 01:15:16  mcharon
reset i2c device; don't cterr in driver code..propogate err message to slot.c

Revision 1.3  2012/10/25 18:56:18  mcharon
