/* $Id: dev_1112.h,v 1.2 2013/10/08 08:48:25 tirawan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/chips/dev_88e111x_marvell/dev_1112.h,v $
 ***********************************************************************
 * File Name: dev_1112.h
 *
 * Description: Contains definitions specific for the Marvell 88E1112 PHY
 *
...
#ifndef _MRV88E1112_PHY_H_
#define _MRV88E1112_PHY_H_

#include "dev_mrvl_ge.h"

typedef struct dev_88e1112c_p0_t_ {
...
typedef struct dev_88e1112c_p1_t_ {
    smi_t fb_ctrl;	/* 0 - Fiber Control */
    smi_t fb_stat;	/* Fiber Status */
    smi_t phy_id1;	/* PHY Identifier 1 */
    smi_t phy_id2;	/* PHY Identifier 2 */
    smi_t fb_adv;	/* Autonegotiation Fiber Advertisement */
    smi_t fb_pt_ab;	/* Autonegotiation Fiber Link Partner Ability Base
			 * Page */
    smi_t fb_exp;	/* Autonegotiation Fiber Expansion */
    smi_t fb_nx_tx;	/* Autonegotiation Fiber Next Page Transmit Register */
    smi_t fb_pt_nx;	/* 8 - Autonegotiation Fiber Link Partner Next Page */
    smi_t reserve1[6];	/* Reserved */
    smi_t ext_stat;	/* Extended Status */
    smi_t fb_sp_ct1;	/* 0x10 - Fiber Specific Control Register 1 */
    smi_t fb_sp_st1;	/* Fiber Specific Status Register 1 */
    smi_t fb_int_en;	/* Fiber Interrupt Enable Register */
    smi_t fb_sp_st2;	/* Fiber Specific Status Register 2 */
    smi_t reserve2;	/* Reserved */
    smi_t rcv_err_ct;	/* Receive Error Counter */
    smi_t pg_addr;	/* Page Address */
    smi_t reserve3[3];	/* 0x17 - Reserved */
    smi_t fb_sp_ct2;	/* Fiber Specific Control Register 2 */
    smi_t reserve4[2];	/* Reserved */
    smi_t fac_tst_m1;	/* Factory Test modes */
    smi_t fac_tst_m2;	/* Factory Test modes */
    smi_t fac_tst_m3;	/* Factory Test modes */
...
typedef struct dev_88e1112c_p2_t_ {
...
typedef struct dev_88e1112c_p3_t_ {
...
typedef struct dev_88e1112c_p4_t_ {
    smi_t reserve1[2];	/* 0 - Reserved */
    smi_t phy_id1;	/* PHY Identifier 1 */
    smi_t phy_id2;	/* PHY Identifier 2 */
    smi_t reserve2[12];	/* Reserved */
...
typedef struct dev_88e1112c_p5_t_ {
    smi_t reserve1[2];	/* 0 - Reserved */
    smi_t phy_id1;	/* PHY Identifier 1 */
    smi_t phy_id2;	/* PHY Identifier 2 */
    smi_t reserve2[12];	/* Reserved */
...
typedef struct dev_88e1112c_p6_t_ {
    smi_t reserve1[2];	/* 0 - Reserved */
    smi_t phy_id1;	/* PHY Identifier 1 */
    smi_t phy_id2;	/* PHY Identifier 2 */
    smi_t reserve2[12];	/* Reserved */
...
typedef struct dev_88e1112c_p_rsv_t_ {
    smi_t reserve1[2];	/* 0 - Reserved */
    smi_t phy_id1;	/* PHY Identifier 1 */
    smi_t phy_id2;	/* PHY Identifier 2 */
    ...
    smi_t fac_tst_m2;	/* Factory Test modes */
    smi_t fac_tst_m3;	/* Factory Test modes */
} dev_88e1112c_p_rsv_t;

#define MRV88E1112_PHY_ID_1_VALUE               0x0141
#define MRV88E1112_PHY_ID_2_VALUE               0x0C90
#define MRV88E1112_PHY_ID                       0x01430C90

typedef struct mrv_88e1112_reg_t_ {
    dev_88e1112c_p0_t	pg0;	/* Page 0 */
    dev_88e1112c_p1_t	pg1;	/* Page 1 */
    dev_88e1112c_p2_t	pg2;	/* Page 2 */
    dev_88e1112c_p3_t	pg3;	/* Page 3 */
    dev_88e1112c_p4_t	pg4;	/* Page 4 */
    dev_88e1112c_p5_t	pg5;	/* Page 5 */
    dev_88e1112c_p6_t	pg6;	/* Page 6 */
    dev_88e1112c_p_rsv_t rs[249]; /* Reserved Pages */
} mrv_88e1112_reg_t;
...
/* Prototypes */
void mrv88e1112_phy_cleanup(void);
int  mrv88e1112_setup_loopback(int speed);
int  mrv88e1112_setup_ext_loopback(void);
int  mrv88e1112_setup_loopback_param(int loopback, int speed);
int  mrv88e1112_read_phy_id(void);
int  mrv88e1112_setup_phy_loopback(int speed);
int  mrv88e1112_check_phy_link(void);
int  show_mrv88e1112_reg(int menu_option);
int  alter_mrv88e1112_reg(int menu_option);
int  dump_mrv88e1112_registers(int menu_option);
int  mrv88e1112_register_test_wrapper(int menu_option);

#endif /* _MRV88E1112_PHY_H_ */
