/* $Id: dev_88e6176.c,v 1.7 2019/01/24 09:36:07 harrchan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/chips/dev_88e6176_marvell/dev_88e6176.c,v $
 *------------------------------------------------------------------
 * Filename:	dev_88e6176.c
 *
 * Description:	Marvell 88E6176 Device Driver
...
static uint32 dev_88e6176_attach(dev_object_t *);
static uint32 dev_88e6176_detach(dev_object_t *);
static uint32 dev_88e6176_restart(dev_object_t *);
static void dev_88e6176_destroy(dev_object_t **);
static int dev_88e6176_test_reg(dev_object_t *);
static int dev_88e6176_phy_mac_lpbk_test(dev_object_t *, int, int);
static int dev_88e6176_ext_lpbk_test(dev_object_t *, int, int);
static int dev_88e6176_intr_test(dev_object_t *);

static int dev_88e6176_smi_rd(dev_object_t *, int, ushort *);
static int dev_88e6176_smi_wr(dev_object_t *, int, ushort);
static int dev_88e6176_reg_rd_util(dev_object_t *);
static int dev_88e6176_reg_wr_util(dev_object_t *);
static int dev_88e6176_phy_reg_rd_util(dev_object_t *);
static int dev_88e6176_phy_reg_wr_util(dev_object_t *);
static int dev_88e6176_c45_phy_reg_rd_util(dev_object_t *);
static int dev_88e6176_c45_phy_reg_wr_util(dev_object_t *);
static int dev_88e6176_reg_rd(dev_object_t *, int, int, ushort *);
static int dev_88e6176_reg_wr(dev_object_t *, int, int, ushort);
static int dev_88e6176_phy_reg_rd(dev_object_t *, int, int, int, ushort *);
static int dev_88e6176_phy_reg_wr(dev_object_t *, int, int, int, ushort);
static int dev_88e6176_c45_phy_reg_rd(dev_object_t *, int, int, int, ushort *);
static int dev_88e6176_c45_phy_reg_wr(dev_object_t *, int, int, int, ushort);
static int dev_88e6176_pwr_up_ge_port(dev_object_t *, int);
static int dev_88e6176_pwr_up_cpu_port(dev_object_t *, int); 
static int dev_88e6176_set_port_forward(dev_object_t *, int); 
static int dev_88e6176_show_port_status(dev_object_t *, int); 
static int dev_88e6176_enable_phy_port_interrupt(dev_object_t *, int, boolean);
static int dev_88e6176_force_phymac_speed(dev_object_t *, int, int);
static int dev_88e6176_force_phy_speed(dev_object_t *, int, int);
static int dev_88e6176_force_mac_speed(dev_object_t *, int, int);
static int dev_88e6176_enable_int_mask_and_reg(dev_object_t *);
static int dev_88e6176_config_pvlan(dev_object_t *, int);
void mrv_88e6176_dev_create(dev_object_t *, dev_error_report_t);
static int dev_88e6176_led_on(dev_object_t *dev, int); 
static int dev_88e6176_led_off(dev_object_t *dev, int); 
static int dev_88e6176_set_testmode(dev_object_t *);
static int dev_88e6176_chk_intr_assert(dev_object_t *);
static int dev_88e6176_chk_intr_deassert(dev_object_t *);
static int dev_88e6176_set_vod_util(dev_object_t *);
static int dev_88e6176_set_vod(dev_object_t *, int , int , int);

/*===================================================================*
 *                    Polling function                               *
 *===================================================================*/
static int dev_88e6176_is_smi_bus_free(dev_object_t *);                        
static int dev_88e6176_polling_phy_reg(dev_object_t *, int, int, int, ushort); 
static int dev_88e6176_polling_port_reg(dev_object_t *, int, int, int, int, ushort);

/*===================================================================*
 *                    Global variables                               *
 *===================================================================*/
static char mrv_88e6176_err_buf[MRV88E6176_ERR_BUF_SIZE];

static dev_88e6176_pvlan_profile_t vlan_profile[] = 
{
...
/* ======== 88E6176 Test Mode Setting ========== */

/* Based on Marvell FAE,
 * Steps to enter 6176 ESW to Test Mode 1, 2 or 4 are:
 ...
 */
static mrvl_88e6176_phy_setup_t esw_testmode124_steps[] = {
    {PHY_PAGE(0), ESWPHY_1000TCR_ADDR,  0x1F00, 0xFFFF},
    {PHY_PAGE(0), ESWPHY_CCR_ADDR,  0x9140, 0x7B40},
    {PHY_PAGE(4), MRV88E6176_PAGE4_REG27, 0x3E80, 0xFFFF},
    {PHY_PAGE(6), GEPHY_MISC_TEST_REG, 0x8000, 0xFFA0}
};


/* Based on Marvell FAE,
 * Steps to enter 6176 PHY to Test Mode 3 are:
 * 1. Write Page 0, Reg  9 = 0x1700 (Set PHY to Slave mode)
 * 2. Write Page 0, Reg  0 = 0x9140 (Soft-reset)
 * 3. Write Page 4, Reg 27 = 0x3E80 (Disable Clock on the HSDACP/N by set bit8 to 0)
 * 4. Write Page 6, Reg 26 = 0x8000 (Enable TX_TCLK)
 */
static mrvl_88e6176_phy_setup_t esw_testmode3_steps[] = {
...
/******************************************************************************
 *
 * Name:	mrv88e6176_dev_create()
 *
 * Description:	Create object with various device function
 *        		point to "do nothing"
 *
 * Input:	dev_object_t pointer to the 88E6176 device.
 *		    error reporting function pointer.
 *
 * Returns:	none
 *
 *****************************************************************************/
void mrv88e6176_dev_create (dev_object_t *dev, dev_error_report_t error_report_fn)
{
    dev_object_fvt_t	*dev_fvt;
    dev_88e6176_object_t *obj_88e6176= (dev_88e6176_object_t*)dev;

    /* Allocate memory for the device object */
    if ((dev_fvt = (dev_object_fvt_t *)malloc(sizeof(dev_object_fvt_t))) ==
		            NULL) {
        /* Unable to allocate memory */
        error_report_fn(dev, "malloc failure in 88e6176_dev_create()", 0);
        printf("%s: NULL\n", __func__);
	    return;
    }
    ...
    obj_88e6176->base.dev_object_fvt->dev_attach	= dev_88e6176_attach;
    obj_88e6176->base.dev_object_fvt->dev_detach	= dev_88e6176_detach;
    obj_88e6176->base.dev_object_fvt->dev_restart	= dev_88e6176_restart;
    obj_88e6176->base.dev_object_fvt->dev_error_report	= error_report_fn;
    obj_88e6176->base.dev_object_fvt->dev_destroy	= dev_88e6176_destroy;
    obj_88e6176->base.dev_object_fvt->dev_name	= "88E6176 Marvell ESW";

    obj_88e6176->callin_fvt = (dev_88e6176_callin_fvt_t *)
                               malloc(sizeof(dev_88e6176_callin_fvt_t));
    obj_88e6176->callout_fvt = (dev_88e6176_callout_fvt_t *)
                                malloc(sizeof(dev_88e6176_callout_fvt_t));

    obj_88e6176->base.dev_state = DEV_STATE_CREATE;
}


/******************************************************************************
 *
 * Name:	dev_88e6176_attach()
 *
 * Description:	Attach the 88E6176 device for use. This function will
 *		        initialize and setup all necessary pointers and bring the
 *        		chip to operation.
 *
 * Input:	Pointer to the 88E6176 device object
 *
 * Returns:	PASSED/FAILED
 *
 *****************************************************************************/
static uint32 dev_88e6176_attach (dev_object_t *dev)
{
    dev_88e6176_object_t *obj_88e6176 = (dev_88e6176_object_t *) dev;

    if (obj_88e6176->callin_fvt == NULL) {
        DEV_ERROR_REPORT(dev, "dev_88e6176_attach() callin malloc", DEV_88E6176_ATTACH);
        return (FAILED);
    }

    if (obj_88e6176->callout_fvt == NULL) {
        DEV_ERROR_REPORT(dev, "dev_88e6176_attach() callout malloc", DEV_88E6176_ATTACH);
        return (FAILED);
    }

    /* init the call in function */
    obj_88e6176->callin_fvt->register_test  = dev_88e6176_test_reg;
    obj_88e6176->callin_fvt->esw_phy_mac_lpbk_test = dev_88e6176_phy_mac_lpbk_test;
    obj_88e6176->callin_fvt->ext_lpbk_test  = dev_88e6176_ext_lpbk_test;
    obj_88e6176->callin_fvt->intr_test  = dev_88e6176_intr_test;

    obj_88e6176->callin_fvt->esw_reg_read_util   = dev_88e6176_reg_rd_util;
    obj_88e6176->callin_fvt->esw_reg_write_util  = dev_88e6176_reg_wr_util;
    obj_88e6176->callin_fvt->esw_phy_reg_read_util   = dev_88e6176_phy_reg_rd_util;
    obj_88e6176->callin_fvt->esw_phy_reg_write_util  = dev_88e6176_phy_reg_wr_util;
    obj_88e6176->callin_fvt->esw_c45_phy_reg_read_util   = dev_88e6176_c45_phy_reg_rd_util;
    obj_88e6176->callin_fvt->esw_c45_phy_reg_write_util  = dev_88e6176_c45_phy_reg_wr_util;

    obj_88e6176->callin_fvt->esw_reg_read   = dev_88e6176_reg_rd;
    obj_88e6176->callin_fvt->esw_reg_write  = dev_88e6176_reg_wr;
    obj_88e6176->callin_fvt->esw_phy_reg_read   = dev_88e6176_phy_reg_rd;
    obj_88e6176->callin_fvt->esw_phy_reg_write  = dev_88e6176_phy_reg_wr;
    obj_88e6176->callin_fvt->esw_c45_phy_reg_read   = dev_88e6176_c45_phy_reg_rd;
    obj_88e6176->callin_fvt->esw_c45_phy_reg_write  = dev_88e6176_c45_phy_reg_wr;

    obj_88e6176->callin_fvt->esw_pwr_up_ge_port     = dev_88e6176_pwr_up_ge_port;
    obj_88e6176->callin_fvt->esw_pwr_up_cpu_port  = dev_88e6176_pwr_up_cpu_port;
    obj_88e6176->callin_fvt->esw_set_port_forward = dev_88e6176_set_port_forward;
    obj_88e6176->callin_fvt->esw_enable_phy_port_interrupt = 
                             dev_88e6176_enable_phy_port_interrupt ;
    obj_88e6176->callin_fvt->esw_enable_int_mask_and_reg = 
                             dev_88e6176_enable_int_mask_and_reg;
    obj_88e6176->callin_fvt->esw_config_pvlan = dev_88e6176_config_pvlan;
    obj_88e6176->callin_fvt->esw_set_led_on = dev_88e6176_led_on;
    obj_88e6176->callin_fvt->esw_set_led_off = dev_88e6176_led_off;
    obj_88e6176->callin_fvt->esw_set_testmode = dev_88e6176_set_testmode;
    obj_88e6176->callin_fvt->esw_set_vod_util = dev_88e6176_set_vod_util;
    obj_88e6176->base.dev_state = DEV_STATE_ATTACH;
 ...
 *
 *****************************************************************************/
static uint32 dev_88e6176_detach (dev_object_t *dev)
{
    dev_88e6176_object_t *obj_88e6176 = (dev_88e6176_object_t *) dev;

    /* Init the device object structure to default "do nothing" */
    init_default_dev_object(dev, obj_88e6176->base.dev_object_fvt);

    obj_88e6176->base.dev_state = DEV_STATE_DETACH;
 ...
 *
 *****************************************************************************/
static uint32 dev_88e6176_restart (dev_object_t *dev)
{
    dev_88e6176_object_t *obj_88e6176= (dev_88e6176_object_t *) dev;

    obj_88e6176->base.dev_state = DEV_STATE_INIT;
    return (PASSED);
}


/******************************************************************************
 * Name:	dev_88e6176_destroy
 *
 ...
 *
 *****************************************************************************/
static void dev_88e6176_destroy (dev_object_t **dev)
{
    dev_88e6176_object_t *obj_88e6176;
    ...
    obj_88e6176 = (dev_88e6176_object_t *)*dev;

    if (obj_88e6176->callout_fvt) {
        free(obj_88e6176->callout_fvt);	/* Free callout struct */
    }

    if (obj_88e6176->callin_fvt) {
        free(obj_88e6176->callin_fvt);		/* Free callin struct */
    }

    free(obj_88e6176->base.dev_object_fvt);	/* Free dev_object_t */
}

/******************************************************************************
 *
 * Function:    dev_88e6176_test_reg
 *
 * Description: Tests the 88E6176 registers.
 *              Restores original register values after test.
 *
 * Inputs:  dev_object_t pointer to the 88E6176 device
 ...
 *
 *****************************************************************************/
static int dev_88e6176_test_reg (dev_object_t *dev)
{
    int    rc = FAILED;
    int    ctr = 0;
    ...
    for (ctr = start_port; ctr <= end_port; ctr++) {
        ...
        printf("Marvell 88E6176 Register test at Port:%d\n",ctr);

        if (dev_88e6176_phy_reg_rd(dev, ctr,
                                  (int)REG_PAGE(0),
        ...
        if (dev_88e6176_phy_reg_wr(dev, ctr,
                                  (int)REG_PAGE(0),
                                  (int)ESW_GEPHY_PAGE_ADDR,
                                  test_pattern) != PASSED) {
            printf("%s:%d: Fail at Port:%d\n", __FUNCTION__, __LINE__, ctr);
...
/******************************************************************************
 *
 * Function:    dev_88e6176_ext_lpbk_test
 *
 * Description: Tests the 88E6176 external loopback.
 *
 * Inputs:  dev_object_t pointer to the 88E6176 device
 *          A device print function vector
 ...
 *
 *****************************************************************************/
static int dev_88e6176_ext_lpbk_test (dev_object_t *dev, int start_port, int end_port)
{
    dev_88e6176_object_t *obj_88e6176 = (dev_88e6176_object_t *) dev;
    dev_88e6176_callout_fvt_t *callout_p = obj_88e6176->callout_fvt;
    ...
    for (ctr = start_port; ctr <= end_port; ctr++) {
        /* Disable Switch port */
        esw_port = (int)(ctr + ESW_PORT_REG_BASE);
        if (dev_88e6176_reg_wr(dev, esw_port, (int)ESW_PORT_CTL_REG_OFFSET, 
    ...
    for (ctr = start_port; ctr <= end_port; ctr++) {
        /* Enable Switch port */
        esw_port = (int)(ctr + ESW_PORT_REG_BASE);
        if (dev_88e6176_reg_wr(dev, (int)esw_port, (int)ESW_PORT_CTL_REG_OFFSET,
        ...
        for (speed_ctr = 0; speed_ctr < (sizeof(test_speed)/sizeof(int)); speed_ctr++) {
            ...
            if (test_speed[speed_ctr] == SPD_1000MBPS) {
                if (dev_88e6176_phy_reg_wr(dev, ctr, (int)PHY_PAGE(6), 
            ...
            if (dev_88e6176_force_phymac_speed(dev, ctr, test_speed[speed_ctr]) 
                != PASSED) {
                printf("%s:%d: Fail at Port:%d, Speed:%dMbps\n", 
                       __FUNCTION__, __LINE__, ctr, test_speed[speed_ctr]);
            ...
            printf("Marvell 88E6176 External loopback test at Port%d in Speed:%4dmbps\n", 
                   ctr, test_speed[speed_ctr]);

            rc = (*callout_p->sgmii_lpbk_test)();
            if (rc != PASSED) {
                printf("%s:%d: Warning at Port:%d, Speed:%dMbps\n", 
                       __FUNCTION__, __LINE__, ctr, test_speed[speed_ctr]);
                printf("%s:%d: Reason:Something wrong when runnnig loopback test for Tx/Rx\n", 
                       __FUNCTION__, __LINE__);
                dev_88e6176_show_port_status(dev, ctr);
                return (FAILED);
            }
            msleep(50);
        }
...
/******************************************************************************
 *
 * Function:    dev_88e6176_intr_test
 *
 ...
 *       the "88E6352/88E6240/88E6176/88E6172 Functional Specification"
 *       Doc. No.: MV-S108006-00
 *       Please refer to the following page:
 *       P.266, Global 1 offset 0x4 EEIntEn field
 *
 *****************************************************************************/
static int dev_88e6176_intr_test (dev_object_t *dev)
{
    ...
    if (dev_88e6176_reg_rd(dev, smi_addr, reg_addr, &ori_reg_val) == FAILED) {
    ...
    smi_addr = ESW_SMIDEV_GLOB1; 
    reg_addr = GLOBAL_CTRL_REG;
    reg_val = EEINT_ENABLE;
    if (dev_88e6176_reg_wr(dev, smi_addr, reg_addr, reg_val) == FAILED) {
    ...
    if (dev_88e6176_chk_intr_assert(dev) != PASSED) {
    ...
    if (dev_88e6176_chk_intr_deassert(dev) != PASSED) {
    ...
    smi_addr = ESW_SMIDEV_GLOB1;
    reg_addr = GLOBAL_CTRL_REG;
    if (dev_88e6176_reg_rd(dev, smi_addr, reg_addr, &reg_val) == FAILED) {
        printf("%s:%d: Failed to read Device Reg with smi_addr:0x%x reg_addr:0x%x\n", 
               __func__, __LINE__, smi_addr, reg_addr);
        return (FAILED);
    }
...
/**********************************************************************
 *
 * Function: dev_88e6176_smi_rd
 *
 * This function: Reads Marvell ESW registers through callout
 *
 * Input : dev    - dev_object_t pointer to the 88E6176 device
 *	       cmd    - Command register in 88e6176
 ...
 *	                it's format from 88e6176 datasheet.
 *
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_smi_rd (dev_object_t *dev, int cmd, ushort *buf)
{
    int rc;
    dev_88e6176_object_t *obj_88e6176 = (dev_88e6176_object_t *) dev;
    dev_88e6176_callout_fvt_t *callout_p = obj_88e6176->callout_fvt;
    ...
    if (rc != PASSED) {
        sprintf(mrv_88e6176_err_buf, "%s: Failed (%#x)", __func__, rc);
        return (FAILED);
    }
...
/**********************************************************************
 *
 * Function: dev_88e6176_smi_wr
 *
 * This function: writes Marvell ESW registers through callout
 *
 * Input : dev     - dev_object_t pointer to the 88E6176 device
 *	       cmd     - Command data register in 88e6176   
 *	                if it is cmd_reg the value will be 0x0 
 *	                if it is data_reg the value will be 0x1 
 ...
 **********************************************************************
 */
static int dev_88e6176_smi_wr (dev_object_t *dev, int cmd, ushort regval)
{
    dev_88e6176_object_t *obj_88e6176 = (dev_88e6176_object_t *) dev;
    dev_88e6176_callout_fvt_t *callout_p = obj_88e6176->callout_fvt;
    int rc ;
...
/**********************************************************************
 *
 * Function: dev_88e6176_reg_rd_util
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_reg_rd_util (dev_object_t *dev)
{
    ...
    if (dev_88e6176_reg_rd(dev, dev_addr, reg_addr, &reg_val) != PASSED) {
        return (FAILED);
    } else {
...
/**********************************************************************
 *
 * Function: dev_88e6176_reg_wr_util
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_reg_wr_util (dev_object_t *dev)
{
    int    dev_addr = 0, reg_addr = 0;
    ...
    if (dev_88e6176_reg_wr(dev, dev_addr, reg_addr, wr_data) != PASSED) {
        return (FAILED);
    } else {
...
/**********************************************************************
 *
 * Function: dev_88e6176_phy_reg_rd
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_phy_reg_rd_util (dev_object_t *dev)
{
    ...
    if (dev_88e6176_phy_reg_rd(dev, phy_port, reg_page, reg_addr, &reg_val) 
                               != PASSED) {
        return (FAILED);
    } else {
...
/**********************************************************************
 *
 * Function: dev_88e6176_phy_reg_wr_util
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_phy_reg_wr_util (dev_object_t *dev)
{
    int    phy_port = 0, reg_page, reg_addr = 0;
    ushort reg_val = 0, wr_data = 0;
    ...
    if (dev_88e6176_phy_reg_wr(dev, phy_port, reg_page, reg_addr, wr_data) 
                               != PASSED) {
        return (FAILED);
    } else {
...
/**********************************************************************
 *
 * Function: dev_88e6176_c45_phy_reg_rd_util
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_c45_phy_reg_rd_util (dev_object_t *dev)
{
    ...
    if (dev_88e6176_c45_phy_reg_rd(dev, phy_port, dev_num, reg_addr, &rd_buf) 
                                   != PASSED) {
        return (FAILED);
    } else {
...
/**********************************************************************
 *
 * Function: dev_88e6176_c45_phy_reg_wr_util
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_c45_phy_reg_wr_util (dev_object_t *dev)
{
    int    phy_port = 0, dev_num, reg_addr = 0;
    ...
    if (dev_88e6176_c45_phy_reg_wr(dev, phy_port, dev_num, reg_addr, wr_data) 
                                   != PASSED) {
        return (FAILED);
    } else {
 ...
 **********************************************************************
 */
static int dev_88e6176_reg_rd (dev_object_t *dev, int dev_addr, 
                               int reg_addr, ushort *buf)
{
    ...
    if (dev_88e6176_is_smi_bus_free(dev) != PASSED) {
    ...
    /* write want to read register to the command register */
    if (dev_88e6176_smi_wr(dev, smi_cmd_reg, wr_data) != PASSED) {
    ...
    reg_val = 0;
    /* Read data register to get reg value*/
    if (dev_88e6176_smi_rd(dev, smi_data_reg, &reg_val) != PASSED) {
 ...
 **********************************************************************
 */
static int dev_88e6176_reg_wr (dev_object_t *dev, int dev_addr, int reg_addr,
                                ushort wr_data)
{
    int    phy_addr = 0;
    int    smi_cmd_reg = (int)ESW_SMI_CMD_REG;
    ...
    if (dev_88e6176_smi_wr(dev, smi_data_reg, wr_data) != PASSED) {
        printf("%s:%d Failed to SMI write Switch(%#X) command reg.(%#X)\n",
    ...
    if (dev_88e6176_smi_wr(dev, smi_cmd_reg, cmd_data) != PASSED) {
        printf("%s:%d Failed to SMI write Switch(%#X) command reg.(%#X)\n",
                   __FUNCTION__, __LINE__, phy_addr, smi_cmd_reg);
        return (FAILED);
    } 
 ...
 **********************************************************************
 */
static int dev_88e6176_phy_reg_rd (dev_object_t *dev, int phy_port, int reg_page, int reg_addr, ushort *buf)
{
    ...
    if (dev_88e6176_polling_phy_reg(dev, COMPARE_AND, smi_dev, smi_reg, pattern) != PASSED) {
    ...
    if (reg_addr == ESW_GEPHY_PAGE_ADDR) {
        ...
        if (dev_88e6176_reg_wr(dev, smi_dev, smi_reg, smi_cmd) != PASSED) {
            return (FAILED);
        }
        ...
        if (dev_88e6176_reg_rd(dev, smi_dev, smi_reg, buf) != PASSED) {
    ...
    smi_dev = (int)ESW_SMIDEV_GLOB2;
    smi_reg = (int)ESW_GLOB2_PD;
    if (dev_88e6176_reg_wr(dev, smi_dev, smi_reg, wr_data) != PASSED) {
...
/**********************************************************************
 *
 * Function: dev_88e6176_phy_reg_wr
 *
 * This function: writes Marvell Ethernet Switch PHY registers
 *
 * Input : dev      - dev_object_t pointer to the 88E6176 device
 ...
 **********************************************************************
 */
static int dev_88e6176_phy_reg_wr (dev_object_t *dev, int phy_port, int reg_page, int reg_addr, ushort wr_in)
{
    int    smi_dev = 0, smi_reg = 0, phy_page_reg = (int)PHY_REG(22);
    ushort smi_cmd = 0, wr_data = 0, pattern = 0;
    ...
    smi_dev = (int)ESW_SMIDEV_GLOB2;
    smi_reg = (int)ESW_GLOB2_PD;
    if (dev_88e6176_reg_wr(dev, smi_dev, smi_reg, wr_in) != PASSED) {
        printf("%s:%d Failed to write ESW SMI dev %#x reg. %#x\n",
               __FUNCTION__, __LINE__, smi_dev, smi_reg);
        return (FAILED);
    }
...
/**********************************************************************
 *
 * Function: dev_88e6176_c45_phy_reg_rd
 *
 * This function: read Marvell ESW PHY  registers (Clause 45)
 *
 * Input : dev      - dev_object_t pointer to the 88E6176 device
 *	       phy_port - which port want to read
 *         dev_num - the device index reference 88E6176 datasheet
 *         reg_addr - register address
 ...
 **********************************************************************
 */
static int dev_88e6176_c45_phy_reg_rd (dev_object_t *dev, int phy_port, 
                                       int dev_num, int reg_addr, ushort *buf)
{
    ...
    for (ctr = 0; ctr < SMI_WAIT_CUNTR; ctr++) {
        msleep(5);
        ...
        smi_dev = (int)ESW_SMIDEV_GLOB2;
        smi_reg = (int)ESW_GLOB2_PC;
        if (dev_88e6176_reg_rd(dev, smi_dev, smi_reg, &reg_val) != PASSED) {
            printf("%s:%d Failed to SMI read ESW SMI dev %#x reg. %#x\n",
                   __FUNCTION__, __LINE__, smi_dev, smi_reg);
            return (FAILED);
        }
...
/**********************************************************************
 *
 * Function: dev_88e6176_c45_phy_reg_wr
 *
 * This function: write Marvell ESW PHY  registers (Clause 45)
 *
 * Input : dev      - dev_object_t pointer to the 88E6176 device
 ...
 **********************************************************************
 */
static int dev_88e6176_c45_phy_reg_wr (dev_object_t *dev, int phy_port, 
...
/**********************************************************************
 *
 * Function: dev_88e6176_show_port_status
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_show_port_status (dev_object_t *dev, int port) 
{
    ushort result = 0;
    uint   speed = 0;
    ...
    if (dev_88e6176_phy_reg_rd(dev, port, reg_page, reg_addr, 
                                &reg_val) != PASSED) {
...
/**********************************************************************
 *
 * Function: dev_88e6176_pwr_up_ge_port
 *
 ...
 *         
 *         [Info of reference]:
 *         Document: Link Street 88E6352/88E6240/88E6176/88E6172 
 *                   Functional Specification
 *         Doc. No.: MV-S108006-00
 *         Section : 11.1.1 (Copper Registers)
 *         Page    : P.436
 **********************************************************************
 */
static int dev_88e6176_pwr_up_ge_port (dev_object_t *dev, int port) 
{
    ushort reg_val = 0;

    /* Page:0 Reg:0 */
    int page_addr = REG_PAGE(0); 
    int reg_addr  = ESWPHY_CCR_ADDR;
    
    if (dev_88e6176_phy_reg_rd(dev, port, page_addr, reg_addr, &reg_val) != PASSED) {
    ...
    if (dev_88e6176_phy_reg_wr(dev, port, page_addr, reg_addr, reg_val) != PASSED) {
...
/**********************************************************************
 * Function: dev_88e6176_pwr_up_cpu_port
 *
 ...
 * Output: PASSED/FAILED
 * Note  : According to "Info of reference", it indicates that
 *         the description of Fiber/SERDES Control Register(Page:1 Reg:0).
 *         The purpose of this function is to set the 
 *         "Power Down(bit[11])" as 0 for normal operation.
 *
 *         If Power Down is...
 ...
 *                   Functional Specification
 *         Doc. No.: MV-S108006-00
 *         Section : 10.3 (Single-chip Addressing Mode)
 *                   11.1.2 (Fiber/SERDES Registers)
 *         Page    : P.211 / P.472 / P.474
 **********************************************************************
 */
static int dev_88e6176_pwr_up_cpu_port (dev_object_t *dev, int port) 
{
    ushort reg_val = 0;
    if (dev_88e6176_phy_reg_rd(dev, port, (int)REG_PAGE(1), 0, &reg_val) 
                               != PASSED) {
    ...
    if (dev_88e6176_phy_reg_wr(dev, port, (int)REG_PAGE(1), 0, reg_val)
                               != PASSED) {
...
/**********************************************************************
 *
 * Function: dev_88e6176_set_port_forward
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_set_port_forward (dev_object_t *dev, int port) 
{
    ushort reg_val = 0; 
    int reg_addr = (int)ESW_PORTCTR_REG;

    if (dev_88e6176_reg_rd(dev, port, reg_addr, &reg_val) != PASSED) {
    ...
    if (dev_88e6176_reg_wr(dev, port, reg_addr, reg_val) != PASSED) {
...
/**********************************************************************
 *
 * Function: dev_88e6176_enable_phy_port_interrupt
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_enable_phy_port_interrupt (dev_object_t *dev,
                                                  int port, boolean enable) 
{
    if (enable == TRUE) {
        if (dev_88e6176_phy_reg_wr(dev, port, PHY_PAGE(0), COP_SPEC_INT_EN_REG, 
 ...
 **********************************************************************
 */
static int dev_88e6176_force_phymac_speed (dev_object_t *dev, int port_num, int speed_opt)
{
    ...
    /* Configure PHY side */
    if (dev_88e6176_force_phy_speed(dev, port_num, speed_opt) != PASSED) {
    ...
    /* Configure MAC side */
    if (dev_88e6176_force_mac_speed(dev, port_num, speed_opt) != PASSED) {
    ...
    if (dev_88e6176_polling_port_reg(dev, COMPARE_AND_EQL, 
 ...
 *******************************************************************************
 */
static int dev_88e6176_force_phy_speed (dev_object_t *dev, int port_num, int speed_opt)
{
    int    reg_page = (int)REG_PAGE(0);
    ...
    if (dev_88e6176_phy_reg_wr(dev, port_num, reg_page, reg_addr, reg_val) != PASSED) {
    ...
    if (dev_88e6176_polling_port_reg(dev, COMPARE_AND, 
                                     port_num, reg_page, reg_addr, pattern) != PASSED) {
    ...
    if (dev_88e6176_polling_port_reg(dev, COMPARE_EQL, 
                                     port_num, reg_page, reg_addr, pattern) != PASSED) {
...
/*******************************************************************************
 *
 * Function   : dev_88e6176_force_mac_speed
 ...
 *******************************************************************************
 */
static int dev_88e6176_force_mac_speed (dev_object_t *dev, int port_num, int speed_opt)
{
    int    esw_port = 0;
    int    reg_addr = (int)ESW_PCR_ADDR;
    ushort reg_val = 0, chk_val = 0, spd_val = 0, pattern = 0;

    esw_port = (int)(port_num + ESW_PORT_REG_BASE);
    ...
    if (dev_88e6176_reg_rd(dev, esw_port, reg_addr, &reg_val) != PASSED) {
    ...
    if (dev_88e6176_reg_wr(dev, esw_port, reg_addr, reg_val) != PASSED) {
    ...
    if (dev_88e6176_polling_phy_reg(dev, COMPARE_AND, esw_port, reg_addr, pattern) != PASSED) {
        printf("DBG[%s:%d] Inner device SMI bus is busy\n", __FUNCTION__, __LINE__);
        return (FAILED);
    }
    ...
    if (dev_88e6176_reg_wr(dev, esw_port, reg_addr, chk_val) != PASSED) {
        printf("%s(%d) Failed to write ESW port%d Reg.0x%02X\n",
               __func__, __LINE__, port_num, reg_addr);
        return (FAILED);
    }
    ...
    if (dev_88e6176_polling_phy_reg(dev, COMPARE_EQL, esw_port, reg_addr, chk_val) != PASSED) {
...
/*******************************************************************************
 *
 * Function   : dev_88e6176_phy_mac_lpbk_test
 ...
 *******************************************************************************
 */
static int dev_88e6176_phy_mac_lpbk_test (dev_object_t *dev, int port_num, int speed_opt) {
    dev_88e6176_object_t *obj_88e6176 = (dev_88e6176_object_t *) dev;
    dev_88e6176_callout_fvt_t *callout_p = obj_88e6176->callout_fvt;
    ...
    printf("Marvell 88E6176 MAC loopback test at Port%d in Speed:%4dmbps\n", port_num, speed_opt);
    ...
    phy_reg = 0;
    if (dev_88e6176_phy_reg_rd(dev, port_num, reg_page, reg_addr, &phy_reg) != PASSED) {
        printf("%s:%d: Fail at Port:%d, Speed:%dMbps\n", 
               __FUNCTION__, __LINE__, port_num, speed_opt);
    ...
    switch(speed_opt) {
        ...
        default:  
            printf("%s(%d): Unsupported test speed(%d).\n",
                   __FUNCTION__, __LINE__, speed_opt);
            return (FAILED);
    }
    ...
    if (dev_88e6176_phy_reg_wr(dev, port_num, reg_page, reg_addr, 
                                  phy_reg) != PASSED) {
        printf("%s:%d: Fail at Port:%d, Speed:%dMbps\n", 
               __FUNCTION__, __LINE__, port_num, speed_opt);
        printf("%s:%d: Reason: Fail to write PHY reg: Page:%d Reg:%d Data:0x%04x\n", 
    ...
    if (dev_88e6176_phy_reg_rd(dev, port_num, reg_page, reg_addr,
                               &phy_reg) != PASSED) {
        printf("%s:%d: Fail at Port:%d, Speed:%dMbps\n", 
               __FUNCTION__, __LINE__, port_num, speed_opt);
        printf("%s:%d: Reason: Fail to read PHY reg: Page:%d Reg:%d\n", 
    ...
    /* 3. Config. ESW port */
    smi_dev_addr = (int)(port_num + ESW_PORT_REG_BASE);
    ...
    smi_reg = 0;
    if (dev_88e6176_reg_rd(dev, smi_dev_addr, reg_addr, &smi_reg) != PASSED) {
        printf("%s:%d: Fail at Port:%d, Speed:%dMbps\n", 
               __FUNCTION__, __LINE__, port_num, speed_opt);
    ...
    if ((smi_reg & (ushort)(ESW_PCR_FORCE_LINK | ESW_PCR_F_LINKUP)) !=
        ...
        if (dev_88e6176_reg_wr(dev, smi_dev_addr, reg_addr, smi_reg) != PASSED) {
            printf("%s:%d: Fail at Port:%d, Speed:%dMbps\n", 
                   __FUNCTION__, __LINE__, port_num, speed_opt);
            printf("%s:%d: Reason: Fail to write port%d SMI reg:0x%02X data:0x%04x\n", 
                   __FUNCTION__, __LINE__, port_num, reg_addr, smi_reg);
    ...
    for (ctr = start_port; ctr <= end_port; ctr++) {
        ...
        smi_dev_addr = (ctr + (int)ESW_PORT_REG_BASE);
    ...
    /* Run SGMII loopback test */
    if ((*callout_p->sgmii_lpbk_test)() != PASSED) {
        printf("%s:%d: Warning at Port:%d, Speed:%dMbps\n", 
               __FUNCTION__, __LINE__, port_num, speed_opt);
        printf("%s:%d: Reason:Something wrong when runnnig loopback test for Tx/Rx\n", 
               __FUNCTION__, __LINE__);
...
/*******************************************************************************
 *
 * Function   : dev_88e6176_config_pvlan
 ...
 *******************************************************************************
 */
static int dev_88e6176_config_pvlan (dev_object_t *dev, int which_profile)
{
    int ix, smi_addr;
    int reg_addr = (int)ESW_PORT_VLAN_REG; 
    ushort reg_val = 0;
    dev_88e6176_pvlan_profile_t *applied_profile;

    if (which_profile >= VLAN_PROFILE_END) {
 ...
 **********************************************************************
 */
static int dev_88e6176_led_on (dev_object_t *dev, int port) 
{
    ushort reg_val = 0; 
    int reg_addr = (int)ESW_LED_CONTR_REG;
    port += ESW_PORT_REG_BASE;
 ...
 **********************************************************************
 */
static int dev_88e6176_led_off (dev_object_t *dev, int port) 
{
    ushort reg_val = 0; 
    int reg_addr = (int)ESW_LED_CONTR_REG;
    port += ESW_PORT_REG_BASE;
...
/******************************************************************************
 *
 * Function:	dev_88e6176_set_testmode
 *
 ...
 *
 *****************************************************************************/
static int dev_88e6176_set_testmode (dev_object_t *dev)
{
    int test_mode = 0;;
    int ctr = 0, total_steps = 0, port_num = 0;
    uint16_t testmode_val = 0;
    mrvl_88e6176_phy_setup_t *step_ptr;

    printf("ESW(Marvell 6176) Port numner:\n");
    port_num = gethex_answer("Enter Port number (0-3)", 0, 0, 3);

    printf("ESW(Marvell 6176) Supported TestMode:\n");
   ...
   if ((test_mode == ESW_TESTMODE1) || (test_mode == ESW_TESTMODE2) ||
        ...
        total_steps = sizeof(esw_testmode124_steps) / sizeof(mrvl_88e6176_phy_setup_t);
        ...
        total_steps = sizeof(esw_testmode3_steps) / sizeof(mrvl_88e6176_phy_setup_t);

        /* Enable Test mode 3: 0x7700 */
        testmode_val = ESW_TESTMODE3_REG_VAL;
    } else if (test_mode == ESW_TESTMODE_NORMAL) {
        dev_88e6176_phy_reg_wr(dev, port_num, PHY_PAGE(0), ESWPHY_CCR_ADDR,
                                  0x9140);
        return (PASSED);
    } else {
    ...
    for (ctr = 0; ctr < total_steps; ctr++, step_ptr++) {
        /* Set register */
        prpass(testpass, "Set Port %d Set TestMode%d: Set page%d Reg%.2d to 0x%04X",
               port_num, test_mode, step_ptr->reg_page, step_ptr->reg_off,
               step_ptr->val);
        printf("\n");
        if (dev_88e6176_phy_reg_wr(dev, port_num, step_ptr->reg_page,
                    step_ptr->reg_off, step_ptr->val) != PASSED) {
            printf("\n%s: Failed to set ESW(6176) page%d Reg%.2d to 0x%04X.\n",
    ...
    prpass(testpass, "Set TestMode%d: Set page%d Reg%.2d to 0x%04X",
            test_mode, PHY_PAGE(0), ESWPHY_1000TCR_ADDR, testmode_val);
    printf("\n");
    if (dev_88e6176_phy_reg_wr(dev, port_num,  PHY_PAGE(0), ESWPHY_1000TCR_ADDR, 
                               testmode_val) != PASSED) {
        printf("\n%s: Failed to set ESW(6176) page%d Reg%.2d to 0x%04X.\n",
    ...
    printf("\nNow ESW(6176) enter TestMode%d, and press \'q\' to exit: ",
            test_mode);

    while (1) {
        if(getchar() == 'q') {
            dev_88e6176_phy_reg_wr(dev, port_num, PHY_PAGE(0),
...
/**********************************************************************
 *
 * Function: dev_88e6176_chk_intr_assert
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_chk_intr_assert (dev_object_t *dev)
{
    dev_88e6176_object_t *obj_88e6176 = (dev_88e6176_object_t *) dev;
    dev_88e6176_callout_fvt_t *callout_p = obj_88e6176->callout_fvt;
    int rc, ix;
...
/**********************************************************************
 *
 * Function: dev_88e6176_chk_intr_deassert
 *
 ...
 **********************************************************************
 */
static int dev_88e6176_chk_intr_deassert (dev_object_t *dev)
{
    dev_88e6176_object_t *obj_88e6176 = (dev_88e6176_object_t *) dev;
    dev_88e6176_callout_fvt_t *callout_p = obj_88e6176->callout_fvt;
    int rc, ix;
...
/**********************************************************************
 *
 * Function: dev_88e6176_set_vod_util
 *
 * This function: Checking the set the output voltage
 * Input : dev - dev_object_t pointer to the 88E6176 device
 * Output: PASSED/FAILED
 **********************************************************************
 */
static int dev_88e6176_set_vod_util (dev_object_t *dev)
{
    ...
    for (ctr = s_port; ctr < e_port; ctr++) {
        if (dev_88e6176_set_vod(dev, esw_port, eth_mode, vod_val) != PASSED) {
 ...
 **********************************************************************
 */
static int dev_88e6176_set_vod(dev_object_t *dev, int esw_port, int eth_mode, int vod_val)
{
    ...
    /* Adjust VOD */
    if (dev_88e6176_phy_reg_rd(dev, esw_port, reg_page, reg_addr, &reg_val) != PASSED) {
    ...
    if (dev_88e6176_phy_reg_wr(dev, esw_port, reg_page, reg_addr, reg_val) != PASSED) {
...
/**********************************************************************
 * Function: dev_88e6176_is_smi_bus_free
 *
 ...
 **********************************************************************/
static int dev_88e6176_is_smi_bus_free (dev_object_t *dev)
{
    ushort reg_val = 0;
    ...
    for (ix = 0; ix < MAX_POLLING_ROUND; ix++)
    {
        ...
        if (dev_88e6176_smi_rd(dev, ESW_SMI_CMD_REG, &reg_val) != PASSED) {
...
/**********************************************************************
 * Function: dev_88e6176_polling_phy_reg
 *
 ...
 * Output: PASSED/FAILED
 **********************************************************************/
static int dev_88e6176_polling_phy_reg(dev_object_t *dev, int compare_op, int smi_dev, int smi_reg, ushort pattern)
{
    ushort reg_val = 0;
    int polling_result = FAILED, ix;
...
/**********************************************************************
 * Function: dev_88e6176_polling_port_reg
 *
 * This function: Checking whether the read data is equal to pattern
 * Input : dev        - dev_object_t pointer to the 88E6176 device
 *         compare_op - COMPARE_AND/COMPARE_EQL
 ...
 * Output: PASSED/FAILED
 **********************************************************************/
static int dev_88e6176_polling_port_reg(dev_object_t *dev, int compare_op, 
                                 int phy_port, int reg_page, int reg_addr, ushort pattern)
{
    ...
    for (ix = 0; ix < MAX_POLLING_ROUND; ix++)
    {
        ...
        if (dev_88e6176_phy_reg_rd(dev, phy_port, reg_page, reg_addr, &reg_val) != PASSED) {
...
/*------------------------------------------------------------------
$Log: dev_88e6176.c,v $
Revision 1.7  2019/01/24 09:36:07  harrchan
Remove the keyword fail and error when retry on ethernet switch loopback test(2)(CSCvn94470)

Revision 1.6  2019/01/11 07:08:30  harrchan
Remove the keyword fail and error when retry on ethernet switch loopback test(CSCvn94470)

Revision 1.5  2019/01/10 06:13:22  wilbhuan
1. Added interrupt test.
2. Added output voltage utility.
3. Added routine polling function for register value confirmation.

Revision 1.4  2018/12/10 09:57:34  harrchan
...
Revision 1.1.2.5  2018/03/16 06:52:02  harrchan
Support ESW PHY 1000base-T Test Mode

Revision 1.1.2.4  2018/03/15 08:31:01  harrchan
Add new function for led test

Revision 1.1.2.3  2018/03/05 08:54:19  harrchan
Initial hydra application code base

Revision 1.1.2.2  2018/02/27 08:17:12  harrchan
