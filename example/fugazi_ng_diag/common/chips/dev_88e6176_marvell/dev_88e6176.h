/* $Id: dev_88e6176.h,v 1.3 2019/01/10 06:13:22 wilbhuan Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/common/chips/dev_88e6176_marvell/dev_88e6176.h,v $
 *------------------------------------------------------------------
 * 
 * Filename   : dev_88e6176.h
 * Description: 
 *
...
#ifndef __DEV_88E6176_H__
#define __DEV_88E6176_H__
...
#define REG_PAGE(x)  (x)
#define REG_ADDR(x)  (x)
#define MRV88E6176_ERR_BUF_SIZE    (80)
...
#define ESW_PORT_REG_BASE        MRVL88E6176_PORT_REG_BASE
#define MRVL88E6176_SERDES_REG_ADDR    0xF
#define ESW_CPU_PORT_ADDR        MRVL88E6176_SERDES_REG_ADDR
...
/* Misc Test Reg.(26_6) */
#define MRV88E6176_PAGE4_REG27    27
...
typedef struct dev_88e6176_callin_fvt_t_ {
    ...
    int (*esw_pwr_up_cpu_port)(dev_object_t *, int);                      /* Power up serdes port */
...
} dev_88e6176_callout_fvt_t;

typedef enum {
    DEV_88E6176_DEV_STATE = 0,
    DEV_88E6176_ATTACH,
    DEV_88E6176_DETACH,
    DEV_88E6176_INIT,
    DEV_88E6176_SHOW,
    ...
    DEV_88E6176_ALERT,
    DEV_88E6176_DISPLAY,
} dev_88e6176_report_code_t;

typedef enum {
    VLAN_PROFILE_1,
    VLAN_PROFILE_END
} dev_88e6176_vlan_profile_t;
...
} mrvl_88e6176_phy_setup_t;

/*
 * Define the 88E6176 device object structure
 */
typedef struct dev_88e6176_object_t {
    dev_object_t        base;
    dev_88e6176_callin_fvt_t        *callin_fvt;
    dev_88e6176_callout_fvt_t       *callout_fvt;
} dev_88e6176_object_t;

typedef struct dev_88e6176_pvlan_profile_t_ {
    int port_vtable[ESW_PORT7];
} dev_88e6176_pvlan_profile_t;

extern void mrv88e6176_dev_create(dev_object_t *, dev_error_report_t);
#endif   /* __DEV_88E6176_H__ */

/*------------------------------------------------------------------
$Log: dev_88e6176.h,v $
Revision 1.3  2019/01/10 06:13:22  wilbhuan
...
Revision 1.1.2.5  2018/07/03 05:39:26  harrchan
Follow the coding rule to clean up code

Revision 1.1.2.4  2018/03/16 06:52:02  harrchan
Support ESW PHY 1000base-T Test Mode

Revision 1.1.2.3  2018/03/15 08:31:01  harrchan
Add new function for led test

Revision 1.1.2.2  2018/03/05 08:54:19  harrchan
Initial hydra application code base

Revision 1.1.2.1  2018/02/27 08:06:27  harrchan
