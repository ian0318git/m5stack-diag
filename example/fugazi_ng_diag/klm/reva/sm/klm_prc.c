/* $Id: klm_prc.c,v 1.2 2017/03/16 05:22:43 umlin Exp $
 * $Source: /auto/diag/ngd-linux-rep/cvs/ng_diag/klm/reva/sm/klm_prc.c,v $
 ***********************************************************************
 * File Name: klm_prc.c
 *
...
/* CSR 1~6 on Zynq 7z015 */
static prince_scc_regs_t *scc_reg_p = NULL;
static prince_scc_regs_t *scc_reg_p2 = NULL;
static prince_scc_regs_t *scc_reg_p3 = NULL;
static prince_scc_regs_t *scc_reg_p4 = NULL;
static prince_scc_regs_t *scc_reg_p5 = NULL;
static prince_scc_regs_t *scc_reg_p6 = NULL;
/* CSR 7~16 on Zynq A100T */
static prince_scc_regs_t *scc_reg_p7 = NULL;
static prince_scc_regs_t *scc_reg_p8 = NULL;
static prince_scc_regs_t *scc_reg_p9 = NULL;
static prince_scc_regs_t *scc_reg_p10 = NULL;
static prince_scc_regs_t *scc_reg_p11 = NULL;
static prince_scc_regs_t *scc_reg_p12 = NULL;
static prince_scc_regs_t *scc_reg_p13 = NULL;
static prince_scc_regs_t *scc_reg_p14 = NULL;
static prince_scc_regs_t *scc_reg_p15 = NULL;
static prince_scc_regs_t *scc_reg_p16 = NULL;
...
scc_mgmt_isr(int irq, void *dev_id, struct pt_regs *pt)
{
    ...
    for (i = 0; i < channel_num; i++) {
        ...
        data = scc_reg_p2->serial_itf[i].modem_intr_status;
        data = scc_reg_p3->serial_itf[i].modem_intr_status;
        data = scc_reg_p4->serial_itf[i].modem_intr_status;
        data = scc_reg_p5->serial_itf[i].modem_intr_status;
        data = scc_reg_p6->serial_itf[i].modem_intr_status;
        data = scc_reg_p7->serial_itf[i].modem_intr_status;
        data = scc_reg_p8->serial_itf[i].modem_intr_status;
        data = scc_reg_p9->serial_itf[i].modem_intr_status;
        data = scc_reg_p10->serial_itf[i].modem_intr_status;
        data = scc_reg_p11->serial_itf[i].modem_intr_status;
        data = scc_reg_p12->serial_itf[i].modem_intr_status;
        data = scc_reg_p13->serial_itf[i].modem_intr_status;
        data = scc_reg_p14->serial_itf[i].modem_intr_status;
        data = scc_reg_p15->serial_itf[i].modem_intr_status;
        data = scc_reg_p16->serial_itf[i].modem_intr_status;
    }
...
scc_netio_isr(int irq, void *dev_id, struct pt_regs *pt)
{
    ...
    /* Clear the interrupt */
    for (i = 0; i < channel_num; i++) {
        scc_reg_p->proto_regs[i].intr_status |= scc_reg_p->proto_regs[i].intr_status;
        scc_reg_p->proto_regs_lp[i].intr_status |= scc_reg_p->proto_regs_lp[i].intr_status;

        scc_reg_p2->proto_regs[i].intr_status |= scc_reg_p2->proto_regs[i].intr_status;
        scc_reg_p2->proto_regs_lp[i].intr_status |= scc_reg_p2->proto_regs_lp[i].intr_status;

        scc_reg_p3->proto_regs[i].intr_status |= scc_reg_p3->proto_regs[i].intr_status;
        scc_reg_p3->proto_regs_lp[i].intr_status |= scc_reg_p3->proto_regs_lp[i].intr_status;

        scc_reg_p4->proto_regs[i].intr_status |= scc_reg_p4->proto_regs[i].intr_status;
        scc_reg_p4->proto_regs_lp[i].intr_status |= scc_reg_p4->proto_regs_lp[i].intr_status;

        scc_reg_p5->proto_regs[i].intr_status |= scc_reg_p5->proto_regs[i].intr_status;
        scc_reg_p5->proto_regs_lp[i].intr_status |= scc_reg_p5->proto_regs_lp[i].intr_status;

        scc_reg_p6->proto_regs[i].intr_status |= scc_reg_p6->proto_regs[i].intr_status;
        scc_reg_p6->proto_regs_lp[i].intr_status |= scc_reg_p6->proto_regs_lp[i].intr_status;

        scc_reg_p7->proto_regs[i].intr_status |= scc_reg_p7->proto_regs[i].intr_status;
        scc_reg_p7->proto_regs_lp[i].intr_status |= scc_reg_p7->proto_regs_lp[i].intr_status;

        scc_reg_p8->proto_regs[i].intr_status |= scc_reg_p8->proto_regs[i].intr_status;
        scc_reg_p8->proto_regs_lp[i].intr_status |= scc_reg_p8->proto_regs_lp[i].intr_status;

        scc_reg_p9->proto_regs[i].intr_status |= scc_reg_p9->proto_regs[i].intr_status;
        scc_reg_p9->proto_regs_lp[i].intr_status |= scc_reg_p9->proto_regs_lp[i].intr_status;

        scc_reg_p10->proto_regs[i].intr_status |= scc_reg_p10->proto_regs[i].intr_status;
        scc_reg_p10->proto_regs_lp[i].intr_status |= scc_reg_p10->proto_regs_lp[i].intr_status;

        scc_reg_p11->proto_regs[i].intr_status |= scc_reg_p11->proto_regs[i].intr_status;
        scc_reg_p11->proto_regs_lp[i].intr_status |= scc_reg_p11->proto_regs_lp[i].intr_status;

        scc_reg_p12->proto_regs[i].intr_status |= scc_reg_p12->proto_regs[i].intr_status;
        scc_reg_p12->proto_regs_lp[i].intr_status |= scc_reg_p12->proto_regs_lp[i].intr_status;

        scc_reg_p13->proto_regs[i].intr_status |= scc_reg_p13->proto_regs[i].intr_status;
        scc_reg_p13->proto_regs_lp[i].intr_status |= scc_reg_p13->proto_regs_lp[i].intr_status;

        scc_reg_p14->proto_regs[i].intr_status |= scc_reg_p14->proto_regs[i].intr_status;
        scc_reg_p14->proto_regs_lp[i].intr_status |= scc_reg_p14->proto_regs_lp[i].intr_status;

        scc_reg_p15->proto_regs[i].intr_status |= scc_reg_p15->proto_regs[i].intr_status;
        scc_reg_p15->proto_regs_lp[i].intr_status |= scc_reg_p15->proto_regs_lp[i].intr_status;

        scc_reg_p16->proto_regs[i].intr_status |= scc_reg_p16->proto_regs[i].intr_status;
        scc_reg_p16->proto_regs_lp[i].intr_status |= scc_reg_p16->proto_regs_lp[i].intr_status;
    }
...
static int klm_isr_install(void)
{
    ...
    scc_reg_p = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE, (ZYNC_SCC_CSR_LENGTH * 2));

    scc_reg_p2 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x4000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p3 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x8000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p4 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0xC000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p5 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x10000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p6 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x14000, (ZYNC_SCC_CSR_LENGTH * 2));

    scc_reg_p7 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x40000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p8 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x44000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p9 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x48000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p10 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x4C000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p11 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x50000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p12 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x54000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p13 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x58000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p14 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x5C000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p15 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x60000, (ZYNC_SCC_CSR_LENGTH * 2));
    scc_reg_p16 = (prince_scc_regs_t *)
                   ioremap_nocache(ZYNC_SCC_CSR_BASE+0x64000, (ZYNC_SCC_CSR_LENGTH * 2));
...
static void klm_isr_free(void)
{
    ...
    iounmap((void *)scc_reg_p2);
    iounmap((void *)scc_reg_p3);
    iounmap((void *)scc_reg_p4);
    iounmap((void *)scc_reg_p5);
    iounmap((void *)scc_reg_p6);
    iounmap((void *)scc_reg_p7);
    iounmap((void *)scc_reg_p8);
    iounmap((void *)scc_reg_p9);
    iounmap((void *)scc_reg_p10);
    iounmap((void *)scc_reg_p11);
    iounmap((void *)scc_reg_p12);
    iounmap((void *)scc_reg_p13);
    iounmap((void *)scc_reg_p14);
    iounmap((void *)scc_reg_p15);
    iounmap((void *)scc_reg_p16);
...
/******** History ********
$Log: klm_prc.c,v $
Revision 1.2  2017/03/16 05:22:43  umlin
Reva-SM: Commit Reva-SM module side KLM to main trunk

Revision 1.1.2.1  2016/11/23 02:49:03  umlin
Reva-SM: Add Zynq A100T serial CSRs in ISR to handle interrupt test.
